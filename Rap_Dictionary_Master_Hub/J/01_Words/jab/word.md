...
END: jab, jabd, jabs / SLANT: ja, jabe, jaby / MULTI: jab mode, jab codes, jab road

## 3 bar-ready examples:
1. Jab on the mic, watch the room align.
2. Jab in the flow, make the speakers quake.
3. Say Jab with the vision, watch the crowd awake.
