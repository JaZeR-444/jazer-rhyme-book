...
END: uml, umld, umls / SLANT: um, umle, umly / MULTI: uml mode, uml codes, uml road

## 3 bar-ready examples:
1. I move with Uml, every step a headline.
2. Uml on the mic, watch the room align.
3. Uml in the flow, make the speakers quake.
