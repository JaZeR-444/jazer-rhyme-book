...
END: ini, inid, inis / SLANT: in, inie, iniy / MULTI: yogini mode, yogini codes, yogini road

## 3 bar-ready examples:
1. Yogini on the mic, watch the room align.
2. Yogini in the flow, make the speakers quake.
3. Say Yogini with the vision, watch the crowd awake.
