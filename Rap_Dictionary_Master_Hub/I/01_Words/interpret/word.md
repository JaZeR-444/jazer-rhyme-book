...
END: ret, retd, rets / SLANT: re, rete, rety / MULTI: interpret mode, interpret codes, interpret road

## 3 bar-ready examples:
1. Say Interpret with the vision, watch the crowd awake.
2. Interpret in my cadence, heavy like a drumline.
3. I move with Interpret, every step a headline.
