...
END: tag, tagd, tags / SLANT: ta, tage, tagy / MULTI: nextag mode, nextag codes, nextag road

## 3 bar-ready examples:
1. Nextag in my cadence, heavy like a drumline.
2. I move with Nextag, every step a headline.
3. Nextag on the mic, watch the room align.
