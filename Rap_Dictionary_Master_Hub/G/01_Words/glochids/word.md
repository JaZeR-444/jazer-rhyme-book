...
END: ids, idsd, idss / SLANT: id, idse, idsy / MULTI: glochids mode, glochids codes, glochids road

## 3 bar-ready examples:
1. I move with Glochids, every step a headline.
2. Glochids on the mic, watch the room align.
3. Glochids in the flow, make the speakers quake.
