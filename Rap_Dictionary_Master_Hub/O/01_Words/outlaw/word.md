...
END: law, lawd, laws / SLANT: la, lawe, lawy / MULTI: outlaw mode, outlaw codes, outlaw road

## 3 bar-ready examples:
1. Outlaw on the mic, watch the room align.
2. Outlaw in the flow, make the speakers quake.
3. Say Outlaw with the vision, watch the crowd awake.
