...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: grooming mode, grooming codes, grooming road

## 3 bar-ready examples:
1. Grooming in the flow, make the speakers quake.
2. Say Grooming with the vision, watch the crowd awake.
3. Grooming in my cadence, heavy like a drumline.
