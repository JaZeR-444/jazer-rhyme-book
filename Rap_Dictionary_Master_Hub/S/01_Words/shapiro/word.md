...
END: iro, irod, iros / SLANT: ir, iroe, iroy / MULTI: shapiro mode, shapiro codes, shapiro road

## 3 bar-ready examples:
1. I move with Shapiro, every step a headline.
2. Shapiro on the mic, watch the room align.
3. Shapiro in the flow, make the speakers quake.
