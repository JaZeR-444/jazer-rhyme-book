...
END: dge, dged, dges / SLANT: dg, dgee, dgey / MULTI: stodge mode, stodge codes, stodge road

## 3 bar-ready examples:
1. Stodge in the flow, make the speakers quake.
2. Say Stodge with the vision, watch the crowd awake.
3. Stodge in my cadence, heavy like a drumline.
