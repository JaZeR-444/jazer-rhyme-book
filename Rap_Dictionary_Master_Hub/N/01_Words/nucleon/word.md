...
END: eon, eond, eons / SLANT: eo, eone, eony / MULTI: nucleon mode, nucleon codes, nucleon road

## 3 bar-ready examples:
1. I move with Nucleon, every step a headline.
2. Nucleon on the mic, watch the room align.
3. Nucleon in the flow, make the speakers quake.
