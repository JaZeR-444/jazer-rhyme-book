...
END: ome, omed, omes / SLANT: om, omee, omey / MULTI: fewsome mode, fewsome codes, fewsome road

## 3 bar-ready examples:
1. Fewsome in the flow, make the speakers quake.
2. Say Fewsome with the vision, watch the crowd awake.
3. Fewsome in my cadence, heavy like a drumline.
