...
END: sso, ssod, ssos / SLANT: ss, ssoe, ssoy / MULTI: yesso mode, yesso codes, yesso road

## 3 bar-ready examples:
1. Yesso in the flow, make the speakers quake.
2. Say Yesso with the vision, watch the crowd awake.
3. Yesso in my cadence, heavy like a drumline.
