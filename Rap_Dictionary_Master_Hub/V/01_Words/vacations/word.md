...
END: ons, onsd, onss / SLANT: on, onse, onsy / MULTI: vacations mode, vacations codes, vacations road

## 3 bar-ready examples:
1. Vacations on the mic, watch the room align.
2. Vacations in the flow, make the speakers quake.
3. Say Vacations with the vision, watch the crowd awake.
