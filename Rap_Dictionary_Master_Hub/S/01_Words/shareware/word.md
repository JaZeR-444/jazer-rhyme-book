...
END: are, ared, ares / SLANT: ar, aree, arey / MULTI: shareware mode, shareware codes, shareware road

## 3 bar-ready examples:
1. Shareware on the mic, watch the room align.
2. Shareware in the flow, make the speakers quake.
3. Say Shareware with the vision, watch the crowd awake.
