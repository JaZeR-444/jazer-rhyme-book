...
END: eam, eamd, eams / SLANT: ea, eame, eamy / MULTI: upstream mode, upstream codes, upstream road

## 3 bar-ready examples:
1. Upstream on the mic, watch the room align.
2. Upstream in the flow, make the speakers quake.
3. Say Upstream with the vision, watch the crowd awake.
