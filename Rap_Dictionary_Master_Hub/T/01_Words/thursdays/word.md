...
END: ays, aysd, ayss / SLANT: ay, ayse, aysy / MULTI: thursdays mode, thursdays codes, thursdays road

## 3 bar-ready examples:
1. Say Thursdays with the vision, watch the crowd awake.
2. Thursdays in my cadence, heavy like a drumline.
3. I move with Thursdays, every step a headline.
