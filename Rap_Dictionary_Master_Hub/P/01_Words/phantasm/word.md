...
END: asm, asmd, asms / SLANT: as, asme, asmy / MULTI: phantasm mode, phantasm codes, phantasm road

## 3 bar-ready examples:
1. Phantasm in the flow, make the speakers quake.
2. Say Phantasm with the vision, watch the crowd awake.
3. Phantasm in my cadence, heavy like a drumline.
