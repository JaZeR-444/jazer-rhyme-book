...
END: sem, semd, sems / SLANT: se, seme, semy / MULTI: glossem mode, glossem codes, glossem road

## 3 bar-ready examples:
1. Glossem in the flow, make the speakers quake.
2. Say Glossem with the vision, watch the crowd awake.
3. Glossem in my cadence, heavy like a drumline.
