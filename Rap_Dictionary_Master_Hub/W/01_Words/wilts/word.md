...
END: lts, ltsd, ltss / SLANT: lt, ltse, ltsy / MULTI: wilts mode, wilts codes, wilts road

## 3 bar-ready examples:
1. I move with Wilts, every step a headline.
2. Wilts on the mic, watch the room align.
3. Wilts in the flow, make the speakers quake.
