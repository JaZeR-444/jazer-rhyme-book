...
END: ves, vesd, vess / SLANT: ve, vese, vesy / MULTI: nerves mode, nerves codes, nerves road

## 3 bar-ready examples:
1. Nerves on the mic, watch the room align.
2. Nerves in the flow, make the speakers quake.
3. Say Nerves with the vision, watch the crowd awake.
