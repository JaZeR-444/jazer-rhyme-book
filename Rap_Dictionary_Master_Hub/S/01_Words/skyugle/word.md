...
END: gle, gled, gles / SLANT: gl, glee, gley / MULTI: skyugle mode, skyugle codes, skyugle road

## 3 bar-ready examples:
1. Skyugle in the flow, make the speakers quake.
2. Say Skyugle with the vision, watch the crowd awake.
3. Skyugle in my cadence, heavy like a drumline.
