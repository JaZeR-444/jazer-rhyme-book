...
END: ist, istd, ists / SLANT: is, iste, isty / MULTI: nudist mode, nudist codes, nudist road

## 3 bar-ready examples:
1. Nudist in the flow, make the speakers quake.
2. Say Nudist with the vision, watch the crowd awake.
3. Nudist in my cadence, heavy like a drumline.
