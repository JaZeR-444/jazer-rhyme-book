...
END: ors, orsd, orss / SLANT: or, orse, orsy / MULTI: neighbors mode, neighbors codes, neighbors road

## 3 bar-ready examples:
1. Neighbors on the mic, watch the room align.
2. Neighbors in the flow, make the speakers quake.
3. Say Neighbors with the vision, watch the crowd awake.
