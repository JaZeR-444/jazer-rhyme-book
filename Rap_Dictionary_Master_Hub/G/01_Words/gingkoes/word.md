...
END: oes, oesd, oess / SLANT: oe, oese, oesy / MULTI: gingkoes mode, gingkoes codes, gingkoes road

## 3 bar-ready examples:
1. I move with Gingkoes, every step a headline.
2. Gingkoes on the mic, watch the room align.
3. Gingkoes in the flow, make the speakers quake.
