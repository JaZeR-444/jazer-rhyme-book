...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: voting mode, voting codes, voting road

## 3 bar-ready examples:
1. Say Voting with the vision, watch the crowd awake.
2. Voting in my cadence, heavy like a drumline.
3. I move with Voting, every step a headline.
