...
END: llc, llcd, llcs / SLANT: ll, llce, llcy / MULTI: llc mode, llc codes, llc road

## 3 bar-ready examples:
1. Llc in the flow, make the speakers quake.
2. Say Llc with the vision, watch the crowd awake.
3. Llc in my cadence, heavy like a drumline.
