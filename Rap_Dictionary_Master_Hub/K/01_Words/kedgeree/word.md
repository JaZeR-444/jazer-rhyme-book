...
END: ree, reed, rees / SLANT: re, reee, reey / MULTI: kedgeree mode, kedgeree codes, kedgeree road

## 3 bar-ready examples:
1. Kedgeree on the mic, watch the room align.
2. Kedgeree in the flow, make the speakers quake.
3. Say Kedgeree with the vision, watch the crowd awake.
