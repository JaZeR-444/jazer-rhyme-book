...
END: nel, neld, nels / SLANT: ne, nele, nely / MULTI: sentinel mode, sentinel codes, sentinel road

## 3 bar-ready examples:
1. Sentinel on the mic, watch the room align.
2. Sentinel in the flow, make the speakers quake.
3. Say Sentinel with the vision, watch the crowd awake.
