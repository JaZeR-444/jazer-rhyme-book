...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: incoming mode, incoming codes, incoming road

## 3 bar-ready examples:
1. Say Incoming with the vision, watch the crowd awake.
2. Incoming in my cadence, heavy like a drumline.
3. I move with Incoming, every step a headline.
