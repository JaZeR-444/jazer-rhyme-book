...
END: ons, onsd, onss / SLANT: on, onse, onsy / MULTI: objections mode, objections codes, objections road

## 3 bar-ready examples:
1. Objections in the flow, make the speakers quake.
2. Say Objections with the vision, watch the crowd awake.
3. Objections in my cadence, heavy like a drumline.
