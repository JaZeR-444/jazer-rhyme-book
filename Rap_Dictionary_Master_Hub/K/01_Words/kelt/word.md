...
END: elt, eltd, elts / SLANT: el, elte, elty / MULTI: kelt mode, kelt codes, kelt road

## 3 bar-ready examples:
1. Say Kelt with the vision, watch the crowd awake.
2. Kelt in my cadence, heavy like a drumline.
3. I move with Kelt, every step a headline.
