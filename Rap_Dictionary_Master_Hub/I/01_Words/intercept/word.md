...
END: ept, eptd, epts / SLANT: ep, epte, epty / MULTI: intercept mode, intercept codes, intercept road

## 3 bar-ready examples:
1. Say Intercept with the vision, watch the crowd awake.
2. Intercept in my cadence, heavy like a drumline.
3. I move with Intercept, every step a headline.
