...
END: cts, ctsd, ctss / SLANT: ct, ctse, ctsy / MULTI: objects mode, objects codes, objects road

## 3 bar-ready examples:
1. Objects in the flow, make the speakers quake.
2. Say Objects with the vision, watch the crowd awake.
3. Objects in my cadence, heavy like a drumline.
