...
END: ces, cesd, cess / SLANT: ce, cese, cesy / MULTI: indices mode, indices codes, indices road

## 3 bar-ready examples:
1. Indices in the flow, make the speakers quake.
2. Say Indices with the vision, watch the crowd awake.
3. Indices in my cadence, heavy like a drumline.
