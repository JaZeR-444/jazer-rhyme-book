...
END: ull, ulld, ulls / SLANT: ul, ulle, ully / MULTI: null mode, null codes, null road

## 3 bar-ready examples:
1. Null in the flow, make the speakers quake.
2. Say Null with the vision, watch the crowd awake.
3. Null in my cadence, heavy like a drumline.
