...
END: lan, land, lans / SLANT: la, lane, lany / MULTI: wlan mode, wlan codes, wlan road

## 3 bar-ready examples:
1. Wlan on the mic, watch the room align.
2. Wlan in the flow, make the speakers quake.
3. Say Wlan with the vision, watch the crowd awake.
