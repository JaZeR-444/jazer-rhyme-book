...
END: kes, kesd, kess / SLANT: ke, kese, kesy / MULTI: jokes mode, jokes codes, jokes road

## 3 bar-ready examples:
1. Jokes on the mic, watch the room align.
2. Jokes in the flow, make the speakers quake.
3. Say Jokes with the vision, watch the crowd awake.
