...
END: rge, rged, rges / SLANT: rg, rgee, rgey / MULTI: verge mode, verge codes, verge road

## 3 bar-ready examples:
1. Verge on the mic, watch the room align.
2. Verge in the flow, make the speakers quake.
3. Say Verge with the vision, watch the crowd awake.
