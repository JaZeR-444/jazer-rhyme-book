...
END: eni, enid, enis / SLANT: en, enie, eniy / MULTI: yeni mode, yeni codes, yeni road

## 3 bar-ready examples:
1. I move with Yeni, every step a headline.
2. Yeni on the mic, watch the room align.
3. Yeni in the flow, make the speakers quake.
