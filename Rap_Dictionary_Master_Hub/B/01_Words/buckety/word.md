...
END: ety, etyd, etys / SLANT: et, etye, etyy / MULTI: buckety mode, buckety codes, buckety road

## 3 bar-ready examples:
1. I move with Buckety, every step a headline.
2. Buckety on the mic, watch the room align.
3. Buckety in the flow, make the speakers quake.
