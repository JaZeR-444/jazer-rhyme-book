...
END: jn, jnd, jns / SLANT: j, jne, jny / MULTI: jn mode, jn codes, jn road

## 3 bar-ready examples:
1. I move with Jn, every step a headline.
2. Jn on the mic, watch the room align.
3. Jn in the flow, make the speakers quake.
