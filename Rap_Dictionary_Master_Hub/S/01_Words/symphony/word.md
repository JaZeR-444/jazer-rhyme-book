...
END: ony, onyd, onys / SLANT: on, onye, onyy / MULTI: symphony mode, symphony codes, symphony road

## 3 bar-ready examples:
1. Symphony on the mic, watch the room align.
2. Symphony in the flow, make the speakers quake.
3. Say Symphony with the vision, watch the crowd awake.
