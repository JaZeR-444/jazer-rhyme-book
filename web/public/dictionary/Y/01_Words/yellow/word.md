...
END: low, lowd, lows / SLANT: lo, lowe, lowy / MULTI: yellow mode, yellow codes, yellow road

## 3 bar-ready examples:
1. Yellow in the flow, make the speakers quake.
2. Say Yellow with the vision, watch the crowd awake.
3. Yellow in my cadence, heavy like a drumline.
