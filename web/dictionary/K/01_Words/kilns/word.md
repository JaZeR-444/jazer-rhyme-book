...
END: lns, lnsd, lnss / SLANT: ln, lnse, lnsy / MULTI: kilns mode, kilns codes, kilns road

## 3 bar-ready examples:
1. Kilns on the mic, watch the room align.
2. Kilns in the flow, make the speakers quake.
3. Say Kilns with the vision, watch the crowd awake.
