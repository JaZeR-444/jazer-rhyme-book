...
END: pts, ptsd, ptss / SLANT: pt, ptse, ptsy / MULTI: prompts mode, prompts codes, prompts road

## 3 bar-ready examples:
1. Say Prompts with the vision, watch the crowd awake.
2. Prompts in my cadence, heavy like a drumline.
3. I move with Prompts, every step a headline.
