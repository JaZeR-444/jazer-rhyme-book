...
END: ues, uesd, uess / SLANT: ue, uese, uesy / MULTI: tues mode, tues codes, tues road

## 3 bar-ready examples:
1. I move with Tues, every step a headline.
2. Tues on the mic, watch the room align.
3. Tues in the flow, make the speakers quake.
