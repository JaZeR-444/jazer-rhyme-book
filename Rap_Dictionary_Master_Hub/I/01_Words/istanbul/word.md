...
END: bul, buld, buls / SLANT: bu, bule, buly / MULTI: istanbul mode, istanbul codes, istanbul road

## 3 bar-ready examples:
1. Istanbul in the flow, make the speakers quake.
2. Say Istanbul with the vision, watch the crowd awake.
3. Istanbul in my cadence, heavy like a drumline.
