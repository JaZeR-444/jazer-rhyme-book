...
END: ics, icsd, icss / SLANT: ic, icse, icsy / MULTI: obstetrics mode, obstetrics codes, obstetrics road

## 3 bar-ready examples:
1. Obstetrics in my cadence, heavy like a drumline.
2. I move with Obstetrics, every step a headline.
3. Obstetrics on the mic, watch the room align.
