...
END: rly, rlyd, rlys / SLANT: rl, rlye, rlyy / MULTI: quarterly mode, quarterly codes, quarterly road

## 3 bar-ready examples:
1. I move with Quarterly, every step a headline.
2. Quarterly on the mic, watch the room align.
3. Quarterly in the flow, make the speakers quake.
