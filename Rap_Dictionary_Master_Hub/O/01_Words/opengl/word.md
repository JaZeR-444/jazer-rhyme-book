...
END: ngl, ngld, ngls / SLANT: ng, ngle, ngly / MULTI: opengl mode, opengl codes, opengl road

## 3 bar-ready examples:
1. I move with Opengl, every step a headline.
2. Opengl on the mic, watch the room align.
3. Opengl in the flow, make the speakers quake.
