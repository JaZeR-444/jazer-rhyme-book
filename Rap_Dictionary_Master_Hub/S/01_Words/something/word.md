...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: something mode, something codes, something road

## 3 bar-ready examples:
1. I move with Something, every step a headline.
2. Something on the mic, watch the room align.
3. Something in the flow, make the speakers quake.
