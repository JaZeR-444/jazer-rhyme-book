...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: misses mode, misses codes, misses road

## 3 bar-ready examples:
1. Say Misses with the vision, watch the crowd awake.
2. Misses in my cadence, heavy like a drumline.
3. I move with Misses, every step a headline.
