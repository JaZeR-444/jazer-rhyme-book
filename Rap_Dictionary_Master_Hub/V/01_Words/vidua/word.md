...
END: dua, duad, duas / SLANT: du, duae, duay / MULTI: vidua mode, vidua codes, vidua road

## 3 bar-ready examples:
1. I move with Vidua, every step a headline.
2. Vidua on the mic, watch the room align.
3. Vidua in the flow, make the speakers quake.
