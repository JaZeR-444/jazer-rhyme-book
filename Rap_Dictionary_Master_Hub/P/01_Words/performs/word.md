...
END: rms, rmsd, rmss / SLANT: rm, rmse, rmsy / MULTI: performs mode, performs codes, performs road

## 3 bar-ready examples:
1. Performs in my cadence, heavy like a drumline.
2. I move with Performs, every step a headline.
3. Performs on the mic, watch the room align.
