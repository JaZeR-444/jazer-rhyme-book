...
END: eby, ebyd, ebys / SLANT: eb, ebye, ebyy / MULTI: thereby mode, thereby codes, thereby road

## 3 bar-ready examples:
1. Thereby in the flow, make the speakers quake.
2. Say Thereby with the vision, watch the crowd awake.
3. Thereby in my cadence, heavy like a drumline.
