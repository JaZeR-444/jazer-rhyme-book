...
END: kin, kind, kins / SLANT: ki, kine, kiny / MULTI: goatskin mode, goatskin codes, goatskin road

## 3 bar-ready examples:
1. Goatskin in the flow, make the speakers quake.
2. Say Goatskin with the vision, watch the crowd awake.
3. Goatskin in my cadence, heavy like a drumline.
