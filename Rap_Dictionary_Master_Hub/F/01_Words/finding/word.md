...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: finding mode, finding codes, finding road

## 3 bar-ready examples:
1. I move with Finding, every step a headline.
2. Finding on the mic, watch the room align.
3. Finding in the flow, make the speakers quake.
