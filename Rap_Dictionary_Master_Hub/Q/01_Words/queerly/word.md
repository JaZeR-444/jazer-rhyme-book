...
END: rly, rlyd, rlys / SLANT: rl, rlye, rlyy / MULTI: queerly mode, queerly codes, queerly road

## 3 bar-ready examples:
1. Queerly in the flow, make the speakers quake.
2. Say Queerly with the vision, watch the crowd awake.
3. Queerly in my cadence, heavy like a drumline.
