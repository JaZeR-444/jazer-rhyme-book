...
END: usd, usdd, usds / SLANT: us, usde, usdy / MULTI: usd mode, usd codes, usd road

## 3 bar-ready examples:
1. Usd in the flow, make the speakers quake.
2. Say Usd with the vision, watch the crowd awake.
3. Usd in my cadence, heavy like a drumline.
