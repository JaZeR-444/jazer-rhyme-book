...
END: atz, atzd, atzs / SLANT: at, atze, atzy / MULTI: katz mode, katz codes, katz road

## 3 bar-ready examples:
1. Katz in the flow, make the speakers quake.
2. Say Katz with the vision, watch the crowd awake.
3. Katz in my cadence, heavy like a drumline.
