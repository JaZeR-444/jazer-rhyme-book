...
END: lip, lipd, lips / SLANT: li, lipe, lipy / MULTI: tulip mode, tulip codes, tulip road

## 3 bar-ready examples:
1. Tulip on the mic, watch the room align.
2. Tulip in the flow, make the speakers quake.
3. Say Tulip with the vision, watch the crowd awake.
