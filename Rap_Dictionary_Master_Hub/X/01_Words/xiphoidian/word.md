...
END: ian, iand, ians / SLANT: ia, iane, iany / MULTI: xiphoidian mode, xiphoidian codes, xiphoidian road

## 3 bar-ready examples:
1. I move with Xiphoidian, every step a headline.
2. Xiphoidian on the mic, watch the room align.
3. Xiphoidian in the flow, make the speakers quake.
