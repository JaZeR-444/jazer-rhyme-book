...
END: lid, lidd, lids / SLANT: li, lide, lidy / MULTI: solid mode, solid codes, solid road

## 3 bar-ready examples:
1. Solid on the mic, watch the room align.
2. Solid in the flow, make the speakers quake.
3. Say Solid with the vision, watch the crowd awake.
