...
END: ude, uded, udes / SLANT: ud, udee, udey / MULTI: include mode, include codes, include road

## 3 bar-ready examples:
1. Say Include with the vision, watch the crowd awake.
2. Include in my cadence, heavy like a drumline.
3. I move with Include, every step a headline.
