...
END: nts, ntsd, ntss / SLANT: nt, ntse, ntsy / MULTI: increments mode, increments codes, increments road

## 3 bar-ready examples:
1. Increments in the flow, make the speakers quake.
2. Say Increments with the vision, watch the crowd awake.
3. Increments in my cadence, heavy like a drumline.
