...
END: goa, goad, goas / SLANT: go, goae, goay / MULTI: goa mode, goa codes, goa road

## 3 bar-ready examples:
1. I move with Goa, every step a headline.
2. Goa on the mic, watch the room align.
3. Goa in the flow, make the speakers quake.
