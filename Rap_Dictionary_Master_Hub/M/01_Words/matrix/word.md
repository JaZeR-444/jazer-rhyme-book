...
END: rix, rixd, rixs / SLANT: ri, rixe, rixy / MULTI: matrix mode, matrix codes, matrix road

## 3 bar-ready examples:
1. Say Matrix with the vision, watch the crowd awake.
2. Matrix in my cadence, heavy like a drumline.
3. I move with Matrix, every step a headline.
