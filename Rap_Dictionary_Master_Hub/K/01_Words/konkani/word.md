...
END: ani, anid, anis / SLANT: an, anie, aniy / MULTI: konkani mode, konkani codes, konkani road

## 3 bar-ready examples:
1. Konkani in the flow, make the speakers quake.
2. Say Konkani with the vision, watch the crowd awake.
3. Konkani in my cadence, heavy like a drumline.
