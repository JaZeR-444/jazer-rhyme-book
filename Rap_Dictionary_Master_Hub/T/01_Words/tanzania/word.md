...
END: nia, niad, nias / SLANT: ni, niae, niay / MULTI: tanzania mode, tanzania codes, tanzania road

## 3 bar-ready examples:
1. I move with Tanzania, every step a headline.
2. Tanzania on the mic, watch the room align.
3. Tanzania in the flow, make the speakers quake.
