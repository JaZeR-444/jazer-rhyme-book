...
END: iut, iutd, iuts / SLANT: iu, iute, iuty / MULTI: nugumiut mode, nugumiut codes, nugumiut road

## 3 bar-ready examples:
1. I move with Nugumiut, every step a headline.
2. Nugumiut on the mic, watch the room align.
3. Nugumiut in the flow, make the speakers quake.
