...
END: age, aged, ages / SLANT: ag, agee, agey / MULTI: lineage mode, lineage codes, lineage road

## 3 bar-ready examples:
1. I move with Lineage, every step a headline.
2. Lineage on the mic, watch the room align.
3. Lineage in the flow, make the speakers quake.
