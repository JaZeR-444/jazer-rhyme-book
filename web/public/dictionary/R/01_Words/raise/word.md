...
END: ise, ised, ises / SLANT: is, isee, isey / MULTI: raise mode, raise codes, raise road

## 3 bar-ready examples:
1. Raise in my cadence, heavy like a drumline.
2. I move with Raise, every step a headline.
3. Raise on the mic, watch the room align.
