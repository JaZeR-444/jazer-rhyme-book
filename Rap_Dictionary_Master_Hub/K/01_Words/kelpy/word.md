...
END: lpy, lpyd, lpys / SLANT: lp, lpye, lpyy / MULTI: kelpy mode, kelpy codes, kelpy road

## 3 bar-ready examples:
1. I move with Kelpy, every step a headline.
2. Kelpy on the mic, watch the room align.
3. Kelpy in the flow, make the speakers quake.
