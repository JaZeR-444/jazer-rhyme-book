...
END: vc, vcd, vcs / SLANT: v, vce, vcy / MULTI: vc mode, vc codes, vc road

## 3 bar-ready examples:
1. Vc on the mic, watch the room align.
2. Vc in the flow, make the speakers quake.
3. Say Vc with the vision, watch the crowd awake.
