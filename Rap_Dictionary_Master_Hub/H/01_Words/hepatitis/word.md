...
END: tis, tisd, tiss / SLANT: ti, tise, tisy / MULTI: hepatitis mode, hepatitis codes, hepatitis road

## 3 bar-ready examples:
1. I move with Hepatitis, every step a headline.
2. Hepatitis on the mic, watch the room align.
3. Hepatitis in the flow, make the speakers quake.
