...
END: cin, cind, cins / SLANT: ci, cine, ciny / MULTI: larcin mode, larcin codes, larcin road

## 3 bar-ready examples:
1. I move with Larcin, every step a headline.
2. Larcin on the mic, watch the room align.
3. Larcin in the flow, make the speakers quake.
