...
END: rbo, rbod, rbos / SLANT: rb, rboe, rboy / MULTI: turbo mode, turbo codes, turbo road

## 3 bar-ready examples:
1. Turbo in the flow, make the speakers quake.
2. Say Turbo with the vision, watch the crowd awake.
3. Turbo in my cadence, heavy like a drumline.
