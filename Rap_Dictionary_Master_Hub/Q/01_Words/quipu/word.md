...
END: ipu, ipud, ipus / SLANT: ip, ipue, ipuy / MULTI: quipu mode, quipu codes, quipu road

## 3 bar-ready examples:
1. Quipu on the mic, watch the room align.
2. Quipu in the flow, make the speakers quake.
3. Say Quipu with the vision, watch the crowd awake.
