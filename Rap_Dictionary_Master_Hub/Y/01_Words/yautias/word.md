...
END: ias, iasd, iass / SLANT: ia, iase, iasy / MULTI: yautias mode, yautias codes, yautias road

## 3 bar-ready examples:
1. Yautias in the flow, make the speakers quake.
2. Say Yautias with the vision, watch the crowd awake.
3. Yautias in my cadence, heavy like a drumline.
