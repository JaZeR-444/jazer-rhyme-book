...
END: isk, iskd, isks / SLANT: is, iske, isky / MULTI: obelisk mode, obelisk codes, obelisk road

## 3 bar-ready examples:
1. I move with Obelisk, every step a headline.
2. Obelisk on the mic, watch the room align.
3. Obelisk in the flow, make the speakers quake.
