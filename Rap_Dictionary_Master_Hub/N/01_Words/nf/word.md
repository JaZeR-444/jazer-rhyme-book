...
END: nf, nfd, nfs / SLANT: n, nfe, nfy / MULTI: nf mode, nf codes, nf road

## 3 bar-ready examples:
1. I move with Nf, every step a headline.
2. Nf on the mic, watch the room align.
3. Nf in the flow, make the speakers quake.
