...
END: lly, llyd, llys / SLANT: ll, llye, llyy / MULTI: visually mode, visually codes, visually road

## 3 bar-ready examples:
1. Visually on the mic, watch the room align.
2. Visually in the flow, make the speakers quake.
3. Say Visually with the vision, watch the crowd awake.
