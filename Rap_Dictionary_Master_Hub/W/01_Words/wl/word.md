...
END: wl, wld, wls / SLANT: w, wle, wly / MULTI: wl mode, wl codes, wl road

## 3 bar-ready examples:
1. Wl on the mic, watch the room align.
2. Wl in the flow, make the speakers quake.
3. Say Wl with the vision, watch the crowd awake.
