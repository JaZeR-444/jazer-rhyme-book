...
END: sur, surd, surs / SLANT: su, sure, sury / MULTI: sur mode, sur codes, sur road

## 3 bar-ready examples:
1. Sur in the flow, make the speakers quake.
2. Say Sur with the vision, watch the crowd awake.
3. Sur in my cadence, heavy like a drumline.
