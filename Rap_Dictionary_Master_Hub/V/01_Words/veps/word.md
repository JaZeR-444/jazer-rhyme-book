...
END: eps, epsd, epss / SLANT: ep, epse, epsy / MULTI: veps mode, veps codes, veps road

## 3 bar-ready examples:
1. Veps in my cadence, heavy like a drumline.
2. I move with Veps, every step a headline.
3. Veps on the mic, watch the room align.
