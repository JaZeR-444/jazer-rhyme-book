...
END: nto, ntod, ntos / SLANT: nt, ntoe, ntoy / MULTI: sacramento mode, sacramento codes, sacramento road

## 3 bar-ready examples:
1. I move with Sacramento, every step a headline.
2. Sacramento on the mic, watch the room align.
3. Sacramento in the flow, make the speakers quake.
