...
END: cus, cusd, cuss / SLANT: cu, cuse, cusy / MULTI: locus mode, locus codes, locus road

## 3 bar-ready examples:
1. Locus on the mic, watch the room align.
2. Locus in the flow, make the speakers quake.
3. Say Locus with the vision, watch the crowd awake.
