...
END: ill, illd, ills / SLANT: il, ille, illy / MULTI: thrill mode, thrill codes, thrill road

## 3 bar-ready examples:
1. Thrill on the mic, watch the room align.
2. Thrill in the flow, make the speakers quake.
3. Say Thrill with the vision, watch the crowd awake.
