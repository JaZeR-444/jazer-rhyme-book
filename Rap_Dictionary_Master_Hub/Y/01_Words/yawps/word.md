...
END: wps, wpsd, wpss / SLANT: wp, wpse, wpsy / MULTI: yawps mode, yawps codes, yawps road

## 3 bar-ready examples:
1. I move with Yawps, every step a headline.
2. Yawps on the mic, watch the room align.
3. Yawps in the flow, make the speakers quake.
