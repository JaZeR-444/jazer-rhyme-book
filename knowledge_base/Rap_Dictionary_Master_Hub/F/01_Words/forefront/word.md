...
END: ont, ontd, onts / SLANT: on, onte, onty / MULTI: forefront mode, forefront codes, forefront road

## 3 bar-ready examples:
1. Say Forefront with the vision, watch the crowd awake.
2. Forefront in my cadence, heavy like a drumline.
3. I move with Forefront, every step a headline.
