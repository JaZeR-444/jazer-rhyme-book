...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: trying mode, trying codes, trying road

## 3 bar-ready examples:
1. Trying on the mic, watch the room align.
2. Trying in the flow, make the speakers quake.
3. Say Trying with the vision, watch the crowd awake.
