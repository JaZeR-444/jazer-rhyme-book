...
END: cao, caod, caos / SLANT: ca, caoe, caoy / MULTI: macao mode, macao codes, macao road

## 3 bar-ready examples:
1. I move with Macao, every step a headline.
2. Macao on the mic, watch the room align.
3. Macao in the flow, make the speakers quake.
