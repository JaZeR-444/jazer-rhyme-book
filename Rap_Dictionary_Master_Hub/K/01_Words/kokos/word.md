...
END: kos, kosd, koss / SLANT: ko, kose, kosy / MULTI: kokos mode, kokos codes, kokos road

## 3 bar-ready examples:
1. Kokos in the flow, make the speakers quake.
2. Say Kokos with the vision, watch the crowd awake.
3. Kokos in my cadence, heavy like a drumline.
