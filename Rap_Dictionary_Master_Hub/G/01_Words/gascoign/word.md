...
END: ign, ignd, igns / SLANT: ig, igne, igny / MULTI: gascoign mode, gascoign codes, gascoign road

## 3 bar-ready examples:
1. Gascoign on the mic, watch the room align.
2. Gascoign in the flow, make the speakers quake.
3. Say Gascoign with the vision, watch the crowd awake.
