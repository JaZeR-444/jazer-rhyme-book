...
END: eck, eckd, ecks / SLANT: ec, ecke, ecky / MULTI: heck mode, heck codes, heck road

## 3 bar-ready examples:
1. Heck on the mic, watch the room align.
2. Heck in the flow, make the speakers quake.
3. Say Heck with the vision, watch the crowd awake.
