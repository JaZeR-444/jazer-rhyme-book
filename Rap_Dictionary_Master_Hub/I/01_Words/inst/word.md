...
END: nst, nstd, nsts / SLANT: ns, nste, nsty / MULTI: inst mode, inst codes, inst road

## 3 bar-ready examples:
1. Say Inst with the vision, watch the crowd awake.
2. Inst in my cadence, heavy like a drumline.
3. I move with Inst, every step a headline.
