...
END: sen, send, sens / SLANT: se, sene, seny / MULTI: falsen mode, falsen codes, falsen road

## 3 bar-ready examples:
1. Falsen on the mic, watch the room align.
2. Falsen in the flow, make the speakers quake.
3. Say Falsen with the vision, watch the crowd awake.
