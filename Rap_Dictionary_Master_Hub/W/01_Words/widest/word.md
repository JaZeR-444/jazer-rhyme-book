...
END: est, estd, ests / SLANT: es, este, esty / MULTI: widest mode, widest codes, widest road

## 3 bar-ready examples:
1. I move with Widest, every step a headline.
2. Widest on the mic, watch the room align.
3. Widest in the flow, make the speakers quake.
