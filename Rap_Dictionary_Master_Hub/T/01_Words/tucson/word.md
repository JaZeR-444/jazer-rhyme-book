...
END: son, sond, sons / SLANT: so, sone, sony / MULTI: tucson mode, tucson codes, tucson road

## 3 bar-ready examples:
1. Tucson in the flow, make the speakers quake.
2. Say Tucson with the vision, watch the crowd awake.
3. Tucson in my cadence, heavy like a drumline.
