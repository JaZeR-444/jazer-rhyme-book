...
END: ian, iand, ians / SLANT: ia, iane, iany / MULTI: wellsian mode, wellsian codes, wellsian road

## 3 bar-ready examples:
1. Wellsian in the flow, make the speakers quake.
2. Say Wellsian with the vision, watch the crowd awake.
3. Wellsian in my cadence, heavy like a drumline.
