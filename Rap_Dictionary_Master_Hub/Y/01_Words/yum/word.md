...
END: yum, yumd, yums / SLANT: yu, yume, yumy / MULTI: yum mode, yum codes, yum road

## 3 bar-ready examples:
1. I move with Yum, every step a headline.
2. Yum on the mic, watch the room align.
3. Yum in the flow, make the speakers quake.
