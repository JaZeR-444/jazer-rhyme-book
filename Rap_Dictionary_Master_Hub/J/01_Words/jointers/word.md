...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: jointers mode, jointers codes, jointers road

## 3 bar-ready examples:
1. Say Jointers with the vision, watch the crowd awake.
2. Jointers in my cadence, heavy like a drumline.
3. I move with Jointers, every step a headline.
