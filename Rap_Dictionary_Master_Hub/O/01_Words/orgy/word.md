...
END: rgy, rgyd, rgys / SLANT: rg, rgye, rgyy / MULTI: orgy mode, orgy codes, orgy road

## 3 bar-ready examples:
1. Orgy on the mic, watch the room align.
2. Orgy in the flow, make the speakers quake.
3. Say Orgy with the vision, watch the crowd awake.
