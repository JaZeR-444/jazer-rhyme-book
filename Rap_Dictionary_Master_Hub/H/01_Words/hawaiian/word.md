...
END: ian, iand, ians / SLANT: ia, iane, iany / MULTI: hawaiian mode, hawaiian codes, hawaiian road

## 3 bar-ready examples:
1. Say Hawaiian with the vision, watch the crowd awake.
2. Hawaiian in my cadence, heavy like a drumline.
3. I move with Hawaiian, every step a headline.
