...
END: mni, mnid, mnis / SLANT: mn, mnie, mniy / MULTI: omni mode, omni codes, omni road

## 3 bar-ready examples:
1. Say Omni with the vision, watch the crowd awake.
2. Omni in my cadence, heavy like a drumline.
3. I move with Omni, every step a headline.
