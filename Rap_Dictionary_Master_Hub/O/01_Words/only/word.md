...
END: nly, nlyd, nlys / SLANT: nl, nlye, nlyy / MULTI: only mode, only codes, only road

## 3 bar-ready examples:
1. I move with Only, every step a headline.
2. Only on the mic, watch the room align.
3. Only in the flow, make the speakers quake.
