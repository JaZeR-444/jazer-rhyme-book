...
END: ern, ernd, erns / SLANT: er, erne, erny / MULTI: stern mode, stern codes, stern road

## 3 bar-ready examples:
1. Stern on the mic, watch the room align.
2. Stern in the flow, make the speakers quake.
3. Say Stern with the vision, watch the crowd awake.
