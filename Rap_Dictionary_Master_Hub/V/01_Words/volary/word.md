...
END: ary, aryd, arys / SLANT: ar, arye, aryy / MULTI: volary mode, volary codes, volary road

## 3 bar-ready examples:
1. Volary in the flow, make the speakers quake.
2. Say Volary with the vision, watch the crowd awake.
3. Volary in my cadence, heavy like a drumline.
