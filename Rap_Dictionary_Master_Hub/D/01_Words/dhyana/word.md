...
END: ana, anad, anas / SLANT: an, anae, anay / MULTI: dhyana mode, dhyana codes, dhyana road

## 3 bar-ready examples:
1. I move with Dhyana, every step a headline.
2. Dhyana on the mic, watch the room align.
3. Dhyana in the flow, make the speakers quake.
