...
END: ist, istd, ists / SLANT: is, iste, isty / MULTI: quinologist mode, quinologist codes, quinologist road

## 3 bar-ready examples:
1. Quinologist in the flow, make the speakers quake.
2. Say Quinologist with the vision, watch the crowd awake.
3. Quinologist in my cadence, heavy like a drumline.
