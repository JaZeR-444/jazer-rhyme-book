...
END: lea, lead, leas / SLANT: le, leae, leay / MULTI: lea mode, lea codes, lea road

## 3 bar-ready examples:
1. I move with Lea, every step a headline.
2. Lea on the mic, watch the room align.
3. Lea in the flow, make the speakers quake.
