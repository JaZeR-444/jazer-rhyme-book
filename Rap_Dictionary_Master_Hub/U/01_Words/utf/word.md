...
END: utf, utfd, utfs / SLANT: ut, utfe, utfy / MULTI: utf mode, utf codes, utf road

## 3 bar-ready examples:
1. Utf in my cadence, heavy like a drumline.
2. I move with Utf, every step a headline.
3. Utf on the mic, watch the room align.
