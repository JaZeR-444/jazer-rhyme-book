...
END: bai, baid, bais / SLANT: ba, baie, baiy / MULTI: mumbai mode, mumbai codes, mumbai road

## 3 bar-ready examples:
1. Mumbai on the mic, watch the room align.
2. Mumbai in the flow, make the speakers quake.
3. Say Mumbai with the vision, watch the crowd awake.
