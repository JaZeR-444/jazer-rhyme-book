...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: lightning mode, lightning codes, lightning road

## 3 bar-ready examples:
1. Lightning in the flow, make the speakers quake.
2. Say Lightning with the vision, watch the crowd awake.
3. Lightning in my cadence, heavy like a drumline.
