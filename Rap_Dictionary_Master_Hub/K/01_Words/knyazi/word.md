...
END: azi, azid, azis / SLANT: az, azie, aziy / MULTI: knyazi mode, knyazi codes, knyazi road

## 3 bar-ready examples:
1. Knyazi in the flow, make the speakers quake.
2. Say Knyazi with the vision, watch the crowd awake.
3. Knyazi in my cadence, heavy like a drumline.
