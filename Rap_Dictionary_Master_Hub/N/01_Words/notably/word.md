...
END: bly, blyd, blys / SLANT: bl, blye, blyy / MULTI: notably mode, notably codes, notably road

## 3 bar-ready examples:
1. Notably in my cadence, heavy like a drumline.
2. I move with Notably, every step a headline.
3. Notably on the mic, watch the room align.
