...
END: ult, ultd, ults / SLANT: ul, ulte, ulty / MULTI: ult mode, ult codes, ult road

## 3 bar-ready examples:
1. Ult in my cadence, heavy like a drumline.
2. I move with Ult, every step a headline.
3. Ult on the mic, watch the room align.
