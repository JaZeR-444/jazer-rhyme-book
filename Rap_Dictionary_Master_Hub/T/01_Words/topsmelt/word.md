...
END: elt, eltd, elts / SLANT: el, elte, elty / MULTI: topsmelt mode, topsmelt codes, topsmelt road

## 3 bar-ready examples:
1. Topsmelt on the mic, watch the room align.
2. Topsmelt in the flow, make the speakers quake.
3. Say Topsmelt with the vision, watch the crowd awake.
