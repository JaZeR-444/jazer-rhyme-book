...
END: nxp, nxpd, nxps / SLANT: nx, nxpe, nxpy / MULTI: winxp mode, winxp codes, winxp road

## 3 bar-ready examples:
1. I move with Winxp, every step a headline.
2. Winxp on the mic, watch the room align.
3. Winxp in the flow, make the speakers quake.
