...
END: cts, ctsd, ctss / SLANT: ct, ctse, ctsy / MULTI: predicts mode, predicts codes, predicts road

## 3 bar-ready examples:
1. Predicts in my cadence, heavy like a drumline.
2. I move with Predicts, every step a headline.
3. Predicts on the mic, watch the room align.
