...
END: lli, llid, llis / SLANT: ll, llie, lliy / MULTI: willi mode, willi codes, willi road

## 3 bar-ready examples:
1. I move with Willi, every step a headline.
2. Willi on the mic, watch the room align.
3. Willi in the flow, make the speakers quake.
