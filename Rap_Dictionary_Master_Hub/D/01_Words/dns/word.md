...
END: dns, dnsd, dnss / SLANT: dn, dnse, dnsy / MULTI: dns mode, dns codes, dns road

## 3 bar-ready examples:
1. I move with Dns, every step a headline.
2. Dns on the mic, watch the room align.
3. Dns in the flow, make the speakers quake.
