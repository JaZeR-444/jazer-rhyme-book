...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: updating mode, updating codes, updating road

## 3 bar-ready examples:
1. Updating on the mic, watch the room align.
2. Updating in the flow, make the speakers quake.
3. Say Updating with the vision, watch the crowd awake.
