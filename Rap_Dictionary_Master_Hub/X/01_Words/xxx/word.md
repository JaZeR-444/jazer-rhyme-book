...
END: xxx, xxxd, xxxs / SLANT: xx, xxxe, xxxy / MULTI: xxx mode, xxx codes, xxx road

## 3 bar-ready examples:
1. Xxx on the mic, watch the room align.
2. Xxx in the flow, make the speakers quake.
3. Say Xxx with the vision, watch the crowd awake.
