...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: loading mode, loading codes, loading road

## 3 bar-ready examples:
1. I move with Loading, every step a headline.
2. Loading on the mic, watch the room align.
3. Loading in the flow, make the speakers quake.
