...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: openings mode, openings codes, openings road

## 3 bar-ready examples:
1. Openings on the mic, watch the room align.
2. Openings in the flow, make the speakers quake.
3. Say Openings with the vision, watch the crowd awake.
