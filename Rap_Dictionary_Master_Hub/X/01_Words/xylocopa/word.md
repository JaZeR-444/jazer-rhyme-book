...
END: opa, opad, opas / SLANT: op, opae, opay / MULTI: xylocopa mode, xylocopa codes, xylocopa road

## 3 bar-ready examples:
1. Xylocopa on the mic, watch the room align.
2. Xylocopa in the flow, make the speakers quake.
3. Say Xylocopa with the vision, watch the crowd awake.
