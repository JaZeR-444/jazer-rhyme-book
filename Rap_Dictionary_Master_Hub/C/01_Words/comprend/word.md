...
END: end, endd, ends / SLANT: en, ende, endy / MULTI: comprend mode, comprend codes, comprend road

## 3 bar-ready examples:
1. I move with Comprend, every step a headline.
2. Comprend on the mic, watch the room align.
3. Comprend in the flow, make the speakers quake.
