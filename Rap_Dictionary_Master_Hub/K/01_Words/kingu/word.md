...
END: ngu, ngud, ngus / SLANT: ng, ngue, nguy / MULTI: kingu mode, kingu codes, kingu road

## 3 bar-ready examples:
1. Kingu in the flow, make the speakers quake.
2. Say Kingu with the vision, watch the crowd awake.
3. Kingu in my cadence, heavy like a drumline.
