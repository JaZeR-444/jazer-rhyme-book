...
END: amb, ambd, ambs / SLANT: am, ambe, amby / MULTI: lamb mode, lamb codes, lamb road

## 3 bar-ready examples:
1. Lamb in the flow, make the speakers quake.
2. Say Lamb with the vision, watch the crowd awake.
3. Lamb in my cadence, heavy like a drumline.
