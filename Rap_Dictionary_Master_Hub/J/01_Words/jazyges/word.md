...
END: ges, gesd, gess / SLANT: ge, gese, gesy / MULTI: jazyges mode, jazyges codes, jazyges road

## 3 bar-ready examples:
1. Jazyges on the mic, watch the room align.
2. Jazyges in the flow, make the speakers quake.
3. Say Jazyges with the vision, watch the crowd awake.
