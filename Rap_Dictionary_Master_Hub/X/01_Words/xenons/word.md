...
END: ons, onsd, onss / SLANT: on, onse, onsy / MULTI: xenons mode, xenons codes, xenons road

## 3 bar-ready examples:
1. Xenons in my cadence, heavy like a drumline.
2. I move with Xenons, every step a headline.
3. Xenons on the mic, watch the room align.
