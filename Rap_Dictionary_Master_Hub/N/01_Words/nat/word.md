...
END: nat, natd, nats / SLANT: na, nate, naty / MULTI: nat mode, nat codes, nat road

## 3 bar-ready examples:
1. Nat on the mic, watch the room align.
2. Nat in the flow, make the speakers quake.
3. Say Nat with the vision, watch the crowd awake.
