...
END: ays, aysd, ayss / SLANT: ay, ayse, aysy / MULTI: getaways mode, getaways codes, getaways road

## 3 bar-ready examples:
1. I move with Getaways, every step a headline.
2. Getaways on the mic, watch the room align.
3. Getaways in the flow, make the speakers quake.
