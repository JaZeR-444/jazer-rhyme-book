...
END: ock, ockd, ocks / SLANT: oc, ocke, ocky / MULTI: warlock mode, warlock codes, warlock road

## 3 bar-ready examples:
1. Warlock in the flow, make the speakers quake.
2. Say Warlock with the vision, watch the crowd awake.
3. Warlock in my cadence, heavy like a drumline.
