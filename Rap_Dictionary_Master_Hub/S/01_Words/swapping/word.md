...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: swapping mode, swapping codes, swapping road

## 3 bar-ready examples:
1. Swapping in the flow, make the speakers quake.
2. Say Swapping with the vision, watch the crowd awake.
3. Swapping in my cadence, heavy like a drumline.
