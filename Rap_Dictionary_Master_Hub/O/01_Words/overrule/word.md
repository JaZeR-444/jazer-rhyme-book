...
END: ule, uled, ules / SLANT: ul, ulee, uley / MULTI: overrule mode, overrule codes, overrule road

## 3 bar-ready examples:
1. Overrule on the mic, watch the room align.
2. Overrule in the flow, make the speakers quake.
3. Say Overrule with the vision, watch the crowd awake.
