...
END: ons, onsd, onss / SLANT: on, onse, onsy / MULTI: simpsons mode, simpsons codes, simpsons road

## 3 bar-ready examples:
1. Simpsons in the flow, make the speakers quake.
2. Say Simpsons with the vision, watch the crowd awake.
3. Simpsons in my cadence, heavy like a drumline.
