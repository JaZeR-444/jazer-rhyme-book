...
END: era, erad, eras / SLANT: er, erae, eray / MULTI: nemocera mode, nemocera codes, nemocera road

## 3 bar-ready examples:
1. I move with Nemocera, every step a headline.
2. Nemocera on the mic, watch the room align.
3. Nemocera in the flow, make the speakers quake.
