...
END: ads, adsd, adss / SLANT: ad, adse, adsy / MULTI: loads mode, loads codes, loads road

## 3 bar-ready examples:
1. I move with Loads, every step a headline.
2. Loads on the mic, watch the room align.
3. Loads in the flow, make the speakers quake.
