...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: surveying mode, surveying codes, surveying road

## 3 bar-ready examples:
1. Surveying in my cadence, heavy like a drumline.
2. I move with Surveying, every step a headline.
3. Surveying on the mic, watch the room align.
