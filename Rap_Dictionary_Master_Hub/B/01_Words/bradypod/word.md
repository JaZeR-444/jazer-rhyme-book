...
END: pod, podd, pods / SLANT: po, pode, pody / MULTI: bradypod mode, bradypod codes, bradypod road

## 3 bar-ready examples:
1. I move with Bradypod, every step a headline.
2. Bradypod on the mic, watch the room align.
3. Bradypod in the flow, make the speakers quake.
