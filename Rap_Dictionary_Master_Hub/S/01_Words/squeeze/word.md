...
END: eze, ezed, ezes / SLANT: ez, ezee, ezey / MULTI: squeeze mode, squeeze codes, squeeze road

## 3 bar-ready examples:
1. Squeeze in the flow, make the speakers quake.
2. Say Squeeze with the vision, watch the crowd awake.
3. Squeeze in my cadence, heavy like a drumline.
