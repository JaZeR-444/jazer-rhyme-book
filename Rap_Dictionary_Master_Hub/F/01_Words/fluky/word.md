...
END: uky, ukyd, ukys / SLANT: uk, ukye, ukyy / MULTI: fluky mode, fluky codes, fluky road

## 3 bar-ready examples:
1. I move with Fluky, every step a headline.
2. Fluky on the mic, watch the room align.
3. Fluky in the flow, make the speakers quake.
