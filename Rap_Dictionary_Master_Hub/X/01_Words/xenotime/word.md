...
END: ime, imed, imes / SLANT: im, imee, imey / MULTI: xenotime mode, xenotime codes, xenotime road

## 3 bar-ready examples:
1. Say Xenotime with the vision, watch the crowd awake.
2. Xenotime in my cadence, heavy like a drumline.
3. I move with Xenotime, every step a headline.
