...
END: ild, ildd, ilds / SLANT: il, ilde, ildy / MULTI: unwild mode, unwild codes, unwild road

## 3 bar-ready examples:
1. Unwild on the mic, watch the room align.
2. Unwild in the flow, make the speakers quake.
3. Say Unwild with the vision, watch the crowd awake.
