...
END: lee, leed, lees / SLANT: le, leee, leey / MULTI: jalee mode, jalee codes, jalee road

## 3 bar-ready examples:
1. Jalee in the flow, make the speakers quake.
2. Say Jalee with the vision, watch the crowd awake.
3. Jalee in my cadence, heavy like a drumline.
