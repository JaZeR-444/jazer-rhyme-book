...
END: now, nowd, nows / SLANT: no, nowe, nowy / MULTI: now mode, now codes, now road

## 3 bar-ready examples:
1. I move with Now, every step a headline.
2. Now on the mic, watch the room align.
3. Now in the flow, make the speakers quake.
