...
END: res, resd, ress / SLANT: re, rese, resy / MULTI: feres mode, feres codes, feres road

## 3 bar-ready examples:
1. Feres on the mic, watch the room align.
2. Feres in the flow, make the speakers quake.
3. Say Feres with the vision, watch the crowd awake.
