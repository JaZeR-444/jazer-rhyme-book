...
END: ene, ened, enes / SLANT: en, enee, eney / MULTI: obscene mode, obscene codes, obscene road

## 3 bar-ready examples:
1. Obscene on the mic, watch the room align.
2. Obscene in the flow, make the speakers quake.
3. Say Obscene with the vision, watch the crowd awake.
