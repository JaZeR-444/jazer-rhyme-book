...
END: lma, lmad, lmas / SLANT: lm, lmae, lmay / MULTI: palma mode, palma codes, palma road

## 3 bar-ready examples:
1. Palma in the flow, make the speakers quake.
2. Say Palma with the vision, watch the crowd awake.
3. Palma in my cadence, heavy like a drumline.
