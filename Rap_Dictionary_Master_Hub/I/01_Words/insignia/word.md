...
END: nia, niad, nias / SLANT: ni, niae, niay / MULTI: insignia mode, insignia codes, insignia road

## 3 bar-ready examples:
1. Insignia in the flow, make the speakers quake.
2. Say Insignia with the vision, watch the crowd awake.
3. Insignia in my cadence, heavy like a drumline.
