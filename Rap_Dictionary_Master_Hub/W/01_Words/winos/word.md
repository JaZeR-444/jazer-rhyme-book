...
END: nos, nosd, noss / SLANT: no, nose, nosy / MULTI: winos mode, winos codes, winos road

## 3 bar-ready examples:
1. I move with Winos, every step a headline.
2. Winos on the mic, watch the room align.
3. Winos in the flow, make the speakers quake.
