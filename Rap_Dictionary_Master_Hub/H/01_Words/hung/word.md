...
END: ung, ungd, ungs / SLANT: un, unge, ungy / MULTI: hung mode, hung codes, hung road

## 3 bar-ready examples:
1. I move with Hung, every step a headline.
2. Hung on the mic, watch the room align.
3. Hung in the flow, make the speakers quake.
