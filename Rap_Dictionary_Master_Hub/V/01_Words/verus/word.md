...
END: rus, rusd, russ / SLANT: ru, ruse, rusy / MULTI: verus mode, verus codes, verus road

## 3 bar-ready examples:
1. I move with Verus, every step a headline.
2. Verus on the mic, watch the room align.
3. Verus in the flow, make the speakers quake.
