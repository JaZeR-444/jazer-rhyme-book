...
END: ime, imed, imes / SLANT: im, imee, imey / MULTI: ofttime mode, ofttime codes, ofttime road

## 3 bar-ready examples:
1. Ofttime on the mic, watch the room align.
2. Ofttime in the flow, make the speakers quake.
3. Say Ofttime with the vision, watch the crowd awake.
