...
END: mez, mezd, mezs / SLANT: me, meze, mezy / MULTI: gomez mode, gomez codes, gomez road

## 3 bar-ready examples:
1. Gomez on the mic, watch the room align.
2. Gomez in the flow, make the speakers quake.
3. Say Gomez with the vision, watch the crowd awake.
