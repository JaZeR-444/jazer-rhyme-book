...
END: ura, urad, uras / SLANT: ur, urae, uray / MULTI: kagura mode, kagura codes, kagura road

## 3 bar-ready examples:
1. Kagura on the mic, watch the room align.
2. Kagura in the flow, make the speakers quake.
3. Say Kagura with the vision, watch the crowd awake.
