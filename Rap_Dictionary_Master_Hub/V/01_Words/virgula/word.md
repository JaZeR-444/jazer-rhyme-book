...
END: ula, ulad, ulas / SLANT: ul, ulae, ulay / MULTI: virgula mode, virgula codes, virgula road

## 3 bar-ready examples:
1. I move with Virgula, every step a headline.
2. Virgula on the mic, watch the room align.
3. Virgula in the flow, make the speakers quake.
