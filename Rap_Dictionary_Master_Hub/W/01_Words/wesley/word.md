...
END: ley, leyd, leys / SLANT: le, leye, leyy / MULTI: wesley mode, wesley codes, wesley road

## 3 bar-ready examples:
1. I move with Wesley, every step a headline.
2. Wesley on the mic, watch the room align.
3. Wesley in the flow, make the speakers quake.
