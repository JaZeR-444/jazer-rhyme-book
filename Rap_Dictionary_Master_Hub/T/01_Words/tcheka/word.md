...
END: eka, ekad, ekas / SLANT: ek, ekae, ekay / MULTI: tcheka mode, tcheka codes, tcheka road

## 3 bar-ready examples:
1. Tcheka on the mic, watch the room align.
2. Tcheka in the flow, make the speakers quake.
3. Say Tcheka with the vision, watch the crowd awake.
