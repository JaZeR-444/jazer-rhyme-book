...
END: eps, epsd, epss / SLANT: ep, epse, epsy / MULTI: upsweeps mode, upsweeps codes, upsweeps road

## 3 bar-ready examples:
1. Upsweeps in the flow, make the speakers quake.
2. Say Upsweeps with the vision, watch the crowd awake.
3. Upsweeps in my cadence, heavy like a drumline.
