...
END: ian, iand, ians / SLANT: ia, iane, iany / MULTI: norwegian mode, norwegian codes, norwegian road

## 3 bar-ready examples:
1. I move with Norwegian, every step a headline.
2. Norwegian on the mic, watch the room align.
3. Norwegian in the flow, make the speakers quake.
