...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: kittling mode, kittling codes, kittling road

## 3 bar-ready examples:
1. Kittling in the flow, make the speakers quake.
2. Say Kittling with the vision, watch the crowd awake.
3. Kittling in my cadence, heavy like a drumline.
