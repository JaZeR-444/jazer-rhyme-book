...
END: ubc, ubcd, ubcs / SLANT: ub, ubce, ubcy / MULTI: ubc mode, ubc codes, ubc road

## 3 bar-ready examples:
1. Say Ubc with the vision, watch the crowd awake.
2. Ubc in my cadence, heavy like a drumline.
3. I move with Ubc, every step a headline.
