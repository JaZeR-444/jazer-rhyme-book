...
END: nts, ntsd, ntss / SLANT: nt, ntse, ntsy / MULTI: presents mode, presents codes, presents road

## 3 bar-ready examples:
1. Say Presents with the vision, watch the crowd awake.
2. Presents in my cadence, heavy like a drumline.
3. I move with Presents, every step a headline.
