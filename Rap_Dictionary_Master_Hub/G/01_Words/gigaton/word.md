...
END: ton, tond, tons / SLANT: to, tone, tony / MULTI: gigaton mode, gigaton codes, gigaton road

## 3 bar-ready examples:
1. I move with Gigaton, every step a headline.
2. Gigaton on the mic, watch the room align.
3. Gigaton in the flow, make the speakers quake.
