...
END: ast, astd, asts / SLANT: as, aste, asty / MULTI: upbrast mode, upbrast codes, upbrast road

## 3 bar-ready examples:
1. Upbrast on the mic, watch the room align.
2. Upbrast in the flow, make the speakers quake.
3. Say Upbrast with the vision, watch the crowd awake.
