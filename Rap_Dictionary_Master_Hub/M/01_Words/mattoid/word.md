...
END: oid, oidd, oids / SLANT: oi, oide, oidy / MULTI: mattoid mode, mattoid codes, mattoid road

## 3 bar-ready examples:
1. Mattoid in the flow, make the speakers quake.
2. Say Mattoid with the vision, watch the crowd awake.
3. Mattoid in my cadence, heavy like a drumline.
