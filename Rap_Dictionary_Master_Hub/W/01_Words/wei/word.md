...
END: wei, weid, weis / SLANT: we, weie, weiy / MULTI: wei mode, wei codes, wei road

## 3 bar-ready examples:
1. Wei in the flow, make the speakers quake.
2. Say Wei with the vision, watch the crowd awake.
3. Wei in my cadence, heavy like a drumline.
