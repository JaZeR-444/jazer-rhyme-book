...
END: ift, iftd, ifts / SLANT: if, ifte, ifty / MULTI: outswift mode, outswift codes, outswift road

## 3 bar-ready examples:
1. I move with Outswift, every step a headline.
2. Outswift on the mic, watch the room align.
3. Outswift in the flow, make the speakers quake.
