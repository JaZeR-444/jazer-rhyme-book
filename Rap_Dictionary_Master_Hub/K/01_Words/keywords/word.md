...
END: rds, rdsd, rdss / SLANT: rd, rdse, rdsy / MULTI: keywords mode, keywords codes, keywords road

## 3 bar-ready examples:
1. Keywords on the mic, watch the room align.
2. Keywords in the flow, make the speakers quake.
3. Say Keywords with the vision, watch the crowd awake.
