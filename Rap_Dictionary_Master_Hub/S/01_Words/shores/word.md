...
END: res, resd, ress / SLANT: re, rese, resy / MULTI: shores mode, shores codes, shores road

## 3 bar-ready examples:
1. Shores on the mic, watch the room align.
2. Shores in the flow, make the speakers quake.
3. Say Shores with the vision, watch the crowd awake.
