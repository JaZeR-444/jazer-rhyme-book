...
END: idi, idid, idis / SLANT: id, idie, idiy / MULTI: yezidi mode, yezidi codes, yezidi road

## 3 bar-ready examples:
1. Yezidi in the flow, make the speakers quake.
2. Say Yezidi with the vision, watch the crowd awake.
3. Yezidi in my cadence, heavy like a drumline.
