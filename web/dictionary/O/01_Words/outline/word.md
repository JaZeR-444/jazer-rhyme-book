...
END: ine, ined, ines / SLANT: in, inee, iney / MULTI: outline mode, outline codes, outline road

## 3 bar-ready examples:
1. I move with Outline, every step a headline.
2. Outline on the mic, watch the room align.
3. Outline in the flow, make the speakers quake.
