...
END: are, ared, ares / SLANT: ar, aree, arey / MULTI: nightmare mode, nightmare codes, nightmare road

## 3 bar-ready examples:
1. I move with Nightmare, every step a headline.
2. Nightmare on the mic, watch the room align.
3. Nightmare in the flow, make the speakers quake.
