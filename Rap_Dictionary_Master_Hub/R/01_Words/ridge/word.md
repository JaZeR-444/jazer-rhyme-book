...
END: dge, dged, dges / SLANT: dg, dgee, dgey / MULTI: ridge mode, ridge codes, ridge road

## 3 bar-ready examples:
1. Ridge on the mic, watch the room align.
2. Ridge in the flow, make the speakers quake.
3. Say Ridge with the vision, watch the crowd awake.
