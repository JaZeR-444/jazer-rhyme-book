...
END: way, wayd, ways / SLANT: wa, waye, wayy / MULTI: kioway mode, kioway codes, kioway road

## 3 bar-ready examples:
1. I move with Kioway, every step a headline.
2. Kioway on the mic, watch the room align.
3. Kioway in the flow, make the speakers quake.
