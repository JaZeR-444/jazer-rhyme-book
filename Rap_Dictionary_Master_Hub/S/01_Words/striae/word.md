...
END: iae, iaed, iaes / SLANT: ia, iaee, iaey / MULTI: striae mode, striae codes, striae road

## 3 bar-ready examples:
1. Striae on the mic, watch the room align.
2. Striae in the flow, make the speakers quake.
3. Say Striae with the vision, watch the crowd awake.
