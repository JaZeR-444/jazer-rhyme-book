...
END: les, lesd, less / SLANT: le, lese, lesy / MULTI: turtles mode, turtles codes, turtles road

## 3 bar-ready examples:
1. Turtles on the mic, watch the room align.
2. Turtles in the flow, make the speakers quake.
3. Say Turtles with the vision, watch the crowd awake.
