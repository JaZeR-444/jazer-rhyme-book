...
END: ces, cesd, cess / SLANT: ce, cese, cesy / MULTI: sequences mode, sequences codes, sequences road

## 3 bar-ready examples:
1. I move with Sequences, every step a headline.
2. Sequences on the mic, watch the room align.
3. Sequences in the flow, make the speakers quake.
