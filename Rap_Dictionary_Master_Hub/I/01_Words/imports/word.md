...
END: rts, rtsd, rtss / SLANT: rt, rtse, rtsy / MULTI: imports mode, imports codes, imports road

## 3 bar-ready examples:
1. Imports in the flow, make the speakers quake.
2. Say Imports with the vision, watch the crowd awake.
3. Imports in my cadence, heavy like a drumline.
