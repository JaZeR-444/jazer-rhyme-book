...
END: lap, lapd, laps / SLANT: la, lape, lapy / MULTI: overlap mode, overlap codes, overlap road

## 3 bar-ready examples:
1. Overlap in my cadence, heavy like a drumline.
2. I move with Overlap, every step a headline.
3. Overlap on the mic, watch the room align.
