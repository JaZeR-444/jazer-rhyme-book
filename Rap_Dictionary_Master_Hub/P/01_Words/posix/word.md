...
END: six, sixd, sixs / SLANT: si, sixe, sixy / MULTI: posix mode, posix codes, posix road

## 3 bar-ready examples:
1. Say Posix with the vision, watch the crowd awake.
2. Posix in my cadence, heavy like a drumline.
3. I move with Posix, every step a headline.
