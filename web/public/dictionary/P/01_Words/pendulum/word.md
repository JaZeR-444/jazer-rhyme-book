...
END: lum, lumd, lums / SLANT: lu, lume, lumy / MULTI: pendulum mode, pendulum codes, pendulum road

## 3 bar-ready examples:
1. Pendulum in my cadence, heavy like a drumline.
2. I move with Pendulum, every step a headline.
3. Pendulum on the mic, watch the room align.
