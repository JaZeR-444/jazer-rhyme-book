...
END: oss, ossd, osss / SLANT: os, osse, ossy / MULTI: toss mode, toss codes, toss road

## 3 bar-ready examples:
1. I move with Toss, every step a headline.
2. Toss on the mic, watch the room align.
3. Toss in the flow, make the speakers quake.
