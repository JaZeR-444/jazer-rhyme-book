...
END: rry, rryd, rrys / SLANT: rr, rrye, rryy / MULTI: boxberry mode, boxberry codes, boxberry road

## 3 bar-ready examples:
1. Boxberry on the mic, watch the room align.
2. Boxberry in the flow, make the speakers quake.
3. Say Boxberry with the vision, watch the crowd awake.
