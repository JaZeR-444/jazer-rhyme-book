...
END: tat, tatd, tats / SLANT: ta, tate, taty / MULTI: katat mode, katat codes, katat road

## 3 bar-ready examples:
1. I move with Katat, every step a headline.
2. Katat on the mic, watch the room align.
3. Katat in the flow, make the speakers quake.
