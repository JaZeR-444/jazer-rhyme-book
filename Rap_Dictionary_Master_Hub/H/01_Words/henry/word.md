...
END: nry, nryd, nrys / SLANT: nr, nrye, nryy / MULTI: henry mode, henry codes, henry road

## 3 bar-ready examples:
1. I move with Henry, every step a headline.
2. Henry on the mic, watch the room align.
3. Henry in the flow, make the speakers quake.
