...
END: ble, bled, bles / SLANT: bl, blee, bley / MULTI: visible mode, visible codes, visible road

## 3 bar-ready examples:
1. Visible in the flow, make the speakers quake.
2. Say Visible with the vision, watch the crowd awake.
3. Visible in my cadence, heavy like a drumline.
