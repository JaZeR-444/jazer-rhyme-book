...
END: rms, rmsd, rmss / SLANT: rm, rmse, rmsy / MULTI: norms mode, norms codes, norms road

## 3 bar-ready examples:
1. I move with Norms, every step a headline.
2. Norms on the mic, watch the room align.
3. Norms in the flow, make the speakers quake.
