...
END: run, rund, runs / SLANT: ru, rune, runy / MULTI: freerun mode, freerun codes, freerun road

## 3 bar-ready examples:
1. Freerun on the mic, watch the room align.
2. Freerun in the flow, make the speakers quake.
3. Say Freerun with the vision, watch the crowd awake.
