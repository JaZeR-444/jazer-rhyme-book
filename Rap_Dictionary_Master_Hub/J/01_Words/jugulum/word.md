...
END: lum, lumd, lums / SLANT: lu, lume, lumy / MULTI: jugulum mode, jugulum codes, jugulum road

## 3 bar-ready examples:
1. Jugulum on the mic, watch the room align.
2. Jugulum in the flow, make the speakers quake.
3. Say Jugulum with the vision, watch the crowd awake.
