...
END: ees, eesd, eess / SLANT: ee, eese, eesy / MULTI: trees mode, trees codes, trees road

## 3 bar-ready examples:
1. I move with Trees, every step a headline.
2. Trees on the mic, watch the room align.
3. Trees in the flow, make the speakers quake.
