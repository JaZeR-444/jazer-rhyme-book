...
END: kv, kvd, kvs / SLANT: k, kve, kvy / MULTI: kv mode, kv codes, kv road

## 3 bar-ready examples:
1. Say Kv with the vision, watch the crowd awake.
2. Kv in my cadence, heavy like a drumline.
3. I move with Kv, every step a headline.
