...
END: non, nond, nons / SLANT: no, none, nony / MULTI: xenon mode, xenon codes, xenon road

## 3 bar-ready examples:
1. I move with Xenon, every step a headline.
2. Xenon on the mic, watch the room align.
3. Xenon in the flow, make the speakers quake.
