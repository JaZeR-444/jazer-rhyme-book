...
END: yce, yced, yces / SLANT: yc, ycee, ycey / MULTI: joyce mode, joyce codes, joyce road

## 3 bar-ready examples:
1. Joyce in the flow, make the speakers quake.
2. Say Joyce with the vision, watch the crowd awake.
3. Joyce in my cadence, heavy like a drumline.
