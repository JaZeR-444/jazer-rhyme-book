...
END: unt, untd, unts / SLANT: un, unte, unty / MULTI: unmount mode, unmount codes, unmount road

## 3 bar-ready examples:
1. I move with Unmount, every step a headline.
2. Unmount on the mic, watch the room align.
3. Unmount in the flow, make the speakers quake.
