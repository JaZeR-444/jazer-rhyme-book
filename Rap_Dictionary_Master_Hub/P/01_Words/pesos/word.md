...
END: sos, sosd, soss / SLANT: so, sose, sosy / MULTI: pesos mode, pesos codes, pesos road

## 3 bar-ready examples:
1. I move with Pesos, every step a headline.
2. Pesos on the mic, watch the room align.
3. Pesos in the flow, make the speakers quake.
