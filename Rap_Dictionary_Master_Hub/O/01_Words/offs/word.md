...
END: ffs, ffsd, ffss / SLANT: ff, ffse, ffsy / MULTI: offs mode, offs codes, offs road

## 3 bar-ready examples:
1. Offs in the flow, make the speakers quake.
2. Say Offs with the vision, watch the crowd awake.
3. Offs in my cadence, heavy like a drumline.
