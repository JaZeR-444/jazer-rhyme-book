...
END: lys, lysd, lyss / SLANT: ly, lyse, lysy / MULTI: lys mode, lys codes, lys road

## 3 bar-ready examples:
1. Lys on the mic, watch the room align.
2. Lys in the flow, make the speakers quake.
3. Say Lys with the vision, watch the crowd awake.
