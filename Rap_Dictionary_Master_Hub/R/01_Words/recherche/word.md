...
END: che, ched, ches / SLANT: ch, chee, chey / MULTI: recherche mode, recherche codes, recherche road

## 3 bar-ready examples:
1. Recherche on the mic, watch the room align.
2. Recherche in the flow, make the speakers quake.
3. Say Recherche with the vision, watch the crowd awake.
