...
END: neu, neud, neus / SLANT: ne, neue, neuy / MULTI: neu mode, neu codes, neu road

## 3 bar-ready examples:
1. Neu on the mic, watch the room align.
2. Neu in the flow, make the speakers quake.
3. Say Neu with the vision, watch the crowd awake.
