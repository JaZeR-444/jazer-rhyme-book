...
END: one, oned, ones / SLANT: on, onee, oney / MULTI: redbone mode, redbone codes, redbone road

## 3 bar-ready examples:
1. I move with Redbone, every step a headline.
2. Redbone on the mic, watch the room align.
3. Redbone in the flow, make the speakers quake.
