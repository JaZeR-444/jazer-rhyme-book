...
END: rae, raed, raes / SLANT: ra, raee, raey / MULTI: quadrae mode, quadrae codes, quadrae road

## 3 bar-ready examples:
1. I move with Quadrae, every step a headline.
2. Quadrae on the mic, watch the room align.
3. Quadrae in the flow, make the speakers quake.
