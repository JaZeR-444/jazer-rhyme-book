...
END: ery, eryd, erys / SLANT: er, erye, eryy / MULTI: queery mode, queery codes, queery road

## 3 bar-ready examples:
1. I move with Queery, every step a headline.
2. Queery on the mic, watch the room align.
3. Queery in the flow, make the speakers quake.
