...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: unwilling mode, unwilling codes, unwilling road

## 3 bar-ready examples:
1. Unwilling on the mic, watch the room align.
2. Unwilling in the flow, make the speakers quake.
3. Say Unwilling with the vision, watch the crowd awake.
