...
END: ens, ensd, enss / SLANT: en, ense, ensy / MULTI: pollens mode, pollens codes, pollens road

## 3 bar-ready examples:
1. I move with Pollens, every step a headline.
2. Pollens on the mic, watch the room align.
3. Pollens in the flow, make the speakers quake.
