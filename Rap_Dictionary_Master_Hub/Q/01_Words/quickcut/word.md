...
END: cut, cutd, cuts / SLANT: cu, cute, cuty / MULTI: quickcut mode, quickcut codes, quickcut road

## 3 bar-ready examples:
1. I move with Quickcut, every step a headline.
2. Quickcut on the mic, watch the room align.
3. Quickcut in the flow, make the speakers quake.
