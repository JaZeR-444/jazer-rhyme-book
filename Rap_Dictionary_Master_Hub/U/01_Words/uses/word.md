...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: uses mode, uses codes, uses road

## 3 bar-ready examples:
1. Uses on the mic, watch the room align.
2. Uses in the flow, make the speakers quake.
3. Say Uses with the vision, watch the crowd awake.
