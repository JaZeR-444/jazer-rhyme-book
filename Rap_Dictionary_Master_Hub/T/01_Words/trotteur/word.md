...
END: eur, eurd, eurs / SLANT: eu, eure, eury / MULTI: trotteur mode, trotteur codes, trotteur road

## 3 bar-ready examples:
1. Trotteur in the flow, make the speakers quake.
2. Say Trotteur with the vision, watch the crowd awake.
3. Trotteur in my cadence, heavy like a drumline.
