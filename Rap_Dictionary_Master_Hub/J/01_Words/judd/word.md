...
END: udd, uddd, udds / SLANT: ud, udde, uddy / MULTI: judd mode, judd codes, judd road

## 3 bar-ready examples:
1. Say Judd with the vision, watch the crowd awake.
2. Judd in my cadence, heavy like a drumline.
3. I move with Judd, every step a headline.
