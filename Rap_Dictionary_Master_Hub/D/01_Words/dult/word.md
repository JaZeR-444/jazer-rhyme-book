...
END: ult, ultd, ults / SLANT: ul, ulte, ulty / MULTI: dult mode, dult codes, dult road

## 3 bar-ready examples:
1. Dult on the mic, watch the room align.
2. Dult in the flow, make the speakers quake.
3. Say Dult with the vision, watch the crowd awake.
