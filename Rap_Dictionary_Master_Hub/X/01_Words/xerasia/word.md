...
END: sia, siad, sias / SLANT: si, siae, siay / MULTI: xerasia mode, xerasia codes, xerasia road

## 3 bar-ready examples:
1. Xerasia on the mic, watch the room align.
2. Xerasia in the flow, make the speakers quake.
3. Say Xerasia with the vision, watch the crowd awake.
