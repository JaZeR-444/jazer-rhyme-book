...
END: ids, idsd, idss / SLANT: id, idse, idsy / MULTI: rebids mode, rebids codes, rebids road

## 3 bar-ready examples:
1. Rebids on the mic, watch the room align.
2. Rebids in the flow, make the speakers quake.
3. Say Rebids with the vision, watch the crowd awake.
