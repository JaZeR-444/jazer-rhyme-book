...
END: ick, ickd, icks / SLANT: ic, icke, icky / MULTI: joystick mode, joystick codes, joystick road

## 3 bar-ready examples:
1. Joystick in the flow, make the speakers quake.
2. Say Joystick with the vision, watch the crowd awake.
3. Joystick in my cadence, heavy like a drumline.
