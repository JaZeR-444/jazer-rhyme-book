...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: rebuilding mode, rebuilding codes, rebuilding road

## 3 bar-ready examples:
1. Say Rebuilding with the vision, watch the crowd awake.
2. Rebuilding in my cadence, heavy like a drumline.
3. I move with Rebuilding, every step a headline.
