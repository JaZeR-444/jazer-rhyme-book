...
END: nus, nusd, nuss / SLANT: nu, nuse, nusy / MULTI: linus mode, linus codes, linus road

## 3 bar-ready examples:
1. Linus on the mic, watch the room align.
2. Linus in the flow, make the speakers quake.
3. Say Linus with the vision, watch the crowd awake.
