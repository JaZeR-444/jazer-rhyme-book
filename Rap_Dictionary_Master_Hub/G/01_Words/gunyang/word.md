...
END: ang, angd, angs / SLANT: an, ange, angy / MULTI: gunyang mode, gunyang codes, gunyang road

## 3 bar-ready examples:
1. I move with Gunyang, every step a headline.
2. Gunyang on the mic, watch the room align.
3. Gunyang in the flow, make the speakers quake.
