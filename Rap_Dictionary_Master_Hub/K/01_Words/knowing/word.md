...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: knowing mode, knowing codes, knowing road

## 3 bar-ready examples:
1. I move with Knowing, every step a headline.
2. Knowing on the mic, watch the room align.
3. Knowing in the flow, make the speakers quake.
