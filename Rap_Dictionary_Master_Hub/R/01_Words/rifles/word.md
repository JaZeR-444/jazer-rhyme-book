...
END: les, lesd, less / SLANT: le, lese, lesy / MULTI: rifles mode, rifles codes, rifles road

## 3 bar-ready examples:
1. Rifles in the flow, make the speakers quake.
2. Say Rifles with the vision, watch the crowd awake.
3. Rifles in my cadence, heavy like a drumline.
