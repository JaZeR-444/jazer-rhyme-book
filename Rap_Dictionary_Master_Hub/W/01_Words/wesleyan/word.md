...
END: yan, yand, yans / SLANT: ya, yane, yany / MULTI: wesleyan mode, wesleyan codes, wesleyan road

## 3 bar-ready examples:
1. I move with Wesleyan, every step a headline.
2. Wesleyan on the mic, watch the room align.
3. Wesleyan in the flow, make the speakers quake.
