...
END: upc, upcd, upcs / SLANT: up, upce, upcy / MULTI: upc mode, upc codes, upc road

## 3 bar-ready examples:
1. Say Upc with the vision, watch the crowd awake.
2. Upc in my cadence, heavy like a drumline.
3. I move with Upc, every step a headline.
