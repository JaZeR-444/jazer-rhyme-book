...
END: ope, oped, opes / SLANT: op, opee, opey / MULTI: horoscope mode, horoscope codes, horoscope road

## 3 bar-ready examples:
1. Horoscope in the flow, make the speakers quake.
2. Say Horoscope with the vision, watch the crowd awake.
3. Horoscope in my cadence, heavy like a drumline.
