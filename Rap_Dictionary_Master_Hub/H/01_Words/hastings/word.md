...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: hastings mode, hastings codes, hastings road

## 3 bar-ready examples:
1. Say Hastings with the vision, watch the crowd awake.
2. Hastings in my cadence, heavy like a drumline.
3. I move with Hastings, every step a headline.
