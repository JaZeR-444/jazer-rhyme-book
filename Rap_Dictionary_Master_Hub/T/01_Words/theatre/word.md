...
END: tre, tred, tres / SLANT: tr, tree, trey / MULTI: theatre mode, theatre codes, theatre road

## 3 bar-ready examples:
1. I move with Theatre, every step a headline.
2. Theatre on the mic, watch the room align.
3. Theatre in the flow, make the speakers quake.
