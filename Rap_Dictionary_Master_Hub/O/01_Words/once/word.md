...
END: nce, nced, nces / SLANT: nc, ncee, ncey / MULTI: once mode, once codes, once road

## 3 bar-ready examples:
1. Once on the mic, watch the room align.
2. Once in the flow, make the speakers quake.
3. Say Once with the vision, watch the crowd awake.
