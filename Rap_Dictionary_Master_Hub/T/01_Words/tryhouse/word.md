...
END: use, used, uses / SLANT: us, usee, usey / MULTI: tryhouse mode, tryhouse codes, tryhouse road

## 3 bar-ready examples:
1. Tryhouse on the mic, watch the room align.
2. Tryhouse in the flow, make the speakers quake.
3. Say Tryhouse with the vision, watch the crowd awake.
