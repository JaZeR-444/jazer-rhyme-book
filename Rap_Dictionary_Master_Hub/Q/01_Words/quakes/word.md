...
END: kes, kesd, kess / SLANT: ke, kese, kesy / MULTI: quakes mode, quakes codes, quakes road

## 3 bar-ready examples:
1. Quakes on the mic, watch the room align.
2. Quakes in the flow, make the speakers quake.
3. Say Quakes with the vision, watch the crowd awake.
