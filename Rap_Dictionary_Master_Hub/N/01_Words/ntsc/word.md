...
END: tsc, tscd, tscs / SLANT: ts, tsce, tscy / MULTI: ntsc mode, ntsc codes, ntsc road

## 3 bar-ready examples:
1. Ntsc on the mic, watch the room align.
2. Ntsc in the flow, make the speakers quake.
3. Say Ntsc with the vision, watch the crowd awake.
