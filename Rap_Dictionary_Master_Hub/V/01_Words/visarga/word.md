...
END: rga, rgad, rgas / SLANT: rg, rgae, rgay / MULTI: visarga mode, visarga codes, visarga road

## 3 bar-ready examples:
1. I move with Visarga, every step a headline.
2. Visarga on the mic, watch the room align.
3. Visarga in the flow, make the speakers quake.
