...
END: use, used, uses / SLANT: us, usee, usey / MULTI: use mode, use codes, use road

## 3 bar-ready examples:
1. Use on the mic, watch the room align.
2. Use in the flow, make the speakers quake.
3. Say Use with the vision, watch the crowd awake.
