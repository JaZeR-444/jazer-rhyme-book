...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: increasing mode, increasing codes, increasing road

## 3 bar-ready examples:
1. Increasing in the flow, make the speakers quake.
2. Say Increasing with the vision, watch the crowd awake.
3. Increasing in my cadence, heavy like a drumline.
