...
END: tee, teed, tees / SLANT: te, teee, teey / MULTI: guarantee mode, guarantee codes, guarantee road

## 3 bar-ready examples:
1. I move with Guarantee, every step a headline.
2. Guarantee on the mic, watch the room align.
3. Guarantee in the flow, make the speakers quake.
