...
END: pon, pond, pons / SLANT: po, pone, pony / MULTI: yupon mode, yupon codes, yupon road

## 3 bar-ready examples:
1. Yupon on the mic, watch the room align.
2. Yupon in the flow, make the speakers quake.
3. Say Yupon with the vision, watch the crowd awake.
