...
END: pen, pend, pens / SLANT: pe, pene, peny / MULTI: open mode, open codes, open road

## 3 bar-ready examples:
1. Open on the mic, watch the room align.
2. Open in the flow, make the speakers quake.
3. Say Open with the vision, watch the crowd awake.
