...
END: hod, hodd, hods / SLANT: ho, hode, hody / MULTI: method mode, method codes, method road

## 3 bar-ready examples:
1. Method in the flow, make the speakers quake.
2. Say Method with the vision, watch the crowd awake.
3. Method in my cadence, heavy like a drumline.
