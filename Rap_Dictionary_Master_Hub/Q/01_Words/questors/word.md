...
END: ors, orsd, orss / SLANT: or, orse, orsy / MULTI: questors mode, questors codes, questors road

## 3 bar-ready examples:
1. Questors in the flow, make the speakers quake.
2. Say Questors with the vision, watch the crowd awake.
3. Questors in my cadence, heavy like a drumline.
