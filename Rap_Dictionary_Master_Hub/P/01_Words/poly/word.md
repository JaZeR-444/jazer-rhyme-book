...
END: oly, olyd, olys / SLANT: ol, olye, olyy / MULTI: poly mode, poly codes, poly road

## 3 bar-ready examples:
1. Poly on the mic, watch the room align.
2. Poly in the flow, make the speakers quake.
3. Say Poly with the vision, watch the crowd awake.
