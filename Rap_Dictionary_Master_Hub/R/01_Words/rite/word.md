...
END: ite, ited, ites / SLANT: it, itee, itey / MULTI: rite mode, rite codes, rite road

## 3 bar-ready examples:
1. Rite on the mic, watch the room align.
2. Rite in the flow, make the speakers quake.
3. Say Rite with the vision, watch the crowd awake.
