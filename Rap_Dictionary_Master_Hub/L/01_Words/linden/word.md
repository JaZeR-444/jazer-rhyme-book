...
END: den, dend, dens / SLANT: de, dene, deny / MULTI: linden mode, linden codes, linden road

## 3 bar-ready examples:
1. I move with Linden, every step a headline.
2. Linden on the mic, watch the room align.
3. Linden in the flow, make the speakers quake.
