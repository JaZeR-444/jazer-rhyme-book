...
END: lds, ldsd, ldss / SLANT: ld, ldse, ldsy / MULTI: households mode, households codes, households road

## 3 bar-ready examples:
1. Households on the mic, watch the room align.
2. Households in the flow, make the speakers quake.
3. Say Households with the vision, watch the crowd awake.
