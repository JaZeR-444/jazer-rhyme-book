...
END: kut, kutd, kuts / SLANT: ku, kute, kuty / MULTI: yakut mode, yakut codes, yakut road

## 3 bar-ready examples:
1. I move with Yakut, every step a headline.
2. Yakut on the mic, watch the room align.
3. Yakut in the flow, make the speakers quake.
