...
END: xt, xtd, xts / SLANT: x, xte, xty / MULTI: xt mode, xt codes, xt road

## 3 bar-ready examples:
1. Xt in the flow, make the speakers quake.
2. Say Xt with the vision, watch the crowd awake.
3. Xt in my cadence, heavy like a drumline.
