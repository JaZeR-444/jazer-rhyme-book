...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: folders mode, folders codes, folders road

## 3 bar-ready examples:
1. Folders on the mic, watch the room align.
2. Folders in the flow, make the speakers quake.
3. Say Folders with the vision, watch the crowd awake.
