...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: liking mode, liking codes, liking road

## 3 bar-ready examples:
1. Liking on the mic, watch the room align.
2. Liking in the flow, make the speakers quake.
3. Say Liking with the vision, watch the crowd awake.
