...
END: ock, ockd, ocks / SLANT: oc, ocke, ocky / MULTI: laddock mode, laddock codes, laddock road

## 3 bar-ready examples:
1. Say Laddock with the vision, watch the crowd awake.
2. Laddock in my cadence, heavy like a drumline.
3. I move with Laddock, every step a headline.
