...
END: ool, oold, ools / SLANT: oo, oole, ooly / MULTI: libtool mode, libtool codes, libtool road

## 3 bar-ready examples:
1. I move with Libtool, every step a headline.
2. Libtool on the mic, watch the room align.
3. Libtool in the flow, make the speakers quake.
