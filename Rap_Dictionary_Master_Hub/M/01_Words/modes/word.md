...
END: des, desd, dess / SLANT: de, dese, desy / MULTI: modes mode, modes codes, modes road

## 3 bar-ready examples:
1. Modes in my cadence, heavy like a drumline.
2. I move with Modes, every step a headline.
3. Modes on the mic, watch the room align.
