...
END: ees, eesd, eess / SLANT: ee, eese, eesy / MULTI: tees mode, tees codes, tees road

## 3 bar-ready examples:
1. Tees in the flow, make the speakers quake.
2. Say Tees with the vision, watch the crowd awake.
3. Tees in my cadence, heavy like a drumline.
