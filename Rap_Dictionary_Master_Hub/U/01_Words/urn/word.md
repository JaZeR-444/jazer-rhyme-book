...
END: urn, urnd, urns / SLANT: ur, urne, urny / MULTI: urn mode, urn codes, urn road

## 3 bar-ready examples:
1. I move with Urn, every step a headline.
2. Urn on the mic, watch the room align.
3. Urn in the flow, make the speakers quake.
