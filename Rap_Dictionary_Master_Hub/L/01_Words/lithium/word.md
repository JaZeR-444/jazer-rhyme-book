...
END: ium, iumd, iums / SLANT: iu, iume, iumy / MULTI: lithium mode, lithium codes, lithium road

## 3 bar-ready examples:
1. Say Lithium with the vision, watch the crowd awake.
2. Lithium in my cadence, heavy like a drumline.
3. I move with Lithium, every step a headline.
