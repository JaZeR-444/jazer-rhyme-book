...
END: nvt, nvtd, nvts / SLANT: nv, nvte, nvty / MULTI: invt mode, invt codes, invt road

## 3 bar-ready examples:
1. I move with Invt, every step a headline.
2. Invt on the mic, watch the room align.
3. Invt in the flow, make the speakers quake.
