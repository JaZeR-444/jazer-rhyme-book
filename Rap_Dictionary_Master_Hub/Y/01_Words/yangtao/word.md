...
END: tao, taod, taos / SLANT: ta, taoe, taoy / MULTI: yangtao mode, yangtao codes, yangtao road

## 3 bar-ready examples:
1. Yangtao on the mic, watch the room align.
2. Yangtao in the flow, make the speakers quake.
3. Say Yangtao with the vision, watch the crowd awake.
