...
END: ogs, ogsd, ogss / SLANT: og, ogse, ogsy / MULTI: weblogs mode, weblogs codes, weblogs road

## 3 bar-ready examples:
1. Weblogs in my cadence, heavy like a drumline.
2. I move with Weblogs, every step a headline.
3. Weblogs on the mic, watch the room align.
