...
END: zle, zled, zles / SLANT: zl, zlee, zley / MULTI: unpuzzle mode, unpuzzle codes, unpuzzle road

## 3 bar-ready examples:
1. Unpuzzle in my cadence, heavy like a drumline.
2. I move with Unpuzzle, every step a headline.
3. Unpuzzle on the mic, watch the room align.
