...
END: lls, llsd, llss / SLANT: ll, llse, llsy / MULTI: walls mode, walls codes, walls road

## 3 bar-ready examples:
1. I move with Walls, every step a headline.
2. Walls on the mic, watch the room align.
3. Walls in the flow, make the speakers quake.
