...
END: aur, aurd, aurs / SLANT: au, aure, aury / MULTI: tagaur mode, tagaur codes, tagaur road

## 3 bar-ready examples:
1. I move with Tagaur, every step a headline.
2. Tagaur on the mic, watch the room align.
3. Tagaur in the flow, make the speakers quake.
