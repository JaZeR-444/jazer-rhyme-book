...
END: est, estd, ests / SLANT: es, este, esty / MULTI: newest mode, newest codes, newest road

## 3 bar-ready examples:
1. I move with Newest, every step a headline.
2. Newest on the mic, watch the room align.
3. Newest in the flow, make the speakers quake.
