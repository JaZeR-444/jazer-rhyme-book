...
END: don, dond, dons / SLANT: do, done, dony / MULTI: xiphodon mode, xiphodon codes, xiphodon road

## 3 bar-ready examples:
1. I move with Xiphodon, every step a headline.
2. Xiphodon on the mic, watch the room align.
3. Xiphodon in the flow, make the speakers quake.
