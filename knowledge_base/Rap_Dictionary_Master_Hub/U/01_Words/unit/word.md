...
END: nit, nitd, nits / SLANT: ni, nite, nity / MULTI: unit mode, unit codes, unit road

## 3 bar-ready examples:
1. I move with Unit, every step a headline.
2. Unit on the mic, watch the room align.
3. Unit in the flow, make the speakers quake.
