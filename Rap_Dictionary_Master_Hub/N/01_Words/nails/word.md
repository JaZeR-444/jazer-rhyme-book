...
END: ils, ilsd, ilss / SLANT: il, ilse, ilsy / MULTI: nails mode, nails codes, nails road

## 3 bar-ready examples:
1. Nails in the flow, make the speakers quake.
2. Say Nails with the vision, watch the crowd awake.
3. Nails in my cadence, heavy like a drumline.
