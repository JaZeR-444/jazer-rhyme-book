...
END: lus, lusd, luss / SLANT: lu, luse, lusy / MULTI: jubilus mode, jubilus codes, jubilus road

## 3 bar-ready examples:
1. I move with Jubilus, every step a headline.
2. Jubilus on the mic, watch the room align.
3. Jubilus in the flow, make the speakers quake.
