...
END: mbs, mbsd, mbss / SLANT: mb, mbse, mbsy / MULTI: limbs mode, limbs codes, limbs road

## 3 bar-ready examples:
1. I move with Limbs, every step a headline.
2. Limbs on the mic, watch the room align.
3. Limbs in the flow, make the speakers quake.
