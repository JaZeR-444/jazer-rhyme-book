...
END: ges, gesd, gess / SLANT: ge, gese, gesy / MULTI: messages mode, messages codes, messages road

## 3 bar-ready examples:
1. Say Messages with the vision, watch the crowd awake.
2. Messages in my cadence, heavy like a drumline.
3. I move with Messages, every step a headline.
