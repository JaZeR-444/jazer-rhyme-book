...
END: ave, aved, aves / SLANT: av, avee, avey / MULTI: outknave mode, outknave codes, outknave road

## 3 bar-ready examples:
1. Say Outknave with the vision, watch the crowd awake.
2. Outknave in my cadence, heavy like a drumline.
3. I move with Outknave, every step a headline.
