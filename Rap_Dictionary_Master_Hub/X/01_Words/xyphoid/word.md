...
END: oid, oidd, oids / SLANT: oi, oide, oidy / MULTI: xyphoid mode, xyphoid codes, xyphoid road

## 3 bar-ready examples:
1. I move with Xyphoid, every step a headline.
2. Xyphoid on the mic, watch the room align.
3. Xyphoid in the flow, make the speakers quake.
