...
END: aui, auid, auis / SLANT: au, auie, auiy / MULTI: maui mode, maui codes, maui road

## 3 bar-ready examples:
1. Maui on the mic, watch the room align.
2. Maui in the flow, make the speakers quake.
3. Say Maui with the vision, watch the crowd awake.
