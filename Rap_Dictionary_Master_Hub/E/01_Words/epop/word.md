...
END: pop, popd, pops / SLANT: po, pope, popy / MULTI: epop mode, epop codes, epop road

## 3 bar-ready examples:
1. Epop on the mic, watch the room align.
2. Epop in the flow, make the speakers quake.
3. Say Epop with the vision, watch the crowd awake.
