...
END: nia, niad, nias / SLANT: ni, niae, niay / MULTI: pneumonia mode, pneumonia codes, pneumonia road

## 3 bar-ready examples:
1. I move with Pneumonia, every step a headline.
2. Pneumonia on the mic, watch the room align.
3. Pneumonia in the flow, make the speakers quake.
