...
END: ify, ifyd, ifys / SLANT: if, ifye, ifyy / MULTI: nullify mode, nullify codes, nullify road

## 3 bar-ready examples:
1. I move with Nullify, every step a headline.
2. Nullify on the mic, watch the room align.
3. Nullify in the flow, make the speakers quake.
