...
END: oks, oksd, okss / SLANT: ok, okse, oksy / MULTI: notebooks mode, notebooks codes, notebooks road

## 3 bar-ready examples:
1. Notebooks in my cadence, heavy like a drumline.
2. I move with Notebooks, every step a headline.
3. Notebooks on the mic, watch the room align.
