...
END: ede, eded, edes / SLANT: ed, edee, edey / MULTI: yephede mode, yephede codes, yephede road

## 3 bar-ready examples:
1. Say Yephede with the vision, watch the crowd awake.
2. Yephede in my cadence, heavy like a drumline.
3. I move with Yephede, every step a headline.
