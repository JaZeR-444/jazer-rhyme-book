...
END: est, estd, ests / SLANT: es, este, esty / MULTI: gentlest mode, gentlest codes, gentlest road

## 3 bar-ready examples:
1. I move with Gentlest, every step a headline.
2. Gentlest on the mic, watch the room align.
3. Gentlest in the flow, make the speakers quake.
