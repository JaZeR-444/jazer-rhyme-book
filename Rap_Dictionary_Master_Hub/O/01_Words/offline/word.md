...
END: ine, ined, ines / SLANT: in, inee, iney / MULTI: offline mode, offline codes, offline road

## 3 bar-ready examples:
1. Offline in the flow, make the speakers quake.
2. Say Offline with the vision, watch the crowd awake.
3. Offline in my cadence, heavy like a drumline.
