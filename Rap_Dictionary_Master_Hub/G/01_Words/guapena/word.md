...
END: ena, enad, enas / SLANT: en, enae, enay / MULTI: guapena mode, guapena codes, guapena road

## 3 bar-ready examples:
1. Guapena in the flow, make the speakers quake.
2. Say Guapena with the vision, watch the crowd awake.
3. Guapena in my cadence, heavy like a drumline.
