...
END: ose, osed, oses / SLANT: os, osee, osey / MULTI: sepose mode, sepose codes, sepose road

## 3 bar-ready examples:
1. Sepose on the mic, watch the room align.
2. Sepose in the flow, make the speakers quake.
3. Say Sepose with the vision, watch the crowd awake.
