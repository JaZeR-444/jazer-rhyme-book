...
END: rch, rchd, rchs / SLANT: rc, rche, rchy / MULTI: citysearch mode, citysearch codes, citysearch road

## 3 bar-ready examples:
1. Citysearch on the mic, watch the room align.
2. Citysearch in the flow, make the speakers quake.
3. Say Citysearch with the vision, watch the crowd awake.
