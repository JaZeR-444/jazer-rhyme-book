...
END: dcp, dcpd, dcps / SLANT: dc, dcpe, dcpy / MULTI: dcp mode, dcp codes, dcp road

## 3 bar-ready examples:
1. Dcp on the mic, watch the room align.
2. Dcp in the flow, make the speakers quake.
3. Say Dcp with the vision, watch the crowd awake.
