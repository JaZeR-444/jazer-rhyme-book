...
END: ond, ondd, onds / SLANT: on, onde, ondy / MULTI: fond mode, fond codes, fond road

## 3 bar-ready examples:
1. Fond on the mic, watch the room align.
2. Fond in the flow, make the speakers quake.
3. Say Fond with the vision, watch the crowd awake.
