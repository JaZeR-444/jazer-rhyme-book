...
END: str, strd, strs / SLANT: st, stre, stry / MULTI: msgstr mode, msgstr codes, msgstr road

## 3 bar-ready examples:
1. Msgstr in my cadence, heavy like a drumline.
2. I move with Msgstr, every step a headline.
3. Msgstr on the mic, watch the room align.
