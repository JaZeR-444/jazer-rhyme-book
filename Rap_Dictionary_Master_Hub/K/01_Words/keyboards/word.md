...
END: rds, rdsd, rdss / SLANT: rd, rdse, rdsy / MULTI: keyboards mode, keyboards codes, keyboards road

## 3 bar-ready examples:
1. Keyboards in the flow, make the speakers quake.
2. Say Keyboards with the vision, watch the crowd awake.
3. Keyboards in my cadence, heavy like a drumline.
