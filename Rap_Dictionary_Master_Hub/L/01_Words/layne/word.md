...
END: yne, yned, ynes / SLANT: yn, ynee, yney / MULTI: layne mode, layne codes, layne road

## 3 bar-ready examples:
1. Layne on the mic, watch the room align.
2. Layne in the flow, make the speakers quake.
3. Say Layne with the vision, watch the crowd awake.
