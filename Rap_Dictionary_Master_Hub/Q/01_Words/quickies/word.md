...
END: ies, iesd, iess / SLANT: ie, iese, iesy / MULTI: quickies mode, quickies codes, quickies road

## 3 bar-ready examples:
1. Say Quickies with the vision, watch the crowd awake.
2. Quickies in my cadence, heavy like a drumline.
3. I move with Quickies, every step a headline.
