...
END: aid, aidd, aids / SLANT: ai, aide, aidy / MULTI: waylaid mode, waylaid codes, waylaid road

## 3 bar-ready examples:
1. Waylaid on the mic, watch the room align.
2. Waylaid in the flow, make the speakers quake.
3. Say Waylaid with the vision, watch the crowd awake.
