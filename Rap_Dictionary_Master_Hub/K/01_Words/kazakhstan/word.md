...
END: tan, tand, tans / SLANT: ta, tane, tany / MULTI: kazakhstan mode, kazakhstan codes, kazakhstan road

## 3 bar-ready examples:
1. Kazakhstan on the mic, watch the room align.
2. Kazakhstan in the flow, make the speakers quake.
3. Say Kazakhstan with the vision, watch the crowd awake.
