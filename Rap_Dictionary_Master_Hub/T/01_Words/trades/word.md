...
END: des, desd, dess / SLANT: de, dese, desy / MULTI: trades mode, trades codes, trades road

## 3 bar-ready examples:
1. I move with Trades, every step a headline.
2. Trades on the mic, watch the room align.
3. Trades in the flow, make the speakers quake.
