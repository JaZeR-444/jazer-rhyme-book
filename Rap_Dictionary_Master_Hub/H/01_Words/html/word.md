...
END: tml, tmld, tmls / SLANT: tm, tmle, tmly / MULTI: html mode, html codes, html road

## 3 bar-ready examples:
1. Html in my cadence, heavy like a drumline.
2. I move with Html, every step a headline.
3. Html on the mic, watch the room align.
