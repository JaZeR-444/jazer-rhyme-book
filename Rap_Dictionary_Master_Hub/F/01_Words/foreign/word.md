...
END: ign, ignd, igns / SLANT: ig, igne, igny / MULTI: foreign mode, foreign codes, foreign road

## 3 bar-ready examples:
1. Foreign on the mic, watch the room align.
2. Foreign in the flow, make the speakers quake.
3. Say Foreign with the vision, watch the crowd awake.
