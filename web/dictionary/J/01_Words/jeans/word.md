...
END: ans, ansd, anss / SLANT: an, anse, ansy / MULTI: jeans mode, jeans codes, jeans road

## 3 bar-ready examples:
1. I move with Jeans, every step a headline.
2. Jeans on the mic, watch the room align.
3. Jeans in the flow, make the speakers quake.
