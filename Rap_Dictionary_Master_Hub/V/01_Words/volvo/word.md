...
END: lvo, lvod, lvos / SLANT: lv, lvoe, lvoy / MULTI: volvo mode, volvo codes, volvo road

## 3 bar-ready examples:
1. Volvo in the flow, make the speakers quake.
2. Say Volvo with the vision, watch the crowd awake.
3. Volvo in my cadence, heavy like a drumline.
