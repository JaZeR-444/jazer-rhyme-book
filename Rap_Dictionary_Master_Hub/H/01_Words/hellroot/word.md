...
END: oot, ootd, oots / SLANT: oo, oote, ooty / MULTI: hellroot mode, hellroot codes, hellroot road

## 3 bar-ready examples:
1. I move with Hellroot, every step a headline.
2. Hellroot on the mic, watch the room align.
3. Hellroot in the flow, make the speakers quake.
