...
END: one, oned, ones / SLANT: on, onee, oney / MULTI: tagetone mode, tagetone codes, tagetone road

## 3 bar-ready examples:
1. Tagetone in my cadence, heavy like a drumline.
2. I move with Tagetone, every step a headline.
3. Tagetone on the mic, watch the room align.
