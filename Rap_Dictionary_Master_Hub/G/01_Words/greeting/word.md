...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: greeting mode, greeting codes, greeting road

## 3 bar-ready examples:
1. Greeting in the flow, make the speakers quake.
2. Say Greeting with the vision, watch the crowd awake.
3. Greeting in my cadence, heavy like a drumline.
