...
END: lee, leed, lees / SLANT: le, leee, leey / MULTI: glee mode, glee codes, glee road

## 3 bar-ready examples:
1. Glee in the flow, make the speakers quake.
2. Say Glee with the vision, watch the crowd awake.
3. Glee in my cadence, heavy like a drumline.
