...
END: lee, leed, lees / SLANT: le, leee, leey / MULTI: lee mode, lee codes, lee road

## 3 bar-ready examples:
1. Lee in the flow, make the speakers quake.
2. Say Lee with the vision, watch the crowd awake.
3. Lee in my cadence, heavy like a drumline.
