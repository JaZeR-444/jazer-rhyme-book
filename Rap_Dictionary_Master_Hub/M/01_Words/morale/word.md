...
END: ale, aled, ales / SLANT: al, alee, aley / MULTI: morale mode, morale codes, morale road

## 3 bar-ready examples:
1. Morale in the flow, make the speakers quake.
2. Say Morale with the vision, watch the crowd awake.
3. Morale in my cadence, heavy like a drumline.
