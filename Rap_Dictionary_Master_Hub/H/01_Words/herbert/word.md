...
END: ert, ertd, erts / SLANT: er, erte, erty / MULTI: herbert mode, herbert codes, herbert road

## 3 bar-ready examples:
1. Herbert in my cadence, heavy like a drumline.
2. I move with Herbert, every step a headline.
3. Herbert on the mic, watch the room align.
