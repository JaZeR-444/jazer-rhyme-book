...
END: ang, angd, angs / SLANT: an, ange, angy / MULTI: sundang mode, sundang codes, sundang road

## 3 bar-ready examples:
1. I move with Sundang, every step a headline.
2. Sundang on the mic, watch the room align.
3. Sundang in the flow, make the speakers quake.
