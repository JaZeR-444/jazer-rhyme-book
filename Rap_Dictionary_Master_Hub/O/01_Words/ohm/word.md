...
END: ohm, ohmd, ohms / SLANT: oh, ohme, ohmy / MULTI: ohm mode, ohm codes, ohm road

## 3 bar-ready examples:
1. I move with Ohm, every step a headline.
2. Ohm on the mic, watch the room align.
3. Ohm in the flow, make the speakers quake.
