...
END: are, ared, ares / SLANT: ar, aree, arey / MULTI: middleware mode, middleware codes, middleware road

## 3 bar-ready examples:
1. Middleware in the flow, make the speakers quake.
2. Say Middleware with the vision, watch the crowd awake.
3. Middleware in my cadence, heavy like a drumline.
