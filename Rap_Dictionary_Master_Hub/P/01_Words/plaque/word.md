...
END: que, qued, ques / SLANT: qu, quee, quey / MULTI: plaque mode, plaque codes, plaque road

## 3 bar-ready examples:
1. I move with Plaque, every step a headline.
2. Plaque on the mic, watch the room align.
3. Plaque in the flow, make the speakers quake.
