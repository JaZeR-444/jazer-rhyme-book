...
END: lat, latd, lats / SLANT: la, late, laty / MULTI: explat mode, explat codes, explat road

## 3 bar-ready examples:
1. Explat in the flow, make the speakers quake.
2. Say Explat with the vision, watch the crowd awake.
3. Explat in my cadence, heavy like a drumline.
