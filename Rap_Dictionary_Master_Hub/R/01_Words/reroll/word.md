...
END: oll, olld, olls / SLANT: ol, olle, olly / MULTI: reroll mode, reroll codes, reroll road

## 3 bar-ready examples:
1. Reroll on the mic, watch the room align.
2. Reroll in the flow, make the speakers quake.
3. Say Reroll with the vision, watch the crowd awake.
