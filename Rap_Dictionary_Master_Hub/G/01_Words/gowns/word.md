...
END: wns, wnsd, wnss / SLANT: wn, wnse, wnsy / MULTI: gowns mode, gowns codes, gowns road

## 3 bar-ready examples:
1. Gowns on the mic, watch the room align.
2. Gowns in the flow, make the speakers quake.
3. Say Gowns with the vision, watch the crowd awake.
