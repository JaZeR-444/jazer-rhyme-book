...
END: cha, chad, chas / SLANT: ch, chae, chay / MULTI: morcha mode, morcha codes, morcha road

## 3 bar-ready examples:
1. Morcha in the flow, make the speakers quake.
2. Say Morcha with the vision, watch the crowd awake.
3. Morcha in my cadence, heavy like a drumline.
