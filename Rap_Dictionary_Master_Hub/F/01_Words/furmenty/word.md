...
END: nty, ntyd, ntys / SLANT: nt, ntye, ntyy / MULTI: furmenty mode, furmenty codes, furmenty road

## 3 bar-ready examples:
1. Furmenty on the mic, watch the room align.
2. Furmenty in the flow, make the speakers quake.
3. Say Furmenty with the vision, watch the crowd awake.
