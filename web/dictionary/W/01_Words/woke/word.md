...
END: oke, oked, okes / SLANT: ok, okee, okey / MULTI: woke mode, woke codes, woke road

## 3 bar-ready examples:
1. Woke in the flow, make the speakers quake.
2. Say Woke with the vision, watch the crowd awake.
3. Woke in my cadence, heavy like a drumline.
