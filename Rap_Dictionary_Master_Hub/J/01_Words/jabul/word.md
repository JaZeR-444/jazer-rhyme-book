...
END: bul, buld, buls / SLANT: bu, bule, buly / MULTI: jabul mode, jabul codes, jabul road

## 3 bar-ready examples:
1. Jabul on the mic, watch the room align.
2. Jabul in the flow, make the speakers quake.
3. Say Jabul with the vision, watch the crowd awake.
