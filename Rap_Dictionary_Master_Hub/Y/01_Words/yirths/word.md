...
END: ths, thsd, thss / SLANT: th, thse, thsy / MULTI: yirths mode, yirths codes, yirths road

## 3 bar-ready examples:
1. I move with Yirths, every step a headline.
2. Yirths on the mic, watch the room align.
3. Yirths in the flow, make the speakers quake.
