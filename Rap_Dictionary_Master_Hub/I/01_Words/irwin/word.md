...
END: win, wind, wins / SLANT: wi, wine, winy / MULTI: irwin mode, irwin codes, irwin road

## 3 bar-ready examples:
1. I move with Irwin, every step a headline.
2. Irwin on the mic, watch the room align.
3. Irwin in the flow, make the speakers quake.
