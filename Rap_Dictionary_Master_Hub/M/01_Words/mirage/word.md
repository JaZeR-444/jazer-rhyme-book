...
END: age, aged, ages / SLANT: ag, agee, agey / MULTI: mirage mode, mirage codes, mirage road

## 3 bar-ready examples:
1. I move with Mirage, every step a headline.
2. Mirage on the mic, watch the room align.
3. Mirage in the flow, make the speakers quake.
