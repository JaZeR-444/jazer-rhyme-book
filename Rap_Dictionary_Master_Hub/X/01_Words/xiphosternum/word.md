...
END: num, numd, nums / SLANT: nu, nume, numy / MULTI: xiphosternum mode, xiphosternum codes, xiphosternum road

## 3 bar-ready examples:
1. Xiphosternum in the flow, make the speakers quake.
2. Say Xiphosternum with the vision, watch the crowd awake.
3. Xiphosternum in my cadence, heavy like a drumline.
