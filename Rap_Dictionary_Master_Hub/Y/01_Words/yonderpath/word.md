...
END: ath, athd, aths / SLANT: at, athe, athy / MULTI: yonderpath mode, yonderpath codes, yonderpath road

## 3 bar-ready examples:
1. Say Yonderpath with the vision, watch the crowd awake.
2. Yonderpath in my cadence, heavy like a drumline.
3. I move with Yonderpath, every step a headline.
