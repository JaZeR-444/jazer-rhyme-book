...
END: rin, rind, rins / SLANT: ri, rine, riny / MULTI: jaborin mode, jaborin codes, jaborin road

## 3 bar-ready examples:
1. Say Jaborin with the vision, watch the crowd awake.
2. Jaborin in my cadence, heavy like a drumline.
3. I move with Jaborin, every step a headline.
