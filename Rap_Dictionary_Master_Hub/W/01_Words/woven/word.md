...
END: ven, vend, vens / SLANT: ve, vene, veny / MULTI: woven mode, woven codes, woven road

## 3 bar-ready examples:
1. I move with Woven, every step a headline.
2. Woven on the mic, watch the room align.
3. Woven in the flow, make the speakers quake.
