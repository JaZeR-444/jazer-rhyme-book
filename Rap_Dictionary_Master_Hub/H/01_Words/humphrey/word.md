...
END: rey, reyd, reys / SLANT: re, reye, reyy / MULTI: humphrey mode, humphrey codes, humphrey road

## 3 bar-ready examples:
1. I move with Humphrey, every step a headline.
2. Humphrey on the mic, watch the room align.
3. Humphrey in the flow, make the speakers quake.
