...
END: din, dind, dins / SLANT: di, dine, diny / MULTI: xylidin mode, xylidin codes, xylidin road

## 3 bar-ready examples:
1. Xylidin in the flow, make the speakers quake.
2. Say Xylidin with the vision, watch the crowd awake.
3. Xylidin in my cadence, heavy like a drumline.
