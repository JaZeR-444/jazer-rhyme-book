...
END: gen, gend, gens / SLANT: ge, gene, geny / MULTI: keygen mode, keygen codes, keygen road

## 3 bar-ready examples:
1. I move with Keygen, every step a headline.
2. Keygen on the mic, watch the room align.
3. Keygen in the flow, make the speakers quake.
