...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: feeders mode, feeders codes, feeders road

## 3 bar-ready examples:
1. Feeders on the mic, watch the room align.
2. Feeders in the flow, make the speakers quake.
3. Say Feeders with the vision, watch the crowd awake.
