...
END: bos, bosd, boss / SLANT: bo, bose, bosy / MULTI: jambos mode, jambos codes, jambos road

## 3 bar-ready examples:
1. Jambos on the mic, watch the room align.
2. Jambos in the flow, make the speakers quake.
3. Say Jambos with the vision, watch the crowd awake.
