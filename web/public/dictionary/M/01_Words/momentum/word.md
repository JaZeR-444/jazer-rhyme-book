...
END: tum, tumd, tums / SLANT: tu, tume, tumy / MULTI: momentum mode, momentum codes, momentum road

## 3 bar-ready examples:
1. I move with Momentum, every step a headline.
2. Momentum on the mic, watch the room align.
3. Momentum in the flow, make the speakers quake.
