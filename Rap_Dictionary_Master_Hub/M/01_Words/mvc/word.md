...
END: mvc, mvcd, mvcs / SLANT: mv, mvce, mvcy / MULTI: mvc mode, mvc codes, mvc road

## 3 bar-ready examples:
1. Mvc on the mic, watch the room align.
2. Mvc in the flow, make the speakers quake.
3. Say Mvc with the vision, watch the crowd awake.
