...
END: eys, eysd, eyss / SLANT: ey, eyse, eysy / MULTI: valleys mode, valleys codes, valleys road

## 3 bar-ready examples:
1. I move with Valleys, every step a headline.
2. Valleys on the mic, watch the room align.
3. Valleys in the flow, make the speakers quake.
