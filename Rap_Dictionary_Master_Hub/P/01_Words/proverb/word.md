...
END: erb, erbd, erbs / SLANT: er, erbe, erby / MULTI: proverb mode, proverb codes, proverb road

## 3 bar-ready examples:
1. Proverb in the flow, make the speakers quake.
2. Say Proverb with the vision, watch the crowd awake.
3. Proverb in my cadence, heavy like a drumline.
