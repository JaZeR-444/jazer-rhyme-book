...
END: rve, rved, rves / SLANT: rv, rvee, rvey / MULTI: observe mode, observe codes, observe road

## 3 bar-ready examples:
1. Observe in the flow, make the speakers quake.
2. Say Observe with the vision, watch the crowd awake.
3. Observe in my cadence, heavy like a drumline.
