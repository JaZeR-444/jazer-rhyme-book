...
END: imp, impd, imps / SLANT: im, impe, impy / MULTI: limp mode, limp codes, limp road

## 3 bar-ready examples:
1. Limp on the mic, watch the room align.
2. Limp in the flow, make the speakers quake.
3. Say Limp with the vision, watch the crowd awake.
