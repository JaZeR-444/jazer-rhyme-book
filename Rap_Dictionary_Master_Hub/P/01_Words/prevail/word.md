...
END: ail, aild, ails / SLANT: ai, aile, aily / MULTI: prevail mode, prevail codes, prevail road

## 3 bar-ready examples:
1. Prevail in my cadence, heavy like a drumline.
2. I move with Prevail, every step a headline.
3. Prevail on the mic, watch the room align.
