...
END: tes, tesd, tess / SLANT: te, tese, tesy / MULTI: wastes mode, wastes codes, wastes road

## 3 bar-ready examples:
1. I move with Wastes, every step a headline.
2. Wastes on the mic, watch the room align.
3. Wastes in the flow, make the speakers quake.
