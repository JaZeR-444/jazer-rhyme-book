...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: reasoning mode, reasoning codes, reasoning road

## 3 bar-ready examples:
1. Reasoning in my cadence, heavy like a drumline.
2. I move with Reasoning, every step a headline.
3. Reasoning on the mic, watch the room align.
