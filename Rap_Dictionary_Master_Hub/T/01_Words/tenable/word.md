...
END: ble, bled, bles / SLANT: bl, blee, bley / MULTI: tenable mode, tenable codes, tenable road

## 3 bar-ready examples:
1. Tenable in my cadence, heavy like a drumline.
2. I move with Tenable, every step a headline.
3. Tenable on the mic, watch the room align.
