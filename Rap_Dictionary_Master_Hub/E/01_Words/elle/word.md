...
END: lle, lled, lles / SLANT: ll, llee, lley / MULTI: elle mode, elle codes, elle road

## 3 bar-ready examples:
1. Elle in the flow, make the speakers quake.
2. Say Elle with the vision, watch the crowd awake.
3. Elle in my cadence, heavy like a drumline.
