...
END: y, yd, ys / SLANT: y / MULTI: y mode, y codes, y road

## 3 bar-ready examples:
1. I move with Y, every step a headline.
2. Y on the mic, watch the room align.
3. Y in the flow, make the speakers quake.
