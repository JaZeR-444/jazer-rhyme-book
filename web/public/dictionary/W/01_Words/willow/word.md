...
END: low, lowd, lows / SLANT: lo, lowe, lowy / MULTI: willow mode, willow codes, willow road

## 3 bar-ready examples:
1. I move with Willow, every step a headline.
2. Willow on the mic, watch the room align.
3. Willow in the flow, make the speakers quake.
