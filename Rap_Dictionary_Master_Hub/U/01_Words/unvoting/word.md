...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: unvoting mode, unvoting codes, unvoting road

## 3 bar-ready examples:
1. I move with Unvoting, every step a headline.
2. Unvoting on the mic, watch the room align.
3. Unvoting in the flow, make the speakers quake.
