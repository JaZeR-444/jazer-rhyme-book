...
END: mad, madd, mads / SLANT: ma, made, mady / MULTI: nomad mode, nomad codes, nomad road

## 3 bar-ready examples:
1. Say Nomad with the vision, watch the crowd awake.
2. Nomad in my cadence, heavy like a drumline.
3. I move with Nomad, every step a headline.
