...
END: rta, rtad, rtas / SLANT: rt, rtae, rtay / MULTI: quarta mode, quarta codes, quarta road

## 3 bar-ready examples:
1. I move with Quarta, every step a headline.
2. Quarta on the mic, watch the room align.
3. Quarta in the flow, make the speakers quake.
