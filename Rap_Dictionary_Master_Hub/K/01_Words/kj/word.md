...
END: kj, kjd, kjs / SLANT: k, kje, kjy / MULTI: kj mode, kj codes, kj road

## 3 bar-ready examples:
1. Kj on the mic, watch the room align.
2. Kj in the flow, make the speakers quake.
3. Say Kj with the vision, watch the crowd awake.
