...
END: awn, awnd, awns / SLANT: aw, awne, awny / MULTI: jawn mode, jawn codes, jawn road

## 3 bar-ready examples:
1. I move with Jawn, every step a headline.
2. Jawn on the mic, watch the room align.
3. Jawn in the flow, make the speakers quake.
