...
END: rds, rdsd, rdss / SLANT: rd, rdse, rdsy / MULTI: lords mode, lords codes, lords road

## 3 bar-ready examples:
1. I move with Lords, every step a headline.
2. Lords on the mic, watch the room align.
3. Lords in the flow, make the speakers quake.
