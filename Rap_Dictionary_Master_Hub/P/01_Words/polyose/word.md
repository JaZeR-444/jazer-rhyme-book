...
END: ose, osed, oses / SLANT: os, osee, osey / MULTI: polyose mode, polyose codes, polyose road

## 3 bar-ready examples:
1. Polyose in the flow, make the speakers quake.
2. Say Polyose with the vision, watch the crowd awake.
3. Polyose in my cadence, heavy like a drumline.
