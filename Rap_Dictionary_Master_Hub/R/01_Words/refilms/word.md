...
END: lms, lmsd, lmss / SLANT: lm, lmse, lmsy / MULTI: refilms mode, refilms codes, refilms road

## 3 bar-ready examples:
1. Refilms on the mic, watch the room align.
2. Refilms in the flow, make the speakers quake.
3. Say Refilms with the vision, watch the crowd awake.
