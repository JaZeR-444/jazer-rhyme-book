...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: upgrading mode, upgrading codes, upgrading road

## 3 bar-ready examples:
1. I move with Upgrading, every step a headline.
2. Upgrading on the mic, watch the room align.
3. Upgrading in the flow, make the speakers quake.
