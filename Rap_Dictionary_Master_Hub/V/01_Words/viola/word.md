...
END: ola, olad, olas / SLANT: ol, olae, olay / MULTI: viola mode, viola codes, viola road

## 3 bar-ready examples:
1. Viola on the mic, watch the room align.
2. Viola in the flow, make the speakers quake.
3. Say Viola with the vision, watch the crowd awake.
