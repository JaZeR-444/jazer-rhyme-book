...
END: ows, owsd, owss / SLANT: ow, owse, owsy / MULTI: flows mode, flows codes, flows road

## 3 bar-ready examples:
1. Flows in the flow, make the speakers quake.
2. Say Flows with the vision, watch the crowd awake.
3. Flows in my cadence, heavy like a drumline.
