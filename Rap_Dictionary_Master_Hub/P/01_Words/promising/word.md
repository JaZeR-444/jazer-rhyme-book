...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: promising mode, promising codes, promising road

## 3 bar-ready examples:
1. I move with Promising, every step a headline.
2. Promising on the mic, watch the room align.
3. Promising in the flow, make the speakers quake.
