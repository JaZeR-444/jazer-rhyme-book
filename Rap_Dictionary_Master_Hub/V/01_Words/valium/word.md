...
END: ium, iumd, iums / SLANT: iu, iume, iumy / MULTI: valium mode, valium codes, valium road

## 3 bar-ready examples:
1. I move with Valium, every step a headline.
2. Valium on the mic, watch the room align.
3. Valium in the flow, make the speakers quake.
