...
END: wie, wied, wies / SLANT: wi, wiee, wiey / MULTI: wie mode, wie codes, wie road

## 3 bar-ready examples:
1. I move with Wie, every step a headline.
2. Wie on the mic, watch the room align.
3. Wie in the flow, make the speakers quake.
