...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: rating mode, rating codes, rating road

## 3 bar-ready examples:
1. I move with Rating, every step a headline.
2. Rating on the mic, watch the room align.
3. Rating in the flow, make the speakers quake.
