...
END: ere, ered, eres / SLANT: er, eree, erey / MULTI: umbrere mode, umbrere codes, umbrere road

## 3 bar-ready examples:
1. Umbrere on the mic, watch the room align.
2. Umbrere in the flow, make the speakers quake.
3. Say Umbrere with the vision, watch the crowd awake.
