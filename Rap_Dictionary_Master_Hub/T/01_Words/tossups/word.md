...
END: ups, upsd, upss / SLANT: up, upse, upsy / MULTI: tossups mode, tossups codes, tossups road

## 3 bar-ready examples:
1. I move with Tossups, every step a headline.
2. Tossups on the mic, watch the room align.
3. Tossups in the flow, make the speakers quake.
