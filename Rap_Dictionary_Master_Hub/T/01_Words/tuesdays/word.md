...
END: ays, aysd, ayss / SLANT: ay, ayse, aysy / MULTI: tuesdays mode, tuesdays codes, tuesdays road

## 3 bar-ready examples:
1. I move with Tuesdays, every step a headline.
2. Tuesdays on the mic, watch the room align.
3. Tuesdays in the flow, make the speakers quake.
