...
END: sse, ssed, sses / SLANT: ss, ssee, ssey / MULTI: klosse mode, klosse codes, klosse road

## 3 bar-ready examples:
1. Klosse on the mic, watch the room align.
2. Klosse in the flow, make the speakers quake.
3. Say Klosse with the vision, watch the crowd awake.
