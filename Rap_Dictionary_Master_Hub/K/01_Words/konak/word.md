...
END: nak, nakd, naks / SLANT: na, nake, naky / MULTI: konak mode, konak codes, konak road

## 3 bar-ready examples:
1. Konak on the mic, watch the room align.
2. Konak in the flow, make the speakers quake.
3. Say Konak with the vision, watch the crowd awake.
