...
END: rge, rged, rges / SLANT: rg, rgee, rgey / MULTI: xenoncharge mode, xenoncharge codes, xenoncharge road

## 3 bar-ready examples:
1. I move with Xenoncharge, every step a headline.
2. Xenoncharge on the mic, watch the room align.
3. Xenoncharge in the flow, make the speakers quake.
