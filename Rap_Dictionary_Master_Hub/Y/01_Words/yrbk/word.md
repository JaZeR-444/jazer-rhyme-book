...
END: rbk, rbkd, rbks / SLANT: rb, rbke, rbky / MULTI: yrbk mode, yrbk codes, yrbk road

## 3 bar-ready examples:
1. Yrbk on the mic, watch the room align.
2. Yrbk in the flow, make the speakers quake.
3. Say Yrbk with the vision, watch the crowd awake.
