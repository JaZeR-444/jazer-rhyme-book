...
END: lay, layd, lays / SLANT: la, laye, layy / MULTI: relay mode, relay codes, relay road

## 3 bar-ready examples:
1. Relay on the mic, watch the room align.
2. Relay in the flow, make the speakers quake.
3. Say Relay with the vision, watch the crowd awake.
