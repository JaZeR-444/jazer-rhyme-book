...
END: ont, ontd, onts / SLANT: on, onte, onty / MULTI: ont mode, ont codes, ont road

## 3 bar-ready examples:
1. I move with Ont, every step a headline.
2. Ont on the mic, watch the room align.
3. Ont in the flow, make the speakers quake.
