...
END: one, oned, ones / SLANT: on, onee, oney / MULTI: none mode, none codes, none road

## 3 bar-ready examples:
1. I move with None, every step a headline.
2. None on the mic, watch the room align.
3. None in the flow, make the speakers quake.
