...
END: eaf, eafd, eafs / SLANT: ea, eafe, eafy / MULTI: leaf mode, leaf codes, leaf road

## 3 bar-ready examples:
1. Leaf in the flow, make the speakers quake.
2. Say Leaf with the vision, watch the crowd awake.
3. Leaf in my cadence, heavy like a drumline.
