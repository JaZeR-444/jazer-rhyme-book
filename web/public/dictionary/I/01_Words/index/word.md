...
END: dex, dexd, dexs / SLANT: de, dexe, dexy / MULTI: index mode, index codes, index road

## 3 bar-ready examples:
1. Index on the mic, watch the room align.
2. Index in the flow, make the speakers quake.
3. Say Index with the vision, watch the crowd awake.
