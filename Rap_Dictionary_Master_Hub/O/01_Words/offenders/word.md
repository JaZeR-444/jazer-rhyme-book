...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: offenders mode, offenders codes, offenders road

## 3 bar-ready examples:
1. I move with Offenders, every step a headline.
2. Offenders on the mic, watch the room align.
3. Offenders in the flow, make the speakers quake.
