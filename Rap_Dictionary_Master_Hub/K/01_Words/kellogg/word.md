...
END: ogg, oggd, oggs / SLANT: og, ogge, oggy / MULTI: kellogg mode, kellogg codes, kellogg road

## 3 bar-ready examples:
1. Kellogg in the flow, make the speakers quake.
2. Say Kellogg with the vision, watch the crowd awake.
3. Kellogg in my cadence, heavy like a drumline.
