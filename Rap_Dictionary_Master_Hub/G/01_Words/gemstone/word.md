...
END: one, oned, ones / SLANT: on, onee, oney / MULTI: gemstone mode, gemstone codes, gemstone road

## 3 bar-ready examples:
1. Gemstone on the mic, watch the room align.
2. Gemstone in the flow, make the speakers quake.
3. Say Gemstone with the vision, watch the crowd awake.
