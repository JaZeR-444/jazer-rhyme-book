...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: using mode, using codes, using road

## 3 bar-ready examples:
1. Using in the flow, make the speakers quake.
2. Say Using with the vision, watch the crowd awake.
3. Using in my cadence, heavy like a drumline.
