...
END: ope, oped, opes / SLANT: op, opee, opey / MULTI: quickscope mode, quickscope codes, quickscope road

## 3 bar-ready examples:
1. Quickscope in my cadence, heavy like a drumline.
2. I move with Quickscope, every step a headline.
3. Quickscope on the mic, watch the room align.
