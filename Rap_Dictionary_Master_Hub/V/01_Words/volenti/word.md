...
END: nti, ntid, ntis / SLANT: nt, ntie, ntiy / MULTI: volenti mode, volenti codes, volenti road

## 3 bar-ready examples:
1. Volenti on the mic, watch the room align.
2. Volenti in the flow, make the speakers quake.
3. Say Volenti with the vision, watch the crowd awake.
