...
END: rin, rind, rins / SLANT: ri, rine, riny / MULTI: lutrin mode, lutrin codes, lutrin road

## 3 bar-ready examples:
1. Lutrin on the mic, watch the room align.
2. Lutrin in the flow, make the speakers quake.
3. Say Lutrin with the vision, watch the crowd awake.
