...
END: son, sond, sons / SLANT: so, sone, sony / MULTI: poison mode, poison codes, poison road

## 3 bar-ready examples:
1. Poison on the mic, watch the room align.
2. Poison in the flow, make the speakers quake.
3. Say Poison with the vision, watch the crowd awake.
