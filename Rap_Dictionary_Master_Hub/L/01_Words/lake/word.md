...
END: ake, aked, akes / SLANT: ak, akee, akey / MULTI: lake mode, lake codes, lake road

## 3 bar-ready examples:
1. Lake on the mic, watch the room align.
2. Lake in the flow, make the speakers quake.
3. Say Lake with the vision, watch the crowd awake.
