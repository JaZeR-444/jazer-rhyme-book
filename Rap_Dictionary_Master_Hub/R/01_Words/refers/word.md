...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: refers mode, refers codes, refers road

## 3 bar-ready examples:
1. I move with Refers, every step a headline.
2. Refers on the mic, watch the room align.
3. Refers in the flow, make the speakers quake.
