...
END: tin, tind, tins / SLANT: ti, tine, tiny / MULTI: vbulletin mode, vbulletin codes, vbulletin road

## 3 bar-ready examples:
1. I move with Vbulletin, every step a headline.
2. Vbulletin on the mic, watch the room align.
3. Vbulletin in the flow, make the speakers quake.
