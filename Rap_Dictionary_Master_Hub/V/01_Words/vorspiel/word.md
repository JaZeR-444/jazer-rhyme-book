...
END: iel, ield, iels / SLANT: ie, iele, iely / MULTI: vorspiel mode, vorspiel codes, vorspiel road

## 3 bar-ready examples:
1. Vorspiel in the flow, make the speakers quake.
2. Say Vorspiel with the vision, watch the crowd awake.
3. Vorspiel in my cadence, heavy like a drumline.
