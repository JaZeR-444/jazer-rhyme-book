...
END: ich, ichd, ichs / SLANT: ic, iche, ichy / MULTI: ipswich mode, ipswich codes, ipswich road

## 3 bar-ready examples:
1. Ipswich on the mic, watch the room align.
2. Ipswich in the flow, make the speakers quake.
3. Say Ipswich with the vision, watch the crowd awake.
