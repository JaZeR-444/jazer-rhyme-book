...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: uncaring mode, uncaring codes, uncaring road

## 3 bar-ready examples:
1. I move with Uncaring, every step a headline.
2. Uncaring on the mic, watch the room align.
3. Uncaring in the flow, make the speakers quake.
