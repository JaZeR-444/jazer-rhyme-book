...
END: ups, upsd, upss / SLANT: up, upse, upsy / MULTI: soups mode, soups codes, soups road

## 3 bar-ready examples:
1. Soups on the mic, watch the room align.
2. Soups in the flow, make the speakers quake.
3. Say Soups with the vision, watch the crowd awake.
