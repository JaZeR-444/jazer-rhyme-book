...
END: aft, aftd, afts / SLANT: af, afte, afty / MULTI: updraft mode, updraft codes, updraft road

## 3 bar-ready examples:
1. Updraft in the flow, make the speakers quake.
2. Say Updraft with the vision, watch the crowd awake.
3. Updraft in my cadence, heavy like a drumline.
