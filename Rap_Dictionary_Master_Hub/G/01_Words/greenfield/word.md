...
END: eld, eldd, elds / SLANT: el, elde, eldy / MULTI: greenfield mode, greenfield codes, greenfield road

## 3 bar-ready examples:
1. Greenfield in the flow, make the speakers quake.
2. Say Greenfield with the vision, watch the crowd awake.
3. Greenfield in my cadence, heavy like a drumline.
