...
END: ima, imad, imas / SLANT: im, imae, imay / MULTI: yakima mode, yakima codes, yakima road

## 3 bar-ready examples:
1. Yakima in the flow, make the speakers quake.
2. Say Yakima with the vision, watch the crowd awake.
3. Yakima in my cadence, heavy like a drumline.
