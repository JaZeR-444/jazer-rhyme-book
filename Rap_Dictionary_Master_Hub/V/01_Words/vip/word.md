...
END: vip, vipd, vips / SLANT: vi, vipe, vipy / MULTI: vip mode, vip codes, vip road

## 3 bar-ready examples:
1. Vip on the mic, watch the room align.
2. Vip in the flow, make the speakers quake.
3. Say Vip with the vision, watch the crowd awake.
