...
END: rde, rded, rdes / SLANT: rd, rdee, rdey / MULTI: jarde mode, jarde codes, jarde road

## 3 bar-ready examples:
1. Jarde in my cadence, heavy like a drumline.
2. I move with Jarde, every step a headline.
3. Jarde on the mic, watch the room align.
