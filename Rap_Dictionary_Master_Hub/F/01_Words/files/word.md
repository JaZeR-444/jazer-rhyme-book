...
END: les, lesd, less / SLANT: le, lese, lesy / MULTI: files mode, files codes, files road

## 3 bar-ready examples:
1. Files in my cadence, heavy like a drumline.
2. I move with Files, every step a headline.
3. Files on the mic, watch the room align.
