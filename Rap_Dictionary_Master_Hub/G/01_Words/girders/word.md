...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: girders mode, girders codes, girders road

## 3 bar-ready examples:
1. I move with Girders, every step a headline.
2. Girders on the mic, watch the room align.
3. Girders in the flow, make the speakers quake.
