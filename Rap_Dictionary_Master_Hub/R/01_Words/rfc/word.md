...
END: rfc, rfcd, rfcs / SLANT: rf, rfce, rfcy / MULTI: rfc mode, rfc codes, rfc road

## 3 bar-ready examples:
1. Rfc on the mic, watch the room align.
2. Rfc in the flow, make the speakers quake.
3. Say Rfc with the vision, watch the crowd awake.
