...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: yeorling mode, yeorling codes, yeorling road

## 3 bar-ready examples:
1. Yeorling in the flow, make the speakers quake.
2. Say Yeorling with the vision, watch the crowd awake.
3. Yeorling in my cadence, heavy like a drumline.
