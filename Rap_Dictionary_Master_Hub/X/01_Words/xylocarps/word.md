...
END: rps, rpsd, rpss / SLANT: rp, rpse, rpsy / MULTI: xylocarps mode, xylocarps codes, xylocarps road

## 3 bar-ready examples:
1. Xylocarps on the mic, watch the room align.
2. Xylocarps in the flow, make the speakers quake.
3. Say Xylocarps with the vision, watch the crowd awake.
