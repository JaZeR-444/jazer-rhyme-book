...
END: ldy, ldyd, ldys / SLANT: ld, ldye, ldyy / MULTI: yieldy mode, yieldy codes, yieldy road

## 3 bar-ready examples:
1. Yieldy on the mic, watch the room align.
2. Yieldy in the flow, make the speakers quake.
3. Say Yieldy with the vision, watch the crowd awake.
