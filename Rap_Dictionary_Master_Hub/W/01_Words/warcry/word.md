...
END: cry, cryd, crys / SLANT: cr, crye, cryy / MULTI: warcry mode, warcry codes, warcry road

## 3 bar-ready examples:
1. Warcry in the flow, make the speakers quake.
2. Say Warcry with the vision, watch the crowd awake.
3. Warcry in my cadence, heavy like a drumline.
