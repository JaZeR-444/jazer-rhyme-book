...
END: lls, llsd, llss / SLANT: ll, llse, llsy / MULTI: fills mode, fills codes, fills road

## 3 bar-ready examples:
1. Fills in the flow, make the speakers quake.
2. Say Fills with the vision, watch the crowd awake.
3. Fills in my cadence, heavy like a drumline.
