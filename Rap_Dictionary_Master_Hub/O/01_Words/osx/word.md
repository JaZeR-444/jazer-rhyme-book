...
END: osx, osxd, osxs / SLANT: os, osxe, osxy / MULTI: osx mode, osx codes, osx road

## 3 bar-ready examples:
1. I move with Osx, every step a headline.
2. Osx on the mic, watch the room align.
3. Osx in the flow, make the speakers quake.
