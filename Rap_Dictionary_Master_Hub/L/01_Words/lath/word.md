...
END: ath, athd, aths / SLANT: at, athe, athy / MULTI: lath mode, lath codes, lath road

## 3 bar-ready examples:
1. Lath on the mic, watch the room align.
2. Lath in the flow, make the speakers quake.
3. Say Lath with the vision, watch the crowd awake.
