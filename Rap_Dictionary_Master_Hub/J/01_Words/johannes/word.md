...
END: nes, nesd, ness / SLANT: ne, nese, nesy / MULTI: johannes mode, johannes codes, johannes road

## 3 bar-ready examples:
1. I move with Johannes, every step a headline.
2. Johannes on the mic, watch the room align.
3. Johannes in the flow, make the speakers quake.
