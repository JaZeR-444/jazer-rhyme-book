...
END: imi, imid, imis / SLANT: im, imie, imiy / MULTI: mimi mode, mimi codes, mimi road

## 3 bar-ready examples:
1. Mimi on the mic, watch the room align.
2. Mimi in the flow, make the speakers quake.
3. Say Mimi with the vision, watch the crowd awake.
