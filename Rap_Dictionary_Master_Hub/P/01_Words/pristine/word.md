...
END: ine, ined, ines / SLANT: in, inee, iney / MULTI: pristine mode, pristine codes, pristine road

## 3 bar-ready examples:
1. Pristine in the flow, make the speakers quake.
2. Say Pristine with the vision, watch the crowd awake.
3. Pristine in my cadence, heavy like a drumline.
