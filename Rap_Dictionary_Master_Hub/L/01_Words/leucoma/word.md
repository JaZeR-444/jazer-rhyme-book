...
END: oma, omad, omas / SLANT: om, omae, omay / MULTI: leucoma mode, leucoma codes, leucoma road

## 3 bar-ready examples:
1. Leucoma on the mic, watch the room align.
2. Leucoma in the flow, make the speakers quake.
3. Say Leucoma with the vision, watch the crowd awake.
