...
END: lly, llyd, llys / SLANT: ll, llye, llyy / MULTI: optionally mode, optionally codes, optionally road

## 3 bar-ready examples:
1. Optionally on the mic, watch the room align.
2. Optionally in the flow, make the speakers quake.
3. Say Optionally with the vision, watch the crowd awake.
