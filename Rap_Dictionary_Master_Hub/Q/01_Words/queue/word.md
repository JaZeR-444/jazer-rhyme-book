...
END: eue, eued, eues / SLANT: eu, euee, euey / MULTI: queue mode, queue codes, queue road

## 3 bar-ready examples:
1. Queue in the flow, make the speakers quake.
2. Say Queue with the vision, watch the crowd awake.
3. Queue in my cadence, heavy like a drumline.
