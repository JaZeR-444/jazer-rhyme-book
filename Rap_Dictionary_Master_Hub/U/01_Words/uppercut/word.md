...
END: cut, cutd, cuts / SLANT: cu, cute, cuty / MULTI: uppercut mode, uppercut codes, uppercut road

## 3 bar-ready examples:
1. Uppercut in the flow, make the speakers quake.
2. Say Uppercut with the vision, watch the crowd awake.
3. Uppercut in my cadence, heavy like a drumline.
