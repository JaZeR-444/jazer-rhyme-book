...
END: uts, utsd, utss / SLANT: ut, utse, utsy / MULTI: outputs mode, outputs codes, outputs road

## 3 bar-ready examples:
1. Outputs in my cadence, heavy like a drumline.
2. I move with Outputs, every step a headline.
3. Outputs on the mic, watch the room align.
