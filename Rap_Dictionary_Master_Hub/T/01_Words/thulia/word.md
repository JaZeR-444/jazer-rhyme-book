...
END: lia, liad, lias / SLANT: li, liae, liay / MULTI: thulia mode, thulia codes, thulia road

## 3 bar-ready examples:
1. Thulia on the mic, watch the room align.
2. Thulia in the flow, make the speakers quake.
3. Say Thulia with the vision, watch the crowd awake.
