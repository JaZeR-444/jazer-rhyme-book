...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: hirpling mode, hirpling codes, hirpling road

## 3 bar-ready examples:
1. Hirpling in my cadence, heavy like a drumline.
2. I move with Hirpling, every step a headline.
3. Hirpling on the mic, watch the room align.
