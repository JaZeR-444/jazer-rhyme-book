...
END: ons, onsd, onss / SLANT: on, onse, onsy / MULTI: tions mode, tions codes, tions road

## 3 bar-ready examples:
1. I move with Tions, every step a headline.
2. Tions on the mic, watch the room align.
3. Tions in the flow, make the speakers quake.
