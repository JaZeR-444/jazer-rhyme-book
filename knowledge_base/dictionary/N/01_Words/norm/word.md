...
END: orm, ormd, orms / SLANT: or, orme, ormy / MULTI: norm mode, norm codes, norm road

## 3 bar-ready examples:
1. Say Norm with the vision, watch the crowd awake.
2. Norm in my cadence, heavy like a drumline.
3. I move with Norm, every step a headline.
