...
END: las, lasd, lass / SLANT: la, lase, lasy / MULTI: maxillas mode, maxillas codes, maxillas road

## 3 bar-ready examples:
1. Maxillas in my cadence, heavy like a drumline.
2. I move with Maxillas, every step a headline.
3. Maxillas on the mic, watch the room align.
