...
END: ort, ortd, orts / SLANT: or, orte, orty / MULTI: short mode, short codes, short road

## 3 bar-ready examples:
1. I move with Short, every step a headline.
2. Short on the mic, watch the room align.
3. Short in the flow, make the speakers quake.
