...
END: ble, bled, bles / SLANT: bl, blee, bley / MULTI: framable mode, framable codes, framable road

## 3 bar-ready examples:
1. I move with Framable, every step a headline.
2. Framable on the mic, watch the room align.
3. Framable in the flow, make the speakers quake.
