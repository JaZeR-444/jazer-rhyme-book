...
END: kyo, kyod, kyos / SLANT: ky, kyoe, kyoy / MULTI: tokyo mode, tokyo codes, tokyo road

## 3 bar-ready examples:
1. I move with Tokyo, every step a headline.
2. Tokyo on the mic, watch the room align.
3. Tokyo in the flow, make the speakers quake.
