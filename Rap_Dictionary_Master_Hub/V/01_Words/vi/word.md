...
END: vi, vid, vis / SLANT: v, vie, viy / MULTI: vi mode, vi codes, vi road

## 3 bar-ready examples:
1. Vi on the mic, watch the room align.
2. Vi in the flow, make the speakers quake.
3. Say Vi with the vision, watch the crowd awake.
