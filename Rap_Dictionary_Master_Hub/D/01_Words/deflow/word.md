...
END: low, lowd, lows / SLANT: lo, lowe, lowy / MULTI: deflow mode, deflow codes, deflow road

## 3 bar-ready examples:
1. I move with Deflow, every step a headline.
2. Deflow on the mic, watch the room align.
3. Deflow in the flow, make the speakers quake.
