...
END: ple, pled, ples / SLANT: pl, plee, pley / MULTI: subduple mode, subduple codes, subduple road

## 3 bar-ready examples:
1. I move with Subduple, every step a headline.
2. Subduple on the mic, watch the room align.
3. Subduple in the flow, make the speakers quake.
