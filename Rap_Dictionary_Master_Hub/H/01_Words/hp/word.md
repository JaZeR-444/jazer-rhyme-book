...
END: hp, hpd, hps / SLANT: h, hpe, hpy / MULTI: hp mode, hp codes, hp road

## 3 bar-ready examples:
1. I move with Hp, every step a headline.
2. Hp on the mic, watch the room align.
3. Hp in the flow, make the speakers quake.
