...
END: let, letd, lets / SLANT: le, lete, lety / MULTI: let mode, let codes, let road

## 3 bar-ready examples:
1. I move with Let, every step a headline.
2. Let on the mic, watch the room align.
3. Let in the flow, make the speakers quake.
