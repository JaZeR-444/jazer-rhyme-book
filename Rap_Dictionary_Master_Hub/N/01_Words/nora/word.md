...
END: ora, orad, oras / SLANT: or, orae, oray / MULTI: nora mode, nora codes, nora road

## 3 bar-ready examples:
1. Nora on the mic, watch the room align.
2. Nora in the flow, make the speakers quake.
3. Say Nora with the vision, watch the crowd awake.
