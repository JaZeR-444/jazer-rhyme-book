...
END: irt, irtd, irts / SLANT: ir, irte, irty / MULTI: flirt mode, flirt codes, flirt road

## 3 bar-ready examples:
1. I move with Flirt, every step a headline.
2. Flirt on the mic, watch the room align.
3. Flirt in the flow, make the speakers quake.
