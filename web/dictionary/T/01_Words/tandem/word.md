...
END: dem, demd, dems / SLANT: de, deme, demy / MULTI: tandem mode, tandem codes, tandem road

## 3 bar-ready examples:
1. Tandem on the mic, watch the room align.
2. Tandem in the flow, make the speakers quake.
3. Say Tandem with the vision, watch the crowd awake.
