...
END: ith, ithd, iths / SLANT: it, ithe, ithy / MULTI: judith mode, judith codes, judith road

## 3 bar-ready examples:
1. Judith on the mic, watch the room align.
2. Judith in the flow, make the speakers quake.
3. Say Judith with the vision, watch the crowd awake.
