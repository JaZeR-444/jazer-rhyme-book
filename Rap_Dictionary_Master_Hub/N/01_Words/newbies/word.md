...
END: ies, iesd, iess / SLANT: ie, iese, iesy / MULTI: newbies mode, newbies codes, newbies road

## 3 bar-ready examples:
1. I move with Newbies, every step a headline.
2. Newbies on the mic, watch the room align.
3. Newbies in the flow, make the speakers quake.
