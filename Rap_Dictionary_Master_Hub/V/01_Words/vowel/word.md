...
END: wel, weld, wels / SLANT: we, wele, wely / MULTI: vowel mode, vowel codes, vowel road

## 3 bar-ready examples:
1. Vowel on the mic, watch the room align.
2. Vowel in the flow, make the speakers quake.
3. Say Vowel with the vision, watch the crowd awake.
