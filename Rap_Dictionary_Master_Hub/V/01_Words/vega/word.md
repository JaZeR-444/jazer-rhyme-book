...
END: ega, egad, egas / SLANT: eg, egae, egay / MULTI: vega mode, vega codes, vega road

## 3 bar-ready examples:
1. Vega in the flow, make the speakers quake.
2. Say Vega with the vision, watch the crowd awake.
3. Vega in my cadence, heavy like a drumline.
