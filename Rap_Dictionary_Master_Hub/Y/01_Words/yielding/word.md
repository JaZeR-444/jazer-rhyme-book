...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: yielding mode, yielding codes, yielding road

## 3 bar-ready examples:
1. Yielding in the flow, make the speakers quake.
2. Say Yielding with the vision, watch the crowd awake.
3. Yielding in my cadence, heavy like a drumline.
