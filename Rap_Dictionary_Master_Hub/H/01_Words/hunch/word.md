...
END: nch, nchd, nchs / SLANT: nc, nche, nchy / MULTI: hunch mode, hunch codes, hunch road

## 3 bar-ready examples:
1. I move with Hunch, every step a headline.
2. Hunch on the mic, watch the room align.
3. Hunch in the flow, make the speakers quake.
