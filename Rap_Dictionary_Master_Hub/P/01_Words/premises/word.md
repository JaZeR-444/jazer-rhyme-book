...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: premises mode, premises codes, premises road

## 3 bar-ready examples:
1. I move with Premises, every step a headline.
2. Premises on the mic, watch the room align.
3. Premises in the flow, make the speakers quake.
