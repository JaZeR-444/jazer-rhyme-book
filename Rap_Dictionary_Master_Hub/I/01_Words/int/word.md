...
END: int, intd, ints / SLANT: in, inte, inty / MULTI: int mode, int codes, int road

## 3 bar-ready examples:
1. I move with Int, every step a headline.
2. Int on the mic, watch the room align.
3. Int in the flow, make the speakers quake.
