...
END: lly, llyd, llys / SLANT: ll, llye, llyy / MULTI: jelly mode, jelly codes, jelly road

## 3 bar-ready examples:
1. Jelly on the mic, watch the room align.
2. Jelly in the flow, make the speakers quake.
3. Say Jelly with the vision, watch the crowd awake.
