...
END: ipt, iptd, ipts / SLANT: ip, ipte, ipty / MULTI: manuscript mode, manuscript codes, manuscript road

## 3 bar-ready examples:
1. Manuscript on the mic, watch the room align.
2. Manuscript in the flow, make the speakers quake.
3. Say Manuscript with the vision, watch the crowd awake.
