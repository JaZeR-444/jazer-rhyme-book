...
END: nni, nnid, nnis / SLANT: nn, nnie, nniy / MULTI: jinni mode, jinni codes, jinni road

## 3 bar-ready examples:
1. I move with Jinni, every step a headline.
2. Jinni on the mic, watch the room align.
3. Jinni in the flow, make the speakers quake.
