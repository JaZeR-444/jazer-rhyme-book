...
END: gnd, gndd, gnds / SLANT: gn, gnde, gndy / MULTI: gnd mode, gnd codes, gnd road

## 3 bar-ready examples:
1. Gnd in the flow, make the speakers quake.
2. Say Gnd with the vision, watch the crowd awake.
3. Gnd in my cadence, heavy like a drumline.
