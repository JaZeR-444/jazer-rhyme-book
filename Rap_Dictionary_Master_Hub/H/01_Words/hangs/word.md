...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: hangs mode, hangs codes, hangs road

## 3 bar-ready examples:
1. Hangs on the mic, watch the room align.
2. Hangs in the flow, make the speakers quake.
3. Say Hangs with the vision, watch the crowd awake.
