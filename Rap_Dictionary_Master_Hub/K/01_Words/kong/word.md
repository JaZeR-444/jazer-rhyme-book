...
END: ong, ongd, ongs / SLANT: on, onge, ongy / MULTI: kong mode, kong codes, kong road

## 3 bar-ready examples:
1. I move with Kong, every step a headline.
2. Kong on the mic, watch the room align.
3. Kong in the flow, make the speakers quake.
