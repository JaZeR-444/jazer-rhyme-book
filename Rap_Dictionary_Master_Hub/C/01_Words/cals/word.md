...
END: als, alsd, alss / SLANT: al, alse, alsy / MULTI: cals mode, cals codes, cals road

## 3 bar-ready examples:
1. Cals on the mic, watch the room align.
2. Cals in the flow, make the speakers quake.
3. Say Cals with the vision, watch the crowd awake.
