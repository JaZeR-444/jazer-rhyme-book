...
END: ths, thsd, thss / SLANT: th, thse, thsy / MULTI: lengths mode, lengths codes, lengths road

## 3 bar-ready examples:
1. Say Lengths with the vision, watch the crowd awake.
2. Lengths in my cadence, heavy like a drumline.
3. I move with Lengths, every step a headline.
