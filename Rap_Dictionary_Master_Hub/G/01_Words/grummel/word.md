...
END: mel, meld, mels / SLANT: me, mele, mely / MULTI: grummel mode, grummel codes, grummel road

## 3 bar-ready examples:
1. I move with Grummel, every step a headline.
2. Grummel on the mic, watch the room align.
3. Grummel in the flow, make the speakers quake.
