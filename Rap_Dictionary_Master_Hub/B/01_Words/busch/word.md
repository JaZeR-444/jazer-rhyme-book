...
END: sch, schd, schs / SLANT: sc, sche, schy / MULTI: busch mode, busch codes, busch road

## 3 bar-ready examples:
1. Busch on the mic, watch the room align.
2. Busch in the flow, make the speakers quake.
3. Say Busch with the vision, watch the crowd awake.
