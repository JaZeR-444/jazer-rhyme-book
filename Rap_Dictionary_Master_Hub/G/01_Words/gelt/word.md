...
END: elt, eltd, elts / SLANT: el, elte, elty / MULTI: gelt mode, gelt codes, gelt road

## 3 bar-ready examples:
1. Say Gelt with the vision, watch the crowd awake.
2. Gelt in my cadence, heavy like a drumline.
3. I move with Gelt, every step a headline.
