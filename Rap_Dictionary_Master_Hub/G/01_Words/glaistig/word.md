...
END: tig, tigd, tigs / SLANT: ti, tige, tigy / MULTI: glaistig mode, glaistig codes, glaistig road

## 3 bar-ready examples:
1. I move with Glaistig, every step a headline.
2. Glaistig on the mic, watch the room align.
3. Glaistig in the flow, make the speakers quake.
