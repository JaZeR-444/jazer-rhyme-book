...
END: way, wayd, ways / SLANT: wa, waye, wayy / MULTI: wireway mode, wireway codes, wireway road

## 3 bar-ready examples:
1. I move with Wireway, every step a headline.
2. Wireway on the mic, watch the room align.
3. Wireway in the flow, make the speakers quake.
