...
END: ges, gesd, gess / SLANT: ge, gese, gesy / MULTI: leafages mode, leafages codes, leafages road

## 3 bar-ready examples:
1. I move with Leafages, every step a headline.
2. Leafages on the mic, watch the room align.
3. Leafages in the flow, make the speakers quake.
