...
END: ven, vend, vens / SLANT: ve, vene, veny / MULTI: given mode, given codes, given road

## 3 bar-ready examples:
1. Say Given with the vision, watch the crowd awake.
2. Given in my cadence, heavy like a drumline.
3. I move with Given, every step a headline.
