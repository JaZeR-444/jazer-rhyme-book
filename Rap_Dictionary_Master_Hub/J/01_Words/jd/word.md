...
END: jd, jdd, jds / SLANT: j, jde, jdy / MULTI: jd mode, jd codes, jd road

## 3 bar-ready examples:
1. I move with Jd, every step a headline.
2. Jd on the mic, watch the room align.
3. Jd in the flow, make the speakers quake.
