...
END: let, letd, lets / SLANT: le, lete, lety / MULTI: lorilet mode, lorilet codes, lorilet road

## 3 bar-ready examples:
1. Lorilet in the flow, make the speakers quake.
2. Say Lorilet with the vision, watch the crowd awake.
3. Lorilet in my cadence, heavy like a drumline.
