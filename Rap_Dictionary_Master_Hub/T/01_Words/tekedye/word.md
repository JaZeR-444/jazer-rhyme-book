...
END: dye, dyed, dyes / SLANT: dy, dyee, dyey / MULTI: tekedye mode, tekedye codes, tekedye road

## 3 bar-ready examples:
1. I move with Tekedye, every step a headline.
2. Tekedye on the mic, watch the room align.
3. Tekedye in the flow, make the speakers quake.
