...
END: ian, iand, ians / SLANT: ia, iane, iany / MULTI: librarian mode, librarian codes, librarian road

## 3 bar-ready examples:
1. Say Librarian with the vision, watch the crowd awake.
2. Librarian in my cadence, heavy like a drumline.
3. I move with Librarian, every step a headline.
