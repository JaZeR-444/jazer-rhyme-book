...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: numbering mode, numbering codes, numbering road

## 3 bar-ready examples:
1. Numbering in my cadence, heavy like a drumline.
2. I move with Numbering, every step a headline.
3. Numbering on the mic, watch the room align.
