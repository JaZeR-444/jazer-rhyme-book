...
END: nth, nthd, nths / SLANT: nt, nthe, nthy / MULTI: month mode, month codes, month road

## 3 bar-ready examples:
1. Month in the flow, make the speakers quake.
2. Say Month with the vision, watch the crowd awake.
3. Month in my cadence, heavy like a drumline.
