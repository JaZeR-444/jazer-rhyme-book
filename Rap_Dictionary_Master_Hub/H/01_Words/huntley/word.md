...
END: ley, leyd, leys / SLANT: le, leye, leyy / MULTI: huntley mode, huntley codes, huntley road

## 3 bar-ready examples:
1. I move with Huntley, every step a headline.
2. Huntley on the mic, watch the room align.
3. Huntley in the flow, make the speakers quake.
