...
END: set, setd, sets / SLANT: se, sete, sety / MULTI: offset mode, offset codes, offset road

## 3 bar-ready examples:
1. Offset on the mic, watch the room align.
2. Offset in the flow, make the speakers quake.
3. Say Offset with the vision, watch the crowd awake.
