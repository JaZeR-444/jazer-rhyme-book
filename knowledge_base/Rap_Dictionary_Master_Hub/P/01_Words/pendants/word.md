...
END: nts, ntsd, ntss / SLANT: nt, ntse, ntsy / MULTI: pendants mode, pendants codes, pendants road

## 3 bar-ready examples:
1. Pendants in my cadence, heavy like a drumline.
2. I move with Pendants, every step a headline.
3. Pendants on the mic, watch the room align.
