...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: toying mode, toying codes, toying road

## 3 bar-ready examples:
1. I move with Toying, every step a headline.
2. Toying on the mic, watch the room align.
3. Toying in the flow, make the speakers quake.
