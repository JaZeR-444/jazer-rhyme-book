...
END: ign, ignd, igns / SLANT: ig, igne, igny / MULTI: resign mode, resign codes, resign road

## 3 bar-ready examples:
1. Say Resign with the vision, watch the crowd awake.
2. Resign in my cadence, heavy like a drumline.
3. I move with Resign, every step a headline.
