...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: weighing mode, weighing codes, weighing road

## 3 bar-ready examples:
1. I move with Weighing, every step a headline.
2. Weighing on the mic, watch the room align.
3. Weighing in the flow, make the speakers quake.
