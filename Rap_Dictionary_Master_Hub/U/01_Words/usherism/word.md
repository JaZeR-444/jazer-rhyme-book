...
END: ism, ismd, isms / SLANT: is, isme, ismy / MULTI: usherism mode, usherism codes, usherism road

## 3 bar-ready examples:
1. Usherism in the flow, make the speakers quake.
2. Say Usherism with the vision, watch the crowd awake.
3. Usherism in my cadence, heavy like a drumline.
