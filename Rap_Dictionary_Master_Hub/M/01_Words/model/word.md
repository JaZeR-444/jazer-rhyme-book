...
END: del, deld, dels / SLANT: de, dele, dely / MULTI: model mode, model codes, model road

## 3 bar-ready examples:
1. Model on the mic, watch the room align.
2. Model in the flow, make the speakers quake.
3. Say Model with the vision, watch the crowd awake.
