...
END: ete, eted, etes / SLANT: et, etee, etey / MULTI: pete mode, pete codes, pete road

## 3 bar-ready examples:
1. Pete on the mic, watch the room align.
2. Pete in the flow, make the speakers quake.
3. Say Pete with the vision, watch the crowd awake.
