...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: furnishing mode, furnishing codes, furnishing road

## 3 bar-ready examples:
1. Furnishing in the flow, make the speakers quake.
2. Say Furnishing with the vision, watch the crowd awake.
3. Furnishing in my cadence, heavy like a drumline.
