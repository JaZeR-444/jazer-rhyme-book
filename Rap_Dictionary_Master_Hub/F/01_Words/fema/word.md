...
END: ema, emad, emas / SLANT: em, emae, emay / MULTI: fema mode, fema codes, fema road

## 3 bar-ready examples:
1. Fema on the mic, watch the room align.
2. Fema in the flow, make the speakers quake.
3. Say Fema with the vision, watch the crowd awake.
