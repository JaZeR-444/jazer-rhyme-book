...
END: ons, onsd, onss / SLANT: on, onse, onsy / MULTI: operations mode, operations codes, operations road

## 3 bar-ready examples:
1. Operations on the mic, watch the room align.
2. Operations in the flow, make the speakers quake.
3. Say Operations with the vision, watch the crowd awake.
