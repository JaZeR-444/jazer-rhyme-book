...
END: ptr, ptrd, ptrs / SLANT: pt, ptre, ptry / MULTI: ptr mode, ptr codes, ptr road

## 3 bar-ready examples:
1. Ptr in the flow, make the speakers quake.
2. Say Ptr with the vision, watch the crowd awake.
3. Ptr in my cadence, heavy like a drumline.
