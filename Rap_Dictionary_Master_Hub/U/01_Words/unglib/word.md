...
END: lib, libd, libs / SLANT: li, libe, liby / MULTI: unglib mode, unglib codes, unglib road

## 3 bar-ready examples:
1. Unglib in my cadence, heavy like a drumline.
2. I move with Unglib, every step a headline.
3. Unglib on the mic, watch the room align.
