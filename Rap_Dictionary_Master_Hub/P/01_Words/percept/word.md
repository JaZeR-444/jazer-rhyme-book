...
END: ept, eptd, epts / SLANT: ep, epte, epty / MULTI: percept mode, percept codes, percept road

## 3 bar-ready examples:
1. Percept in the flow, make the speakers quake.
2. Say Percept with the vision, watch the crowd awake.
3. Percept in my cadence, heavy like a drumline.
