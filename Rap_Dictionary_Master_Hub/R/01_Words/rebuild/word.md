...
END: ild, ildd, ilds / SLANT: il, ilde, ildy / MULTI: rebuild mode, rebuild codes, rebuild road

## 3 bar-ready examples:
1. Rebuild in my cadence, heavy like a drumline.
2. I move with Rebuild, every step a headline.
3. Rebuild on the mic, watch the room align.
