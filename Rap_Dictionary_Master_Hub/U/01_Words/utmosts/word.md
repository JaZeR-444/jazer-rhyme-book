...
END: sts, stsd, stss / SLANT: st, stse, stsy / MULTI: utmosts mode, utmosts codes, utmosts road

## 3 bar-ready examples:
1. I move with Utmosts, every step a headline.
2. Utmosts on the mic, watch the room align.
3. Utmosts in the flow, make the speakers quake.
