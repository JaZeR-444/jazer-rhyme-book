...
END: ela, elad, elas / SLANT: el, elae, elay / MULTI: neela mode, neela codes, neela road

## 3 bar-ready examples:
1. I move with Neela, every step a headline.
2. Neela on the mic, watch the room align.
3. Neela in the flow, make the speakers quake.
