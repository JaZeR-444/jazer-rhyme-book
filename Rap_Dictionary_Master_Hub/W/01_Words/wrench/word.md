...
END: nch, nchd, nchs / SLANT: nc, nche, nchy / MULTI: wrench mode, wrench codes, wrench road

## 3 bar-ready examples:
1. Wrench in my cadence, heavy like a drumline.
2. I move with Wrench, every step a headline.
3. Wrench on the mic, watch the room align.
