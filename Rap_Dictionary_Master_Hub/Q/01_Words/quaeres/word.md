...
END: res, resd, ress / SLANT: re, rese, resy / MULTI: quaeres mode, quaeres codes, quaeres road

## 3 bar-ready examples:
1. I move with Quaeres, every step a headline.
2. Quaeres on the mic, watch the room align.
3. Quaeres in the flow, make the speakers quake.
