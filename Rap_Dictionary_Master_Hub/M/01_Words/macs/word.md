...
END: acs, acsd, acss / SLANT: ac, acse, acsy / MULTI: macs mode, macs codes, macs road

## 3 bar-ready examples:
1. I move with Macs, every step a headline.
2. Macs on the mic, watch the room align.
3. Macs in the flow, make the speakers quake.
