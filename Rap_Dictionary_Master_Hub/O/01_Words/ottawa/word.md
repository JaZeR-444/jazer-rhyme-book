...
END: awa, awad, awas / SLANT: aw, awae, away / MULTI: ottawa mode, ottawa codes, ottawa road

## 3 bar-ready examples:
1. I move with Ottawa, every step a headline.
2. Ottawa on the mic, watch the room align.
3. Ottawa in the flow, make the speakers quake.
