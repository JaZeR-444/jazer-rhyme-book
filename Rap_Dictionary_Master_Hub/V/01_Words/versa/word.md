...
END: rsa, rsad, rsas / SLANT: rs, rsae, rsay / MULTI: versa mode, versa codes, versa road

## 3 bar-ready examples:
1. Versa on the mic, watch the room align.
2. Versa in the flow, make the speakers quake.
3. Say Versa with the vision, watch the crowd awake.
