...
END: ira, irad, iras / SLANT: ir, irae, iray / MULTI: ira mode, ira codes, ira road

## 3 bar-ready examples:
1. Ira in the flow, make the speakers quake.
2. Say Ira with the vision, watch the crowd awake.
3. Ira in my cadence, heavy like a drumline.
