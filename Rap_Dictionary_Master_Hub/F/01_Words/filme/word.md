...
END: lme, lmed, lmes / SLANT: lm, lmee, lmey / MULTI: filme mode, filme codes, filme road

## 3 bar-ready examples:
1. Filme on the mic, watch the room align.
2. Filme in the flow, make the speakers quake.
3. Say Filme with the vision, watch the crowd awake.
