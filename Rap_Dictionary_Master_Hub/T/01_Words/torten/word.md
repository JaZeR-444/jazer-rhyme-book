...
END: ten, tend, tens / SLANT: te, tene, teny / MULTI: torten mode, torten codes, torten road

## 3 bar-ready examples:
1. I move with Torten, every step a headline.
2. Torten on the mic, watch the room align.
3. Torten in the flow, make the speakers quake.
