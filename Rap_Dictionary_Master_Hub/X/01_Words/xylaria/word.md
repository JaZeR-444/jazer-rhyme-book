...
END: ria, riad, rias / SLANT: ri, riae, riay / MULTI: xylaria mode, xylaria codes, xylaria road

## 3 bar-ready examples:
1. I move with Xylaria, every step a headline.
2. Xylaria on the mic, watch the room align.
3. Xylaria in the flow, make the speakers quake.
