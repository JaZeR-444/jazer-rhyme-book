...
END: are, ared, ares / SLANT: ar, aree, arey / MULTI: welfare mode, welfare codes, welfare road

## 3 bar-ready examples:
1. Welfare on the mic, watch the room align.
2. Welfare in the flow, make the speakers quake.
3. Say Welfare with the vision, watch the crowd awake.
