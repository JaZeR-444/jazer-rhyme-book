...
END: urs, ursd, urss / SLANT: ur, urse, ursy / MULTI: occurs mode, occurs codes, occurs road

## 3 bar-ready examples:
1. I move with Occurs, every step a headline.
2. Occurs on the mic, watch the room align.
3. Occurs in the flow, make the speakers quake.
