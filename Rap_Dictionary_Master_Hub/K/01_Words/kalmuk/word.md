...
END: muk, mukd, muks / SLANT: mu, muke, muky / MULTI: kalmuk mode, kalmuk codes, kalmuk road

## 3 bar-ready examples:
1. I move with Kalmuk, every step a headline.
2. Kalmuk on the mic, watch the room align.
3. Kalmuk in the flow, make the speakers quake.
