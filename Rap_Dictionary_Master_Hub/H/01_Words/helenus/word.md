...
END: nus, nusd, nuss / SLANT: nu, nuse, nusy / MULTI: helenus mode, helenus codes, helenus road

## 3 bar-ready examples:
1. Helenus in the flow, make the speakers quake.
2. Say Helenus with the vision, watch the crowd awake.
3. Helenus in my cadence, heavy like a drumline.
