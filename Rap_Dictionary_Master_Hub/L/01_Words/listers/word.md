...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: listers mode, listers codes, listers road

## 3 bar-ready examples:
1. Listers on the mic, watch the room align.
2. Listers in the flow, make the speakers quake.
3. Say Listers with the vision, watch the crowd awake.
