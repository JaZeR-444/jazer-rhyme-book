...
END: ina, inad, inas / SLANT: in, inae, inay / MULTI: quinquina mode, quinquina codes, quinquina road

## 3 bar-ready examples:
1. Quinquina on the mic, watch the room align.
2. Quinquina in the flow, make the speakers quake.
3. Say Quinquina with the vision, watch the crowd awake.
