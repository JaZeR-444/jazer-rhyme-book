...
END: min, mind, mins / SLANT: mi, mine, miny / MULTI: min mode, min codes, min road

## 3 bar-ready examples:
1. Min in the flow, make the speakers quake.
2. Say Min with the vision, watch the crowd awake.
3. Min in my cadence, heavy like a drumline.
