...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: grazing mode, grazing codes, grazing road

## 3 bar-ready examples:
1. I move with Grazing, every step a headline.
2. Grazing on the mic, watch the room align.
3. Grazing in the flow, make the speakers quake.
