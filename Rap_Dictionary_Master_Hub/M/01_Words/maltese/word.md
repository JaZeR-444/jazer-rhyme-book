...
END: ese, esed, eses / SLANT: es, esee, esey / MULTI: maltese mode, maltese codes, maltese road

## 3 bar-ready examples:
1. Maltese in the flow, make the speakers quake.
2. Say Maltese with the vision, watch the crowd awake.
3. Maltese in my cadence, heavy like a drumline.
