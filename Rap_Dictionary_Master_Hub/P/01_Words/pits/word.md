...
END: its, itsd, itss / SLANT: it, itse, itsy / MULTI: pits mode, pits codes, pits road

## 3 bar-ready examples:
1. Pits on the mic, watch the room align.
2. Pits in the flow, make the speakers quake.
3. Say Pits with the vision, watch the crowd awake.
