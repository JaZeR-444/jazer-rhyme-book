...
END: int, intd, ints / SLANT: in, inte, inty / MULTI: point mode, point codes, point road

## 3 bar-ready examples:
1. Say Point with the vision, watch the crowd awake.
2. Point in my cadence, heavy like a drumline.
3. I move with Point, every step a headline.
