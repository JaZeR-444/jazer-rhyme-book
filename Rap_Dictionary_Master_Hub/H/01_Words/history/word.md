...
END: ory, oryd, orys / SLANT: or, orye, oryy / MULTI: history mode, history codes, history road

## 3 bar-ready examples:
1. I move with History, every step a headline.
2. History on the mic, watch the room align.
3. History in the flow, make the speakers quake.
