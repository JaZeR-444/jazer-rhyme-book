...
END: res, resd, ress / SLANT: re, rese, resy / MULTI: keres mode, keres codes, keres road

## 3 bar-ready examples:
1. Keres in the flow, make the speakers quake.
2. Say Keres with the vision, watch the crowd awake.
3. Keres in my cadence, heavy like a drumline.
