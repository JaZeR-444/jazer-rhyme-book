...
END: yte, yted, ytes / SLANT: yt, ytee, ytey / MULTI: kyte mode, kyte codes, kyte road

## 3 bar-ready examples:
1. Kyte in the flow, make the speakers quake.
2. Say Kyte with the vision, watch the crowd awake.
3. Kyte in my cadence, heavy like a drumline.
