...
END: len, lend, lens / SLANT: le, lene, leny / MULTI: glen mode, glen codes, glen road

## 3 bar-ready examples:
1. Glen on the mic, watch the room align.
2. Glen in the flow, make the speakers quake.
3. Say Glen with the vision, watch the crowd awake.
