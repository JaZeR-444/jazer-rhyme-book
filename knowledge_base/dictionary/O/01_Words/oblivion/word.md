...
END: lion, Zion, iron / SLANT: tyrant, trying, client / MULTI: iron lion, silent giant, signing on

## 3 bar-ready examples:
1. Oblivion in the flow, make the speakers quake.
2. Say Oblivion with the vision, watch the crowd awake.
3. Oblivion in my cadence, heavy like a drumline.
