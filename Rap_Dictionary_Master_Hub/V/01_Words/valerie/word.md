...
END: rie, ried, ries / SLANT: ri, riee, riey / MULTI: valerie mode, valerie codes, valerie road

## 3 bar-ready examples:
1. Valerie on the mic, watch the room align.
2. Valerie in the flow, make the speakers quake.
3. Say Valerie with the vision, watch the crowd awake.
