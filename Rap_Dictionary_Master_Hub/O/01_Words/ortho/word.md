...
END: tho, thod, thos / SLANT: th, thoe, thoy / MULTI: ortho mode, ortho codes, ortho road

## 3 bar-ready examples:
1. I move with Ortho, every step a headline.
2. Ortho on the mic, watch the room align.
3. Ortho in the flow, make the speakers quake.
