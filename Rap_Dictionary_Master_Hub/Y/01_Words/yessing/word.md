...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: yessing mode, yessing codes, yessing road

## 3 bar-ready examples:
1. Say Yessing with the vision, watch the crowd awake.
2. Yessing in my cadence, heavy like a drumline.
3. I move with Yessing, every step a headline.
