...
END: eld, eldd, elds / SLANT: el, elde, eldy / MULTI: outyield mode, outyield codes, outyield road

## 3 bar-ready examples:
1. Outyield in my cadence, heavy like a drumline.
2. I move with Outyield, every step a headline.
3. Outyield on the mic, watch the room align.
