...
END: ton, tond, tons / SLANT: to, tone, tony / MULTI: ceston mode, ceston codes, ceston road

## 3 bar-ready examples:
1. I move with Ceston, every step a headline.
2. Ceston on the mic, watch the room align.
3. Ceston in the flow, make the speakers quake.
