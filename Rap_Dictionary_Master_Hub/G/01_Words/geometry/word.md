...
END: try, tryd, trys / SLANT: tr, trye, tryy / MULTI: geometry mode, geometry codes, geometry road

## 3 bar-ready examples:
1. Geometry on the mic, watch the room align.
2. Geometry in the flow, make the speakers quake.
3. Say Geometry with the vision, watch the crowd awake.
