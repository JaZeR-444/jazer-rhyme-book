...
END: ass, assd, asss / SLANT: as, asse, assy / MULTI: fiberglass mode, fiberglass codes, fiberglass road

## 3 bar-ready examples:
1. Fiberglass on the mic, watch the room align.
2. Fiberglass in the flow, make the speakers quake.
3. Say Fiberglass with the vision, watch the crowd awake.
