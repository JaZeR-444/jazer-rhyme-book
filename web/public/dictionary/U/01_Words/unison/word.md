...
END: son, sond, sons / SLANT: so, sone, sony / MULTI: unison mode, unison codes, unison road

## 3 bar-ready examples:
1. I move with Unison, every step a headline.
2. Unison on the mic, watch the room align.
3. Unison in the flow, make the speakers quake.
