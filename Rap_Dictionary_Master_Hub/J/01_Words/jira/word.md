...
END: ira, irad, iras / SLANT: ir, irae, iray / MULTI: jira mode, jira codes, jira road

## 3 bar-ready examples:
1. Jira on the mic, watch the room align.
2. Jira in the flow, make the speakers quake.
3. Say Jira with the vision, watch the crowd awake.
