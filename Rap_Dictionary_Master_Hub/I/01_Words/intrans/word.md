...
END: ans, ansd, anss / SLANT: an, anse, ansy / MULTI: intrans mode, intrans codes, intrans road

## 3 bar-ready examples:
1. Intrans in the flow, make the speakers quake.
2. Say Intrans with the vision, watch the crowd awake.
3. Intrans in my cadence, heavy like a drumline.
