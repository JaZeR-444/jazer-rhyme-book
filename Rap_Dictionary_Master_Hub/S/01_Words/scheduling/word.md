...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: scheduling mode, scheduling codes, scheduling road

## 3 bar-ready examples:
1. I move with Scheduling, every step a headline.
2. Scheduling on the mic, watch the room align.
3. Scheduling in the flow, make the speakers quake.
