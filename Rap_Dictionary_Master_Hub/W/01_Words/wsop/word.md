...
END: sop, sopd, sops / SLANT: so, sope, sopy / MULTI: wsop mode, wsop codes, wsop road

## 3 bar-ready examples:
1. Wsop in the flow, make the speakers quake.
2. Say Wsop with the vision, watch the crowd awake.
3. Wsop in my cadence, heavy like a drumline.
