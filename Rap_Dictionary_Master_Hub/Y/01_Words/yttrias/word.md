...
END: ias, iasd, iass / SLANT: ia, iase, iasy / MULTI: yttrias mode, yttrias codes, yttrias road

## 3 bar-ready examples:
1. Yttrias in the flow, make the speakers quake.
2. Say Yttrias with the vision, watch the crowd awake.
3. Yttrias in my cadence, heavy like a drumline.
