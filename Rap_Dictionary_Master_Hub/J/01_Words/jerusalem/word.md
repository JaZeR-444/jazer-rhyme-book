...
END: lem, lemd, lems / SLANT: le, leme, lemy / MULTI: jerusalem mode, jerusalem codes, jerusalem road

## 3 bar-ready examples:
1. Jerusalem in the flow, make the speakers quake.
2. Say Jerusalem with the vision, watch the crowd awake.
3. Jerusalem in my cadence, heavy like a drumline.
