...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: quoting mode, quoting codes, quoting road

## 3 bar-ready examples:
1. Quoting on the mic, watch the room align.
2. Quoting in the flow, make the speakers quake.
3. Say Quoting with the vision, watch the crowd awake.
