...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: kibbling mode, kibbling codes, kibbling road

## 3 bar-ready examples:
1. Kibbling in the flow, make the speakers quake.
2. Say Kibbling with the vision, watch the crowd awake.
3. Kibbling in my cadence, heavy like a drumline.
