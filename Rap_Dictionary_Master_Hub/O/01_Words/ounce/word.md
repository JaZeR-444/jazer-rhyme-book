...
END: nce, nced, nces / SLANT: nc, ncee, ncey / MULTI: ounce mode, ounce codes, ounce road

## 3 bar-ready examples:
1. I move with Ounce, every step a headline.
2. Ounce on the mic, watch the room align.
3. Ounce in the flow, make the speakers quake.
