...
END: qld, qldd, qlds / SLANT: ql, qlde, qldy / MULTI: qld mode, qld codes, qld road

## 3 bar-ready examples:
1. Qld in the flow, make the speakers quake.
2. Say Qld with the vision, watch the crowd awake.
3. Qld in my cadence, heavy like a drumline.
