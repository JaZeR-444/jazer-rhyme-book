...
END: uct, uctd, ucts / SLANT: uc, ucte, ucty / MULTI: misconduct mode, misconduct codes, misconduct road

## 3 bar-ready examples:
1. Misconduct on the mic, watch the room align.
2. Misconduct in the flow, make the speakers quake.
3. Say Misconduct with the vision, watch the crowd awake.
