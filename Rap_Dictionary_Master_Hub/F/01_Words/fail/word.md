...
END: ail, aild, ails / SLANT: ai, aile, aily / MULTI: fail mode, fail codes, fail road

## 3 bar-ready examples:
1. Fail in my cadence, heavy like a drumline.
2. I move with Fail, every step a headline.
3. Fail on the mic, watch the room align.
