...
END: bby, bbyd, bbys / SLANT: bb, bbye, bbyy / MULTI: lobby mode, lobby codes, lobby road

## 3 bar-ready examples:
1. Lobby on the mic, watch the room align.
2. Lobby in the flow, make the speakers quake.
3. Say Lobby with the vision, watch the crowd awake.
