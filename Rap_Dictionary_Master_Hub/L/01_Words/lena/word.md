...
END: ena, enad, enas / SLANT: en, enae, enay / MULTI: lena mode, lena codes, lena road

## 3 bar-ready examples:
1. I move with Lena, every step a headline.
2. Lena on the mic, watch the room align.
3. Lena in the flow, make the speakers quake.
