...
END: ntu, ntud, ntus / SLANT: nt, ntue, ntuy / MULTI: jantu mode, jantu codes, jantu road

## 3 bar-ready examples:
1. Say Jantu with the vision, watch the crowd awake.
2. Jantu in my cadence, heavy like a drumline.
3. I move with Jantu, every step a headline.
