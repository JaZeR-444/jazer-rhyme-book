...
END: ely, elyd, elys / SLANT: el, elye, elyy / MULTI: lonely mode, lonely codes, lonely road

## 3 bar-ready examples:
1. I move with Lonely, every step a headline.
2. Lonely on the mic, watch the room align.
3. Lonely in the flow, make the speakers quake.
