...
END: ist, istd, ists / SLANT: is, iste, isty / MULTI: pharmacist mode, pharmacist codes, pharmacist road

## 3 bar-ready examples:
1. Pharmacist in the flow, make the speakers quake.
2. Say Pharmacist with the vision, watch the crowd awake.
3. Pharmacist in my cadence, heavy like a drumline.
