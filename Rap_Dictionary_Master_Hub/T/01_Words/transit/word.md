...
END: sit, sitd, sits / SLANT: si, site, sity / MULTI: transit mode, transit codes, transit road

## 3 bar-ready examples:
1. I move with Transit, every step a headline.
2. Transit on the mic, watch the room align.
3. Transit in the flow, make the speakers quake.
