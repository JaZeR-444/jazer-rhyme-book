...
END: eus, eusd, euss / SLANT: eu, euse, eusy / MULTI: lynceus mode, lynceus codes, lynceus road

## 3 bar-ready examples:
1. I move with Lynceus, every step a headline.
2. Lynceus on the mic, watch the room align.
3. Lynceus in the flow, make the speakers quake.
