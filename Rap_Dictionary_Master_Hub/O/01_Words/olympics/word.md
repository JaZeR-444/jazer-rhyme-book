...
END: ics, icsd, icss / SLANT: ic, icse, icsy / MULTI: olympics mode, olympics codes, olympics road

## 3 bar-ready examples:
1. I move with Olympics, every step a headline.
2. Olympics on the mic, watch the room align.
3. Olympics in the flow, make the speakers quake.
