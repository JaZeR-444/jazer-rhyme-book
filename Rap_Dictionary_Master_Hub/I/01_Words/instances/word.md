...
END: ces, cesd, cess / SLANT: ce, cese, cesy / MULTI: instances mode, instances codes, instances road

## 3 bar-ready examples:
1. I move with Instances, every step a headline.
2. Instances on the mic, watch the room align.
3. Instances in the flow, make the speakers quake.
