...
END: rls, rlsd, rlss / SLANT: rl, rlse, rlsy / MULTI: urls mode, urls codes, urls road

## 3 bar-ready examples:
1. I move with Urls, every step a headline.
2. Urls on the mic, watch the room align.
3. Urls in the flow, make the speakers quake.
