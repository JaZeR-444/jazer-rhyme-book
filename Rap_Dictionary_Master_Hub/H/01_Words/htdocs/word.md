...
END: ocs, ocsd, ocss / SLANT: oc, ocse, ocsy / MULTI: htdocs mode, htdocs codes, htdocs road

## 3 bar-ready examples:
1. I move with Htdocs, every step a headline.
2. Htdocs on the mic, watch the room align.
3. Htdocs in the flow, make the speakers quake.
