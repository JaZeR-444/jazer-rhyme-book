...
END: ett, ettd, etts / SLANT: et, ette, etty / MULTI: lett mode, lett codes, lett road

## 3 bar-ready examples:
1. Lett on the mic, watch the room align.
2. Lett in the flow, make the speakers quake.
3. Say Lett with the vision, watch the crowd awake.
