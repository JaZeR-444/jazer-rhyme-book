...
END: rin, rind, rins / SLANT: ri, rine, riny / MULTI: neurin mode, neurin codes, neurin road

## 3 bar-ready examples:
1. Neurin in the flow, make the speakers quake.
2. Say Neurin with the vision, watch the crowd awake.
3. Neurin in my cadence, heavy like a drumline.
