...
END: pes, pesd, pess / SLANT: pe, pese, pesy / MULTI: prototypes mode, prototypes codes, prototypes road

## 3 bar-ready examples:
1. I move with Prototypes, every step a headline.
2. Prototypes on the mic, watch the room align.
3. Prototypes in the flow, make the speakers quake.
