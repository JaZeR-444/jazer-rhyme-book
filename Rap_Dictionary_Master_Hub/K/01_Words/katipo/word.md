...
END: ipo, ipod, ipos / SLANT: ip, ipoe, ipoy / MULTI: katipo mode, katipo codes, katipo road

## 3 bar-ready examples:
1. I move with Katipo, every step a headline.
2. Katipo on the mic, watch the room align.
3. Katipo in the flow, make the speakers quake.
