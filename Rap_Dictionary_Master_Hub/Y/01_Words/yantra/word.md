...
END: tra, trad, tras / SLANT: tr, trae, tray / MULTI: yantra mode, yantra codes, yantra road

## 3 bar-ready examples:
1. Yantra on the mic, watch the room align.
2. Yantra in the flow, make the speakers quake.
3. Say Yantra with the vision, watch the crowd awake.
