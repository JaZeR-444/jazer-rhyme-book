...
END: zle, zled, zles / SLANT: zl, zlee, zley / MULTI: nozzle mode, nozzle codes, nozzle road

## 3 bar-ready examples:
1. Nozzle in the flow, make the speakers quake.
2. Say Nozzle with the vision, watch the crowd awake.
3. Nozzle in my cadence, heavy like a drumline.
