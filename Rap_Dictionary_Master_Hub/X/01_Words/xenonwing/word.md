...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: xenonwing mode, xenonwing codes, xenonwing road

## 3 bar-ready examples:
1. I move with Xenonwing, every step a headline.
2. Xenonwing on the mic, watch the room align.
3. Xenonwing in the flow, make the speakers quake.
