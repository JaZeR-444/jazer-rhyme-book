...
END: ude, uded, udes / SLANT: ud, udee, udey / MULTI: prelude mode, prelude codes, prelude road

## 3 bar-ready examples:
1. Prelude in the flow, make the speakers quake.
2. Say Prelude with the vision, watch the crowd awake.
3. Prelude in my cadence, heavy like a drumline.
