...
END: ton, tond, tons / SLANT: to, tone, tony / MULTI: newton mode, newton codes, newton road

## 3 bar-ready examples:
1. Say Newton with the vision, watch the crowd awake.
2. Newton in my cadence, heavy like a drumline.
3. I move with Newton, every step a headline.
