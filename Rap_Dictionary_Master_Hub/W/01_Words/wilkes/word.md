...
END: kes, kesd, kess / SLANT: ke, kese, kesy / MULTI: wilkes mode, wilkes codes, wilkes road

## 3 bar-ready examples:
1. I move with Wilkes, every step a headline.
2. Wilkes on the mic, watch the room align.
3. Wilkes in the flow, make the speakers quake.
