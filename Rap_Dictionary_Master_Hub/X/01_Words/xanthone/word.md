...
END: one, oned, ones / SLANT: on, onee, oney / MULTI: xanthone mode, xanthone codes, xanthone road

## 3 bar-ready examples:
1. Say Xanthone with the vision, watch the crowd awake.
2. Xanthone in my cadence, heavy like a drumline.
3. I move with Xanthone, every step a headline.
