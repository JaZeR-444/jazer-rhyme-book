...
END: els, elsd, elss / SLANT: el, else, elsy / MULTI: towels mode, towels codes, towels road

## 3 bar-ready examples:
1. Towels on the mic, watch the room align.
2. Towels in the flow, make the speakers quake.
3. Say Towels with the vision, watch the crowd awake.
