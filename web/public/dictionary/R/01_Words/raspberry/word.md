...
END: rry, rryd, rrys / SLANT: rr, rrye, rryy / MULTI: raspberry mode, raspberry codes, raspberry road

## 3 bar-ready examples:
1. Raspberry on the mic, watch the room align.
2. Raspberry in the flow, make the speakers quake.
3. Say Raspberry with the vision, watch the crowd awake.
