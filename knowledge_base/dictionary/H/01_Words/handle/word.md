...
END: dle, dled, dles / SLANT: dl, dlee, dley / MULTI: handle mode, handle codes, handle road

## 3 bar-ready examples:
1. I move with Handle, every step a headline.
2. Handle on the mic, watch the room align.
3. Handle in the flow, make the speakers quake.
