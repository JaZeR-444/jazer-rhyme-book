...
END: rva, rvad, rvas / SLANT: rv, rvae, rvay / MULTI: yerva mode, yerva codes, yerva road

## 3 bar-ready examples:
1. I move with Yerva, every step a headline.
2. Yerva on the mic, watch the room align.
3. Yerva in the flow, make the speakers quake.
