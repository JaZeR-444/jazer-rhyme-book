...
END: ese, esed, eses / SLANT: es, esee, esey / MULTI: vietnamese mode, vietnamese codes, vietnamese road

## 3 bar-ready examples:
1. Vietnamese on the mic, watch the room align.
2. Vietnamese in the flow, make the speakers quake.
3. Say Vietnamese with the vision, watch the crowd awake.
