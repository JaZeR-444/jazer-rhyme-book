...
END: ros, rosd, ross / SLANT: ro, rose, rosy / MULTI: macros mode, macros codes, macros road

## 3 bar-ready examples:
1. Macros in the flow, make the speakers quake.
2. Say Macros with the vision, watch the crowd awake.
3. Macros in my cadence, heavy like a drumline.
