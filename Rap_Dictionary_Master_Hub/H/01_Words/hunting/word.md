...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: hunting mode, hunting codes, hunting road

## 3 bar-ready examples:
1. I move with Hunting, every step a headline.
2. Hunting on the mic, watch the room align.
3. Hunting in the flow, make the speakers quake.
