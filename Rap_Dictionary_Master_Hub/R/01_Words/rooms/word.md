...
END: oms, omsd, omss / SLANT: om, omse, omsy / MULTI: rooms mode, rooms codes, rooms road

## 3 bar-ready examples:
1. I move with Rooms, every step a headline.
2. Rooms on the mic, watch the room align.
3. Rooms in the flow, make the speakers quake.
