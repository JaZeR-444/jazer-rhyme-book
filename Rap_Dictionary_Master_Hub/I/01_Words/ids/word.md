...
END: ids, idsd, idss / SLANT: id, idse, idsy / MULTI: ids mode, ids codes, ids road

## 3 bar-ready examples:
1. Ids in my cadence, heavy like a drumline.
2. I move with Ids, every step a headline.
3. Ids on the mic, watch the room align.
