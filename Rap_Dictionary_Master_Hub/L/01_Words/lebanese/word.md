...
END: ese, esed, eses / SLANT: es, esee, esey / MULTI: lebanese mode, lebanese codes, lebanese road

## 3 bar-ready examples:
1. I move with Lebanese, every step a headline.
2. Lebanese on the mic, watch the room align.
3. Lebanese in the flow, make the speakers quake.
