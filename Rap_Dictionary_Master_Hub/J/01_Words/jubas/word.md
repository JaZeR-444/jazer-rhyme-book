...
END: bas, basd, bass / SLANT: ba, base, basy / MULTI: jubas mode, jubas codes, jubas road

## 3 bar-ready examples:
1. Jubas on the mic, watch the room align.
2. Jubas in the flow, make the speakers quake.
3. Say Jubas with the vision, watch the crowd awake.
