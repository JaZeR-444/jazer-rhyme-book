...
END: tes, tesd, tess / SLANT: te, tese, tesy / MULTI: notes mode, notes codes, notes road

## 3 bar-ready examples:
1. I move with Notes, every step a headline.
2. Notes on the mic, watch the room align.
3. Notes in the flow, make the speakers quake.
