...
END: een, eend, eens / SLANT: ee, eene, eeny / MULTI: wheen mode, wheen codes, wheen road

## 3 bar-ready examples:
1. Wheen in the flow, make the speakers quake.
2. Say Wheen with the vision, watch the crowd awake.
3. Wheen in my cadence, heavy like a drumline.
