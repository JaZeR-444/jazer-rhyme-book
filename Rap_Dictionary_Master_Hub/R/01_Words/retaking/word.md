...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: retaking mode, retaking codes, retaking road

## 3 bar-ready examples:
1. Retaking in the flow, make the speakers quake.
2. Say Retaking with the vision, watch the crowd awake.
3. Retaking in my cadence, heavy like a drumline.
