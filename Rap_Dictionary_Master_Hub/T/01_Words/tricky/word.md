...
END: cky, ckyd, ckys / SLANT: ck, ckye, ckyy / MULTI: tricky mode, tricky codes, tricky road

## 3 bar-ready examples:
1. Tricky on the mic, watch the room align.
2. Tricky in the flow, make the speakers quake.
3. Say Tricky with the vision, watch the crowd awake.
