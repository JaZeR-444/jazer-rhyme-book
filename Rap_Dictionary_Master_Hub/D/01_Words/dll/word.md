...
END: dll, dlld, dlls / SLANT: dl, dlle, dlly / MULTI: dll mode, dll codes, dll road

## 3 bar-ready examples:
1. Say Dll with the vision, watch the crowd awake.
2. Dll in my cadence, heavy like a drumline.
3. I move with Dll, every step a headline.
