...
END: orm, ormd, orms / SLANT: or, orme, ormy / MULTI: rootworm mode, rootworm codes, rootworm road

## 3 bar-ready examples:
1. Rootworm in the flow, make the speakers quake.
2. Say Rootworm with the vision, watch the crowd awake.
3. Rootworm in my cadence, heavy like a drumline.
