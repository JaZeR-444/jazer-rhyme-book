...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: testing mode, testing codes, testing road

## 3 bar-ready examples:
1. Testing in my cadence, heavy like a drumline.
2. I move with Testing, every step a headline.
3. Testing on the mic, watch the room align.
