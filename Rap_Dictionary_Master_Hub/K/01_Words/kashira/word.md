...
END: ira, irad, iras / SLANT: ir, irae, iray / MULTI: kashira mode, kashira codes, kashira road

## 3 bar-ready examples:
1. Kashira on the mic, watch the room align.
2. Kashira in the flow, make the speakers quake.
3. Say Kashira with the vision, watch the crowd awake.
