...
END: sql, sqld, sqls / SLANT: sq, sqle, sqly / MULTI: mysql mode, mysql codes, mysql road

## 3 bar-ready examples:
1. Mysql on the mic, watch the room align.
2. Mysql in the flow, make the speakers quake.
3. Say Mysql with the vision, watch the crowd awake.
