...
END: lam, lamd, lams / SLANT: la, lame, lamy / MULTI: lam mode, lam codes, lam road

## 3 bar-ready examples:
1. Lam in the flow, make the speakers quake.
2. Say Lam with the vision, watch the crowd awake.
3. Lam in my cadence, heavy like a drumline.
