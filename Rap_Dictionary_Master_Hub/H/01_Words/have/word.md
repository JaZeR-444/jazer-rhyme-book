...
END: ave, aved, aves / SLANT: av, avee, avey / MULTI: have mode, have codes, have road

## 3 bar-ready examples:
1. Have in the flow, make the speakers quake.
2. Say Have with the vision, watch the crowd awake.
3. Have in my cadence, heavy like a drumline.
