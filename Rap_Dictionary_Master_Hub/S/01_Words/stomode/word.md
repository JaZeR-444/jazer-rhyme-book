...
END: ode, oded, odes / SLANT: od, odee, odey / MULTI: stomode mode, stomode codes, stomode road

## 3 bar-ready examples:
1. Stomode in the flow, make the speakers quake.
2. Say Stomode with the vision, watch the crowd awake.
3. Stomode in my cadence, heavy like a drumline.
