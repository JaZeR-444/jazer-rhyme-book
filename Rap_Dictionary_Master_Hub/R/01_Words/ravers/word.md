...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: ravers mode, ravers codes, ravers road

## 3 bar-ready examples:
1. I move with Ravers, every step a headline.
2. Ravers on the mic, watch the room align.
3. Ravers in the flow, make the speakers quake.
