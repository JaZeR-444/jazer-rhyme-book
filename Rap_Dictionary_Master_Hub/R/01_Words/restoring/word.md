...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: restoring mode, restoring codes, restoring road

## 3 bar-ready examples:
1. Restoring on the mic, watch the room align.
2. Restoring in the flow, make the speakers quake.
3. Say Restoring with the vision, watch the crowd awake.
