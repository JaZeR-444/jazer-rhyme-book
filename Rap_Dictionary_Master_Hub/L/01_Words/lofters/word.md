...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: lofters mode, lofters codes, lofters road

## 3 bar-ready examples:
1. I move with Lofters, every step a headline.
2. Lofters on the mic, watch the room align.
3. Lofters in the flow, make the speakers quake.
