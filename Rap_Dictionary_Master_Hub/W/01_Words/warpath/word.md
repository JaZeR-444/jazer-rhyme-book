...
END: ath, athd, aths / SLANT: at, athe, athy / MULTI: warpath mode, warpath codes, warpath road

## 3 bar-ready examples:
1. I move with Warpath, every step a headline.
2. Warpath on the mic, watch the room align.
3. Warpath in the flow, make the speakers quake.
