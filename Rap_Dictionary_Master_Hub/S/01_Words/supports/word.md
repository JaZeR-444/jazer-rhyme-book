...
END: rts, rtsd, rtss / SLANT: rt, rtse, rtsy / MULTI: supports mode, supports codes, supports road

## 3 bar-ready examples:
1. Supports on the mic, watch the room align.
2. Supports in the flow, make the speakers quake.
3. Say Supports with the vision, watch the crowd awake.
