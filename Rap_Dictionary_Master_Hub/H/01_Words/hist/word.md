...
END: ist, istd, ists / SLANT: is, iste, isty / MULTI: hist mode, hist codes, hist road

## 3 bar-ready examples:
1. Hist in the flow, make the speakers quake.
2. Say Hist with the vision, watch the crowd awake.
3. Hist in my cadence, heavy like a drumline.
