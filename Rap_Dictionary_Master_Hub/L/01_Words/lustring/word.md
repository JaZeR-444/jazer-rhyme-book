...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: lustring mode, lustring codes, lustring road

## 3 bar-ready examples:
1. I move with Lustring, every step a headline.
2. Lustring on the mic, watch the room align.
3. Lustring in the flow, make the speakers quake.
