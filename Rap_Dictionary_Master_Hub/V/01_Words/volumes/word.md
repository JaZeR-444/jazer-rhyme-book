...
END: mes, mesd, mess / SLANT: me, mese, mesy / MULTI: volumes mode, volumes codes, volumes road

## 3 bar-ready examples:
1. Say Volumes with the vision, watch the crowd awake.
2. Volumes in my cadence, heavy like a drumline.
3. I move with Volumes, every step a headline.
