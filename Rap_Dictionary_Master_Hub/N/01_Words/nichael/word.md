...
END: ael, aeld, aels / SLANT: ae, aele, aely / MULTI: nichael mode, nichael codes, nichael road

## 3 bar-ready examples:
1. I move with Nichael, every step a headline.
2. Nichael on the mic, watch the room align.
3. Nichael in the flow, make the speakers quake.
