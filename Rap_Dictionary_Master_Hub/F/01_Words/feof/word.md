...
END: eof, eofd, eofs / SLANT: eo, eofe, eofy / MULTI: feof mode, feof codes, feof road

## 3 bar-ready examples:
1. Feof in my cadence, heavy like a drumline.
2. I move with Feof, every step a headline.
3. Feof on the mic, watch the room align.
