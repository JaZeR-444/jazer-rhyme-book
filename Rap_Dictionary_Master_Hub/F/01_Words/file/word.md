...
END: ile, iled, iles / SLANT: il, ilee, iley / MULTI: file mode, file codes, file road

## 3 bar-ready examples:
1. File on the mic, watch the room align.
2. File in the flow, make the speakers quake.
3. Say File with the vision, watch the crowd awake.
