...
END: ppy, ppyd, ppys / SLANT: pp, ppye, ppyy / MULTI: knappy mode, knappy codes, knappy road

## 3 bar-ready examples:
1. Knappy on the mic, watch the room align.
2. Knappy in the flow, make the speakers quake.
3. Say Knappy with the vision, watch the crowd awake.
