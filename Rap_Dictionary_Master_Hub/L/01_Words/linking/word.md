...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: linking mode, linking codes, linking road

## 3 bar-ready examples:
1. I move with Linking, every step a headline.
2. Linking on the mic, watch the room align.
3. Linking in the flow, make the speakers quake.
