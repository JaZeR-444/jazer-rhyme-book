...
END: lls, llsd, llss / SLANT: ll, llse, llsy / MULTI: installs mode, installs codes, installs road

## 3 bar-ready examples:
1. Installs in my cadence, heavy like a drumline.
2. I move with Installs, every step a headline.
3. Installs on the mic, watch the room align.
