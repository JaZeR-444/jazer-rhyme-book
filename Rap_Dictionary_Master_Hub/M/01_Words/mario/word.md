...
END: rio, riod, rios / SLANT: ri, rioe, rioy / MULTI: mario mode, mario codes, mario road

## 3 bar-ready examples:
1. Mario on the mic, watch the room align.
2. Mario in the flow, make the speakers quake.
3. Say Mario with the vision, watch the crowd awake.
