...
END: ims, imsd, imss / SLANT: im, imse, imsy / MULTI: victims mode, victims codes, victims road

## 3 bar-ready examples:
1. I move with Victims, every step a headline.
2. Victims on the mic, watch the room align.
3. Victims in the flow, make the speakers quake.
