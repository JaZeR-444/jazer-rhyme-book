...
END: cur, curd, curs / SLANT: cu, cure, cury / MULTI: occur mode, occur codes, occur road

## 3 bar-ready examples:
1. Occur in the flow, make the speakers quake.
2. Say Occur with the vision, watch the crowd awake.
3. Occur in my cadence, heavy like a drumline.
