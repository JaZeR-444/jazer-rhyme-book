...
END: top, topd, tops / SLANT: to, tope, topy / MULTI: nonstop mode, nonstop codes, nonstop road

## 3 bar-ready examples:
1. I move with Nonstop, every step a headline.
2. Nonstop on the mic, watch the room align.
3. Nonstop in the flow, make the speakers quake.
