...
END: atu, atud, atus / SLANT: at, atue, atuy / MULTI: vanuatu mode, vanuatu codes, vanuatu road

## 3 bar-ready examples:
1. Vanuatu on the mic, watch the room align.
2. Vanuatu in the flow, make the speakers quake.
3. Say Vanuatu with the vision, watch the crowd awake.
