...
END: ite, ited, ites / SLANT: it, itee, itey / MULTI: penlite mode, penlite codes, penlite road

## 3 bar-ready examples:
1. Say Penlite with the vision, watch the crowd awake.
2. Penlite in my cadence, heavy like a drumline.
3. I move with Penlite, every step a headline.
