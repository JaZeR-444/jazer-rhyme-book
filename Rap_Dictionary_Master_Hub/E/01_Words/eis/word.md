...
END: eis, eisd, eiss / SLANT: ei, eise, eisy / MULTI: eis mode, eis codes, eis road

## 3 bar-ready examples:
1. I move with Eis, every step a headline.
2. Eis on the mic, watch the room align.
3. Eis in the flow, make the speakers quake.
