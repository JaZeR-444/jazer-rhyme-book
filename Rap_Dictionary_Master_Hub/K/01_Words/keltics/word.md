...
END: ics, icsd, icss / SLANT: ic, icse, icsy / MULTI: keltics mode, keltics codes, keltics road

## 3 bar-ready examples:
1. I move with Keltics, every step a headline.
2. Keltics on the mic, watch the room align.
3. Keltics in the flow, make the speakers quake.
