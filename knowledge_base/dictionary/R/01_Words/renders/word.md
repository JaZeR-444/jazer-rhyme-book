...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: renders mode, renders codes, renders road

## 3 bar-ready examples:
1. Renders in my cadence, heavy like a drumline.
2. I move with Renders, every step a headline.
3. Renders on the mic, watch the room align.
