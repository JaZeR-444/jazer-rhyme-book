...
END: ose, osed, oses / SLANT: os, osee, osey / MULTI: impose mode, impose codes, impose road

## 3 bar-ready examples:
1. I move with Impose, every step a headline.
2. Impose on the mic, watch the room align.
3. Impose in the flow, make the speakers quake.
