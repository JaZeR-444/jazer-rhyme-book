...
END: oma, omad, omas / SLANT: om, omae, omay / MULTI: eriosoma mode, eriosoma codes, eriosoma road

## 3 bar-ready examples:
1. Eriosoma on the mic, watch the room align.
2. Eriosoma in the flow, make the speakers quake.
3. Say Eriosoma with the vision, watch the crowd awake.
