...
END: oom, oomd, ooms / SLANT: oo, oome, oomy / MULTI: heirloom mode, heirloom codes, heirloom road

## 3 bar-ready examples:
1. I move with Heirloom, every step a headline.
2. Heirloom on the mic, watch the room align.
3. Heirloom in the flow, make the speakers quake.
