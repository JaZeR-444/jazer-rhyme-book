...
END: ren, rend, rens / SLANT: re, rene, reny / MULTI: karen mode, karen codes, karen road

## 3 bar-ready examples:
1. I move with Karen, every step a headline.
2. Karen on the mic, watch the room align.
3. Karen in the flow, make the speakers quake.
