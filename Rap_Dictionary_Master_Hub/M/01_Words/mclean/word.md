...
END: ean, eand, eans / SLANT: ea, eane, eany / MULTI: mclean mode, mclean codes, mclean road

## 3 bar-ready examples:
1. Mclean in the flow, make the speakers quake.
2. Say Mclean with the vision, watch the crowd awake.
3. Mclean in my cadence, heavy like a drumline.
