...
END: els, elsd, elss / SLANT: el, else, elsy / MULTI: kernels mode, kernels codes, kernels road

## 3 bar-ready examples:
1. I move with Kernels, every step a headline.
2. Kernels on the mic, watch the room align.
3. Kernels in the flow, make the speakers quake.
