...
END: ies, iesd, iess / SLANT: ie, iese, iesy / MULTI: varies mode, varies codes, varies road

## 3 bar-ready examples:
1. I move with Varies, every step a headline.
2. Varies on the mic, watch the room align.
3. Varies in the flow, make the speakers quake.
