...
END: est, estd, ests / SLANT: es, este, esty / MULTI: tempest mode, tempest codes, tempest road

## 3 bar-ready examples:
1. Tempest on the mic, watch the room align.
2. Tempest in the flow, make the speakers quake.
3. Say Tempest with the vision, watch the crowd awake.
