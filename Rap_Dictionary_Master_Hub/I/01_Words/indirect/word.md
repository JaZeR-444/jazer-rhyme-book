...
END: ect, ectd, ects / SLANT: ec, ecte, ecty / MULTI: indirect mode, indirect codes, indirect road

## 3 bar-ready examples:
1. Indirect in the flow, make the speakers quake.
2. Say Indirect with the vision, watch the crowd awake.
3. Indirect in my cadence, heavy like a drumline.
