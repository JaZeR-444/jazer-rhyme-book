...
END: sus, susd, suss / SLANT: su, suse, susy / MULTI: versus mode, versus codes, versus road

## 3 bar-ready examples:
1. Versus on the mic, watch the room align.
2. Versus in the flow, make the speakers quake.
3. Say Versus with the vision, watch the crowd awake.
