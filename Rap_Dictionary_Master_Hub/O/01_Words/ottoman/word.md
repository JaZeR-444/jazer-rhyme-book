...
END: man, mand, mans / SLANT: ma, mane, many / MULTI: ottoman mode, ottoman codes, ottoman road

## 3 bar-ready examples:
1. Ottoman in the flow, make the speakers quake.
2. Say Ottoman with the vision, watch the crowd awake.
3. Ottoman in my cadence, heavy like a drumline.
