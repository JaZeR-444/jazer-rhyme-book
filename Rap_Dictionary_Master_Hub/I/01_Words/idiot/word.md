...
END: iot, iotd, iots / SLANT: io, iote, ioty / MULTI: idiot mode, idiot codes, idiot road

## 3 bar-ready examples:
1. I move with Idiot, every step a headline.
2. Idiot on the mic, watch the room align.
3. Idiot in the flow, make the speakers quake.
