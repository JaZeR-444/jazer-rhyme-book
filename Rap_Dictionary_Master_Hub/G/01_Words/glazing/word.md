...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: glazing mode, glazing codes, glazing road

## 3 bar-ready examples:
1. Glazing in the flow, make the speakers quake.
2. Say Glazing with the vision, watch the crowd awake.
3. Glazing in my cadence, heavy like a drumline.
