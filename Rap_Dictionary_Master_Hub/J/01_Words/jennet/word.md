...
END: net, netd, nets / SLANT: ne, nete, nety / MULTI: jennet mode, jennet codes, jennet road

## 3 bar-ready examples:
1. Jennet on the mic, watch the room align.
2. Jennet in the flow, make the speakers quake.
3. Say Jennet with the vision, watch the crowd awake.
