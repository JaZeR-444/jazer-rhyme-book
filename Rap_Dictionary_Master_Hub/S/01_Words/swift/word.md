...
END: ift, iftd, ifts / SLANT: if, ifte, ifty / MULTI: swift mode, swift codes, swift road

## 3 bar-ready examples:
1. Swift in the flow, make the speakers quake.
2. Say Swift with the vision, watch the crowd awake.
3. Swift in my cadence, heavy like a drumline.
