...
END: aid, aidd, aids / SLANT: ai, aide, aidy / MULTI: prepaid mode, prepaid codes, prepaid road

## 3 bar-ready examples:
1. Prepaid on the mic, watch the room align.
2. Prepaid in the flow, make the speakers quake.
3. Say Prepaid with the vision, watch the crowd awake.
