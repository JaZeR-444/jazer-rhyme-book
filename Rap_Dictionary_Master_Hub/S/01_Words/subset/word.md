...
END: set, setd, sets / SLANT: se, sete, sety / MULTI: subset mode, subset codes, subset road

## 3 bar-ready examples:
1. Subset on the mic, watch the room align.
2. Subset in the flow, make the speakers quake.
3. Say Subset with the vision, watch the crowd awake.
