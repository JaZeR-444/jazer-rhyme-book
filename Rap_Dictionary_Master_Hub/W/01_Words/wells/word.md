...
END: lls, llsd, llss / SLANT: ll, llse, llsy / MULTI: wells mode, wells codes, wells road

## 3 bar-ready examples:
1. I move with Wells, every step a headline.
2. Wells on the mic, watch the room align.
3. Wells in the flow, make the speakers quake.
