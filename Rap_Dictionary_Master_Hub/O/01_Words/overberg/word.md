...
END: erg, ergd, ergs / SLANT: er, erge, ergy / MULTI: overberg mode, overberg codes, overberg road

## 3 bar-ready examples:
1. Overberg on the mic, watch the room align.
2. Overberg in the flow, make the speakers quake.
3. Say Overberg with the vision, watch the crowd awake.
