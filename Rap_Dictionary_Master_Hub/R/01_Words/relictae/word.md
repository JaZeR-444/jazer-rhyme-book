...
END: tae, taed, taes / SLANT: ta, taee, taey / MULTI: relictae mode, relictae codes, relictae road

## 3 bar-ready examples:
1. I move with Relictae, every step a headline.
2. Relictae on the mic, watch the room align.
3. Relictae in the flow, make the speakers quake.
