...
END: uke, uked, ukes / SLANT: uk, ukee, ukey / MULTI: yuke mode, yuke codes, yuke road

## 3 bar-ready examples:
1. Yuke in the flow, make the speakers quake.
2. Say Yuke with the vision, watch the crowd awake.
3. Yuke in my cadence, heavy like a drumline.
