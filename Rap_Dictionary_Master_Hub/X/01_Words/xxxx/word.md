...
END: xxx, xxxd, xxxs / SLANT: xx, xxxe, xxxy / MULTI: xxxx mode, xxxx codes, xxxx road

## 3 bar-ready examples:
1. Xxxx in the flow, make the speakers quake.
2. Say Xxxx with the vision, watch the crowd awake.
3. Xxxx in my cadence, heavy like a drumline.
