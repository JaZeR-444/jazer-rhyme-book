...
END: ite, ited, ites / SLANT: it, itee, itey / MULTI: taenite mode, taenite codes, taenite road

## 3 bar-ready examples:
1. I move with Taenite, every step a headline.
2. Taenite on the mic, watch the room align.
3. Taenite in the flow, make the speakers quake.
