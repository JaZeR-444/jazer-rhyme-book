...
END: ies, iesd, iess / SLANT: ie, iese, iesy / MULTI: novelties mode, novelties codes, novelties road

## 3 bar-ready examples:
1. Novelties on the mic, watch the room align.
2. Novelties in the flow, make the speakers quake.
3. Say Novelties with the vision, watch the crowd awake.
