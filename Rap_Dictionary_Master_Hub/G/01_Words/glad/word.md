...
END: lad, ladd, lads / SLANT: la, lade, lady / MULTI: glad mode, glad codes, glad road

## 3 bar-ready examples:
1. I move with Glad, every step a headline.
2. Glad on the mic, watch the room align.
3. Glad in the flow, make the speakers quake.
