...
END: ait, aitd, aits / SLANT: ai, aite, aity / MULTI: wait mode, wait codes, wait road

## 3 bar-ready examples:
1. Wait on the mic, watch the room align.
2. Wait in the flow, make the speakers quake.
3. Say Wait with the vision, watch the crowd awake.
