...
END: ine, ined, ines / SLANT: in, inee, iney / MULTI: yardline mode, yardline codes, yardline road

## 3 bar-ready examples:
1. Yardline in the flow, make the speakers quake.
2. Say Yardline with the vision, watch the crowd awake.
3. Yardline in my cadence, heavy like a drumline.
