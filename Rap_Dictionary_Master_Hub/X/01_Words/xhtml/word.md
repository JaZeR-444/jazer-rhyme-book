...
END: tml, tmld, tmls / SLANT: tm, tmle, tmly / MULTI: xhtml mode, xhtml codes, xhtml road

## 3 bar-ready examples:
1. I move with Xhtml, every step a headline.
2. Xhtml on the mic, watch the room align.
3. Xhtml in the flow, make the speakers quake.
