...
END: opy, opyd, opys / SLANT: op, opye, opyy / MULTI: microscopy mode, microscopy codes, microscopy road

## 3 bar-ready examples:
1. Say Microscopy with the vision, watch the crowd awake.
2. Microscopy in my cadence, heavy like a drumline.
3. I move with Microscopy, every step a headline.
