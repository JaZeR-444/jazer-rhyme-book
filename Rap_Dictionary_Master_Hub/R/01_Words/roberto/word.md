...
END: rto, rtod, rtos / SLANT: rt, rtoe, rtoy / MULTI: roberto mode, roberto codes, roberto road

## 3 bar-ready examples:
1. Roberto on the mic, watch the room align.
2. Roberto in the flow, make the speakers quake.
3. Say Roberto with the vision, watch the crowd awake.
