...
END: sha, shad, shas / SLANT: sh, shae, shay / MULTI: inuyasha mode, inuyasha codes, inuyasha road

## 3 bar-ready examples:
1. Inuyasha on the mic, watch the room align.
2. Inuyasha in the flow, make the speakers quake.
3. Say Inuyasha with the vision, watch the crowd awake.
