...
END: ief, iefd, iefs / SLANT: ie, iefe, iefy / MULTI: relief mode, relief codes, relief road

## 3 bar-ready examples:
1. I move with Relief, every step a headline.
2. Relief on the mic, watch the room align.
3. Relief in the flow, make the speakers quake.
