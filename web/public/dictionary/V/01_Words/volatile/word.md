...
END: ile, iled, iles / SLANT: il, ilee, iley / MULTI: volatile mode, volatile codes, volatile road

## 3 bar-ready examples:
1. Volatile on the mic, watch the room align.
2. Volatile in the flow, make the speakers quake.
3. Say Volatile with the vision, watch the crowd awake.
