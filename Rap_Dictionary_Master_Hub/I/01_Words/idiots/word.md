...
END: ots, otsd, otss / SLANT: ot, otse, otsy / MULTI: idiots mode, idiots codes, idiots road

## 3 bar-ready examples:
1. Idiots on the mic, watch the room align.
2. Idiots in the flow, make the speakers quake.
3. Say Idiots with the vision, watch the crowd awake.
