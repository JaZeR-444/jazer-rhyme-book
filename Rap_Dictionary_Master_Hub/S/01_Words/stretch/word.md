...
END: tch, tchd, tchs / SLANT: tc, tche, tchy / MULTI: stretch mode, stretch codes, stretch road

## 3 bar-ready examples:
1. I move with Stretch, every step a headline.
2. Stretch on the mic, watch the room align.
3. Stretch in the flow, make the speakers quake.
