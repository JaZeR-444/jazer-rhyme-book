...
END: rls, rlsd, rlss / SLANT: rl, rlse, rlsy / MULTI: virls mode, virls codes, virls road

## 3 bar-ready examples:
1. I move with Virls, every step a headline.
2. Virls on the mic, watch the room align.
3. Virls in the flow, make the speakers quake.
