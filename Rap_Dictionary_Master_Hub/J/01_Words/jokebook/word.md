...
END: book, look, shook / SLANT: hook, brook, took / MULTI: one look, leave em shook, tight hook

## 3 bar-ready examples:
1. Jokebook in the flow, make the speakers quake.
2. Say Jokebook with the vision, watch the crowd awake.
3. Jokebook in my cadence, heavy like a drumline.
