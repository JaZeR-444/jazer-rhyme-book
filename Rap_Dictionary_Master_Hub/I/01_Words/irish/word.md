...
END: ish, ishd, ishs / SLANT: is, ishe, ishy / MULTI: irish mode, irish codes, irish road

## 3 bar-ready examples:
1. I move with Irish, every step a headline.
2. Irish on the mic, watch the room align.
3. Irish in the flow, make the speakers quake.
