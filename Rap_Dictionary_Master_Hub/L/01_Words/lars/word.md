...
END: ars, arsd, arss / SLANT: ar, arse, arsy / MULTI: lars mode, lars codes, lars road

## 3 bar-ready examples:
1. Lars on the mic, watch the room align.
2. Lars in the flow, make the speakers quake.
3. Say Lars with the vision, watch the crowd awake.
