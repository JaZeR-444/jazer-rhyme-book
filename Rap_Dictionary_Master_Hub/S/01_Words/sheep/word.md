...
END: eep, eepd, eeps / SLANT: ee, eepe, eepy / MULTI: sheep mode, sheep codes, sheep road

## 3 bar-ready examples:
1. Sheep on the mic, watch the room align.
2. Sheep in the flow, make the speakers quake.
3. Say Sheep with the vision, watch the crowd awake.
