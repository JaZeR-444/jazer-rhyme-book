...
END: con, cond, cons / SLANT: co, cone, cony / MULTI: recon mode, recon codes, recon road

## 3 bar-ready examples:
1. I move with Recon, every step a headline.
2. Recon on the mic, watch the room align.
3. Recon in the flow, make the speakers quake.
