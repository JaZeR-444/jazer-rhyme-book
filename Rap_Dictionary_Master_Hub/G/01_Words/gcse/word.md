...
END: cse, csed, cses / SLANT: cs, csee, csey / MULTI: gcse mode, gcse codes, gcse road

## 3 bar-ready examples:
1. Gcse on the mic, watch the room align.
2. Gcse in the flow, make the speakers quake.
3. Say Gcse with the vision, watch the crowd awake.
