...
END: ken, kend, kens / SLANT: ke, kene, keny / MULTI: starken mode, starken codes, starken road

## 3 bar-ready examples:
1. Starken in the flow, make the speakers quake.
2. Say Starken with the vision, watch the crowd awake.
3. Starken in my cadence, heavy like a drumline.
