...
END: ert, ertd, erts / SLANT: er, erte, erty / MULTI: unquert mode, unquert codes, unquert road

## 3 bar-ready examples:
1. I move with Unquert, every step a headline.
2. Unquert on the mic, watch the room align.
3. Unquert in the flow, make the speakers quake.
