...
END: get, getd, gets / SLANT: ge, gete, gety / MULTI: nugget mode, nugget codes, nugget road

## 3 bar-ready examples:
1. Nugget on the mic, watch the room align.
2. Nugget in the flow, make the speakers quake.
3. Say Nugget with the vision, watch the crowd awake.
