...
END: hya, hyad, hyas / SLANT: hy, hyae, hyay / MULTI: xenophya mode, xenophya codes, xenophya road

## 3 bar-ready examples:
1. Xenophya on the mic, watch the room align.
2. Xenophya in the flow, make the speakers quake.
3. Say Xenophya with the vision, watch the crowd awake.
