...
END: eso, esod, esos / SLANT: es, esoe, esoy / MULTI: yeso mode, yeso codes, yeso road

## 3 bar-ready examples:
1. Yeso in the flow, make the speakers quake.
2. Say Yeso with the vision, watch the crowd awake.
3. Yeso in my cadence, heavy like a drumline.
