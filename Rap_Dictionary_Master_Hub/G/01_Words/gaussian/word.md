...
END: ian, iand, ians / SLANT: ia, iane, iany / MULTI: gaussian mode, gaussian codes, gaussian road

## 3 bar-ready examples:
1. Gaussian on the mic, watch the room align.
2. Gaussian in the flow, make the speakers quake.
3. Say Gaussian with the vision, watch the crowd awake.
