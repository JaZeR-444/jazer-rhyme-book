...
END: ely, elyd, elys / SLANT: el, elye, elyy / MULTI: routinely mode, routinely codes, routinely road

## 3 bar-ready examples:
1. Routinely in my cadence, heavy like a drumline.
2. I move with Routinely, every step a headline.
3. Routinely on the mic, watch the room align.
