...
END: ula, ulad, ulas / SLANT: ul, ulae, ulay / MULTI: fecula mode, fecula codes, fecula road

## 3 bar-ready examples:
1. I move with Fecula, every step a headline.
2. Fecula on the mic, watch the room align.
3. Fecula in the flow, make the speakers quake.
