...
END: tie, tied, ties / SLANT: ti, tiee, tiey / MULTI: kittie mode, kittie codes, kittie road

## 3 bar-ready examples:
1. Kittie on the mic, watch the room align.
2. Kittie in the flow, make the speakers quake.
3. Say Kittie with the vision, watch the crowd awake.
