...
END: ggs, ggsd, ggss / SLANT: gg, ggse, ggsy / MULTI: diggs mode, diggs codes, diggs road

## 3 bar-ready examples:
1. Diggs in the flow, make the speakers quake.
2. Say Diggs with the vision, watch the crowd awake.
3. Diggs in my cadence, heavy like a drumline.
