...
END: ite, ited, ites / SLANT: it, itee, itey / MULTI: xylite mode, xylite codes, xylite road

## 3 bar-ready examples:
1. Xylite in my cadence, heavy like a drumline.
2. I move with Xylite, every step a headline.
3. Xylite on the mic, watch the room align.
