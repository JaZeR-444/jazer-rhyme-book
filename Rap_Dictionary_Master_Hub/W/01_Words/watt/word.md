...
END: att, attd, atts / SLANT: at, atte, atty / MULTI: watt mode, watt codes, watt road

## 3 bar-ready examples:
1. Watt in the flow, make the speakers quake.
2. Say Watt with the vision, watch the crowd awake.
3. Watt in my cadence, heavy like a drumline.
