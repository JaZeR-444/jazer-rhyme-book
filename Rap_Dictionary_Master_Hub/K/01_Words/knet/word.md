...
END: net, netd, nets / SLANT: ne, nete, nety / MULTI: knet mode, knet codes, knet road

## 3 bar-ready examples:
1. Knet in the flow, make the speakers quake.
2. Say Knet with the vision, watch the crowd awake.
3. Knet in my cadence, heavy like a drumline.
