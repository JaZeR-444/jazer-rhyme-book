...
END: usa, usad, usas / SLANT: us, usae, usay / MULTI: medusa mode, medusa codes, medusa road

## 3 bar-ready examples:
1. I move with Medusa, every step a headline.
2. Medusa on the mic, watch the room align.
3. Medusa in the flow, make the speakers quake.
