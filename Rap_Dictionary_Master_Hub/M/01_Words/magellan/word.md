...
END: lan, land, lans / SLANT: la, lane, lany / MULTI: magellan mode, magellan codes, magellan road

## 3 bar-ready examples:
1. Magellan on the mic, watch the room align.
2. Magellan in the flow, make the speakers quake.
3. Say Magellan with the vision, watch the crowd awake.
