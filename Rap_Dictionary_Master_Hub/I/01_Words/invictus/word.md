...
END: tus, tusd, tuss / SLANT: tu, tuse, tusy / MULTI: invictus mode, invictus codes, invictus road

## 3 bar-ready examples:
1. Invictus on the mic, watch the room align.
2. Invictus in the flow, make the speakers quake.
3. Say Invictus with the vision, watch the crowd awake.
