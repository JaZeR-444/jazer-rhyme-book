...
END: rry, rryd, rrys / SLANT: rr, rrye, rryy / MULTI: strawberry mode, strawberry codes, strawberry road

## 3 bar-ready examples:
1. Strawberry on the mic, watch the room align.
2. Strawberry in the flow, make the speakers quake.
3. Say Strawberry with the vision, watch the crowd awake.
