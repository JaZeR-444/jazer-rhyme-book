...
END: gro, grod, gros / SLANT: gr, groe, groy / MULTI: negro mode, negro codes, negro road

## 3 bar-ready examples:
1. I move with Negro, every step a headline.
2. Negro on the mic, watch the room align.
3. Negro in the flow, make the speakers quake.
