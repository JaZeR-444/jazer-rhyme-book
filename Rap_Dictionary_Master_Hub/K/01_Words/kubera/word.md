...
END: era, erad, eras / SLANT: er, erae, eray / MULTI: kubera mode, kubera codes, kubera road

## 3 bar-ready examples:
1. I move with Kubera, every step a headline.
2. Kubera on the mic, watch the room align.
3. Kubera in the flow, make the speakers quake.
