...
END: ila, ilad, ilas / SLANT: il, ilae, ilay / MULTI: kafila mode, kafila codes, kafila road

## 3 bar-ready examples:
1. Kafila in the flow, make the speakers quake.
2. Say Kafila with the vision, watch the crowd awake.
3. Kafila in my cadence, heavy like a drumline.
