...
END: ose, osed, oses / SLANT: os, osee, osey / MULTI: heptose mode, heptose codes, heptose road

## 3 bar-ready examples:
1. I move with Heptose, every step a headline.
2. Heptose on the mic, watch the room align.
3. Heptose in the flow, make the speakers quake.
