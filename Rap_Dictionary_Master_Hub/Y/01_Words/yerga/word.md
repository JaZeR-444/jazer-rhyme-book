...
END: rga, rgad, rgas / SLANT: rg, rgae, rgay / MULTI: yerga mode, yerga codes, yerga road

## 3 bar-ready examples:
1. Yerga on the mic, watch the room align.
2. Yerga in the flow, make the speakers quake.
3. Say Yerga with the vision, watch the crowd awake.
