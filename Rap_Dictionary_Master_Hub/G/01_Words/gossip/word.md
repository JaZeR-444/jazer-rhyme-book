...
END: sip, sipd, sips / SLANT: si, sipe, sipy / MULTI: gossip mode, gossip codes, gossip road

## 3 bar-ready examples:
1. Gossip in the flow, make the speakers quake.
2. Say Gossip with the vision, watch the crowd awake.
3. Gossip in my cadence, heavy like a drumline.
