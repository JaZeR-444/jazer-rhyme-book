...
END: kan, kand, kans / SLANT: ka, kane, kany / MULTI: korakan mode, korakan codes, korakan road

## 3 bar-ready examples:
1. Korakan on the mic, watch the room align.
2. Korakan in the flow, make the speakers quake.
3. Say Korakan with the vision, watch the crowd awake.
