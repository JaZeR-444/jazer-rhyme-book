...
END: chy, chyd, chys / SLANT: ch, chye, chyy / MULTI: haunchy mode, haunchy codes, haunchy road

## 3 bar-ready examples:
1. I move with Haunchy, every step a headline.
2. Haunchy on the mic, watch the room align.
3. Haunchy in the flow, make the speakers quake.
