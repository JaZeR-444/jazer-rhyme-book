...
END: tty, ttyd, ttys / SLANT: tt, ttye, ttyy / MULTI: kitty mode, kitty codes, kitty road

## 3 bar-ready examples:
1. Kitty in the flow, make the speakers quake.
2. Say Kitty with the vision, watch the crowd awake.
3. Kitty in my cadence, heavy like a drumline.
