...
END: ndo, ndod, ndos / SLANT: nd, ndoe, ndoy / MULTI: quando mode, quando codes, quando road

## 3 bar-ready examples:
1. Quando in my cadence, heavy like a drumline.
2. I move with Quando, every step a headline.
3. Quando on the mic, watch the room align.
