...
END: hes, hesd, hess / SLANT: he, hese, hesy / MULTI: queenfishes mode, queenfishes codes, queenfishes road

## 3 bar-ready examples:
1. Queenfishes in the flow, make the speakers quake.
2. Say Queenfishes with the vision, watch the crowd awake.
3. Queenfishes in my cadence, heavy like a drumline.
