...
END: pad, padd, pads / SLANT: pa, pade, pady / MULTI: footpad mode, footpad codes, footpad road

## 3 bar-ready examples:
1. I move with Footpad, every step a headline.
2. Footpad on the mic, watch the room align.
3. Footpad in the flow, make the speakers quake.
