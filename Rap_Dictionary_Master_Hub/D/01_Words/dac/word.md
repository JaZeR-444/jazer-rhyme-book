...
END: dac, dacd, dacs / SLANT: da, dace, dacy / MULTI: dac mode, dac codes, dac road

## 3 bar-ready examples:
1. Dac in the flow, make the speakers quake.
2. Say Dac with the vision, watch the crowd awake.
3. Dac in my cadence, heavy like a drumline.
