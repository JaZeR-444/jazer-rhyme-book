...
END: box, boxd, boxs / SLANT: bo, boxe, boxy / MULTI: inbox mode, inbox codes, inbox road

## 3 bar-ready examples:
1. I move with Inbox, every step a headline.
2. Inbox on the mic, watch the room align.
3. Inbox in the flow, make the speakers quake.
