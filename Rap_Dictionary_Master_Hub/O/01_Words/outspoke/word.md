...
END: oke, oked, okes / SLANT: ok, okee, okey / MULTI: outspoke mode, outspoke codes, outspoke road

## 3 bar-ready examples:
1. Outspoke on the mic, watch the room align.
2. Outspoke in the flow, make the speakers quake.
3. Say Outspoke with the vision, watch the crowd awake.
