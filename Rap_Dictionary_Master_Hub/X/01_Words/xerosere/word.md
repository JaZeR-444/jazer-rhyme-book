...
END: ere, ered, eres / SLANT: er, eree, erey / MULTI: xerosere mode, xerosere codes, xerosere road

## 3 bar-ready examples:
1. I move with Xerosere, every step a headline.
2. Xerosere on the mic, watch the room align.
3. Xerosere in the flow, make the speakers quake.
