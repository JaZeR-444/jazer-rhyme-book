...
END: man, mand, mans / SLANT: ma, mane, many / MULTI: saltman mode, saltman codes, saltman road

## 3 bar-ready examples:
1. I move with Saltman, every step a headline.
2. Saltman on the mic, watch the room align.
3. Saltman in the flow, make the speakers quake.
