...
END: ons, onsd, onss / SLANT: on, onse, onsy / MULTI: icons mode, icons codes, icons road

## 3 bar-ready examples:
1. Icons on the mic, watch the room align.
2. Icons in the flow, make the speakers quake.
3. Say Icons with the vision, watch the crowd awake.
