...
END: arp, arpd, arps / SLANT: ar, arpe, arpy / MULTI: xylocarp mode, xylocarp codes, xylocarp road

## 3 bar-ready examples:
1. I move with Xylocarp, every step a headline.
2. Xylocarp on the mic, watch the room align.
3. Xylocarp in the flow, make the speakers quake.
