...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: lying mode, lying codes, lying road

## 3 bar-ready examples:
1. I move with Lying, every step a headline.
2. Lying on the mic, watch the room align.
3. Lying in the flow, make the speakers quake.
