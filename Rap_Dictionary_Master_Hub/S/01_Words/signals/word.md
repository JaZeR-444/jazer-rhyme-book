...
END: als, alsd, alss / SLANT: al, alse, alsy / MULTI: signals mode, signals codes, signals road

## 3 bar-ready examples:
1. Signals on the mic, watch the room align.
2. Signals in the flow, make the speakers quake.
3. Say Signals with the vision, watch the crowd awake.
