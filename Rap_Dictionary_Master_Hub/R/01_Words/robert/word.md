...
END: ert, ertd, erts / SLANT: er, erte, erty / MULTI: robert mode, robert codes, robert road

## 3 bar-ready examples:
1. Robert in the flow, make the speakers quake.
2. Say Robert with the vision, watch the crowd awake.
3. Robert in my cadence, heavy like a drumline.
