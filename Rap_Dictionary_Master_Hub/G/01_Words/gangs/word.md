...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: gangs mode, gangs codes, gangs road

## 3 bar-ready examples:
1. I move with Gangs, every step a headline.
2. Gangs on the mic, watch the room align.
3. Gangs in the flow, make the speakers quake.
