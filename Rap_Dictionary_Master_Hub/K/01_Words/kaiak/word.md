...
END: iak, iakd, iaks / SLANT: ia, iake, iaky / MULTI: kaiak mode, kaiak codes, kaiak road

## 3 bar-ready examples:
1. Kaiak on the mic, watch the room align.
2. Kaiak in the flow, make the speakers quake.
3. Say Kaiak with the vision, watch the crowd awake.
