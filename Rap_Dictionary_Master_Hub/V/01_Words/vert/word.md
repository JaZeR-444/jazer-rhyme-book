...
END: ert, ertd, erts / SLANT: er, erte, erty / MULTI: vert mode, vert codes, vert road

## 3 bar-ready examples:
1. Vert on the mic, watch the room align.
2. Vert in the flow, make the speakers quake.
3. Say Vert with the vision, watch the crowd awake.
