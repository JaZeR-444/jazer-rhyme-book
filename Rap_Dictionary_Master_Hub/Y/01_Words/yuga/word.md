...
END: uga, ugad, ugas / SLANT: ug, ugae, ugay / MULTI: yuga mode, yuga codes, yuga road

## 3 bar-ready examples:
1. Yuga in the flow, make the speakers quake.
2. Say Yuga with the vision, watch the crowd awake.
3. Yuga in my cadence, heavy like a drumline.
