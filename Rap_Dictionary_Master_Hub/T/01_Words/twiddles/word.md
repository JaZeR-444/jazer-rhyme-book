...
END: les, lesd, less / SLANT: le, lese, lesy / MULTI: twiddles mode, twiddles codes, twiddles road

## 3 bar-ready examples:
1. I move with Twiddles, every step a headline.
2. Twiddles on the mic, watch the room align.
3. Twiddles in the flow, make the speakers quake.
