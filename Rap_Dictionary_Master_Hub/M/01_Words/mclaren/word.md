...
END: ren, rend, rens / SLANT: re, rene, reny / MULTI: mclaren mode, mclaren codes, mclaren road

## 3 bar-ready examples:
1. Mclaren in the flow, make the speakers quake.
2. Say Mclaren with the vision, watch the crowd awake.
3. Mclaren in my cadence, heavy like a drumline.
