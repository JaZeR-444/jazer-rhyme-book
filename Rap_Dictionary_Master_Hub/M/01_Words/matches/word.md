...
END: hes, hesd, hess / SLANT: he, hese, hesy / MULTI: matches mode, matches codes, matches road

## 3 bar-ready examples:
1. I move with Matches, every step a headline.
2. Matches on the mic, watch the room align.
3. Matches in the flow, make the speakers quake.
