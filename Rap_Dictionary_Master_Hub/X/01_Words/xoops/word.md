...
END: ops, opsd, opss / SLANT: op, opse, opsy / MULTI: xoops mode, xoops codes, xoops road

## 3 bar-ready examples:
1. Xoops in the flow, make the speakers quake.
2. Say Xoops with the vision, watch the crowd awake.
3. Xoops in my cadence, heavy like a drumline.
