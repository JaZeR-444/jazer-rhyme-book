...
END: ike, iked, ikes / SLANT: ik, ikee, ikey / MULTI: spike mode, spike codes, spike road

## 3 bar-ready examples:
1. I move with Spike, every step a headline.
2. Spike on the mic, watch the room align.
3. Spike in the flow, make the speakers quake.
