...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: headings mode, headings codes, headings road

## 3 bar-ready examples:
1. Headings on the mic, watch the room align.
2. Headings in the flow, make the speakers quake.
3. Say Headings with the vision, watch the crowd awake.
