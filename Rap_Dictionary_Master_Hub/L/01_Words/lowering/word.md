...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: lowering mode, lowering codes, lowering road

## 3 bar-ready examples:
1. I move with Lowering, every step a headline.
2. Lowering on the mic, watch the room align.
3. Lowering in the flow, make the speakers quake.
