...
END: ret, retd, rets / SLANT: re, rete, rety / MULTI: regret mode, regret codes, regret road

## 3 bar-ready examples:
1. Say Regret with the vision, watch the crowd awake.
2. Regret in my cadence, heavy like a drumline.
3. I move with Regret, every step a headline.
