...
END: ots, otsd, otss / SLANT: ot, otse, otsy / MULTI: shoots mode, shoots codes, shoots road

## 3 bar-ready examples:
1. Shoots on the mic, watch the room align.
2. Shoots in the flow, make the speakers quake.
3. Say Shoots with the vision, watch the crowd awake.
