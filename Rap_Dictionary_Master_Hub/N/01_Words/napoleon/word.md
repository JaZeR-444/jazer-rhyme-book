...
END: eon, eond, eons / SLANT: eo, eone, eony / MULTI: napoleon mode, napoleon codes, napoleon road

## 3 bar-ready examples:
1. Napoleon on the mic, watch the room align.
2. Napoleon in the flow, make the speakers quake.
3. Say Napoleon with the vision, watch the crowd awake.
