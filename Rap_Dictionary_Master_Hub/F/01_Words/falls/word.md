...
END: lls, llsd, llss / SLANT: ll, llse, llsy / MULTI: falls mode, falls codes, falls road

## 3 bar-ready examples:
1. I move with Falls, every step a headline.
2. Falls on the mic, watch the room align.
3. Falls in the flow, make the speakers quake.
