...
END: sha, shad, shas / SLANT: sh, shae, shay / MULTI: geisha mode, geisha codes, geisha road

## 3 bar-ready examples:
1. Geisha in my cadence, heavy like a drumline.
2. I move with Geisha, every step a headline.
3. Geisha on the mic, watch the room align.
