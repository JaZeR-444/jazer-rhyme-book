...
END: hop, hopd, hops / SLANT: ho, hope, hopy / MULTI: workshop mode, workshop codes, workshop road

## 3 bar-ready examples:
1. I move with Workshop, every step a headline.
2. Workshop on the mic, watch the room align.
3. Workshop in the flow, make the speakers quake.
