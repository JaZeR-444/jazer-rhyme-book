...
END: dun, dund, duns / SLANT: du, dune, duny / MULTI: yildun mode, yildun codes, yildun road

## 3 bar-ready examples:
1. I move with Yildun, every step a headline.
2. Yildun on the mic, watch the room align.
3. Yildun in the flow, make the speakers quake.
