...
END: ets, etsd, etss / SLANT: et, etse, etsy / MULTI: tickets mode, tickets codes, tickets road

## 3 bar-ready examples:
1. Tickets on the mic, watch the room align.
2. Tickets in the flow, make the speakers quake.
3. Say Tickets with the vision, watch the crowd awake.
