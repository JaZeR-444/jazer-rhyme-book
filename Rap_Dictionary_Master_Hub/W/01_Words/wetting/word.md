...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: wetting mode, wetting codes, wetting road

## 3 bar-ready examples:
1. I move with Wetting, every step a headline.
2. Wetting on the mic, watch the room align.
3. Wetting in the flow, make the speakers quake.
