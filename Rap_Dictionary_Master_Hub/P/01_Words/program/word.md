...
END: ram, ramd, rams / SLANT: ra, rame, ramy / MULTI: program mode, program codes, program road

## 3 bar-ready examples:
1. Program in my cadence, heavy like a drumline.
2. I move with Program, every step a headline.
3. Program on the mic, watch the room align.
