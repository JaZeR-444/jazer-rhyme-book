...
END: oca, ocad, ocas / SLANT: oc, ocae, ocay / MULTI: troca mode, troca codes, troca road

## 3 bar-ready examples:
1. Troca on the mic, watch the room align.
2. Troca in the flow, make the speakers quake.
3. Say Troca with the vision, watch the crowd awake.
