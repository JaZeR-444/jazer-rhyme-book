...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: responses mode, responses codes, responses road

## 3 bar-ready examples:
1. Responses in the flow, make the speakers quake.
2. Say Responses with the vision, watch the crowd awake.
3. Responses in my cadence, heavy like a drumline.
