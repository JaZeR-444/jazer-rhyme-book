...
END: zzy, zzyd, zzys / SLANT: zz, zzye, zzyy / MULTI: quizzy mode, quizzy codes, quizzy road

## 3 bar-ready examples:
1. I move with Quizzy, every step a headline.
2. Quizzy on the mic, watch the room align.
3. Quizzy in the flow, make the speakers quake.
