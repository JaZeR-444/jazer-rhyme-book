...
END: iki, ikid, ikis / SLANT: ik, ikie, ikiy / MULTI: konohiki mode, konohiki codes, konohiki road

## 3 bar-ready examples:
1. I move with Konohiki, every step a headline.
2. Konohiki on the mic, watch the room align.
3. Konohiki in the flow, make the speakers quake.
