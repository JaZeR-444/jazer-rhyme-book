...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: happenings mode, happenings codes, happenings road

## 3 bar-ready examples:
1. Happenings in the flow, make the speakers quake.
2. Say Happenings with the vision, watch the crowd awake.
3. Happenings in my cadence, heavy like a drumline.
