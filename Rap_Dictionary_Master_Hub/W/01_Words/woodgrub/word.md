...
END: rub, rubd, rubs / SLANT: ru, rube, ruby / MULTI: woodgrub mode, woodgrub codes, woodgrub road

## 3 bar-ready examples:
1. I move with Woodgrub, every step a headline.
2. Woodgrub on the mic, watch the room align.
3. Woodgrub in the flow, make the speakers quake.
