...
END: ids, idsd, idss / SLANT: id, idse, idsy / MULTI: rapids mode, rapids codes, rapids road

## 3 bar-ready examples:
1. Rapids in the flow, make the speakers quake.
2. Say Rapids with the vision, watch the crowd awake.
3. Rapids in my cadence, heavy like a drumline.
