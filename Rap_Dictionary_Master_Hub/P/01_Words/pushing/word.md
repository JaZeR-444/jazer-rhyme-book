...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: pushing mode, pushing codes, pushing road

## 3 bar-ready examples:
1. I move with Pushing, every step a headline.
2. Pushing on the mic, watch the room align.
3. Pushing in the flow, make the speakers quake.
