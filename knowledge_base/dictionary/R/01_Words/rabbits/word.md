...
END: its, itsd, itss / SLANT: it, itse, itsy / MULTI: rabbits mode, rabbits codes, rabbits road

## 3 bar-ready examples:
1. I move with Rabbits, every step a headline.
2. Rabbits on the mic, watch the room align.
3. Rabbits in the flow, make the speakers quake.
