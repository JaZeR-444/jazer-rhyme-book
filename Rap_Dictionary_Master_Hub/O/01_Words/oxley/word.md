...
END: ley, leyd, leys / SLANT: le, leye, leyy / MULTI: oxley mode, oxley codes, oxley road

## 3 bar-ready examples:
1. I move with Oxley, every step a headline.
2. Oxley on the mic, watch the room align.
3. Oxley in the flow, make the speakers quake.
