...
END: lub, lubd, lubs / SLANT: lu, lube, luby / MULTI: nightclub mode, nightclub codes, nightclub road

## 3 bar-ready examples:
1. Nightclub on the mic, watch the room align.
2. Nightclub in the flow, make the speakers quake.
3. Say Nightclub with the vision, watch the crowd awake.
