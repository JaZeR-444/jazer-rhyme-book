...
END: rts, rtsd, rtss / SLANT: rt, rtse, rtsy / MULTI: reports mode, reports codes, reports road

## 3 bar-ready examples:
1. Reports on the mic, watch the room align.
2. Reports in the flow, make the speakers quake.
3. Say Reports with the vision, watch the crowd awake.
