...
END: ure, ured, ures / SLANT: ur, uree, urey / MULTI: voiture mode, voiture codes, voiture road

## 3 bar-ready examples:
1. Voiture on the mic, watch the room align.
2. Voiture in the flow, make the speakers quake.
3. Say Voiture with the vision, watch the crowd awake.
