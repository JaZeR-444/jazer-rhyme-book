...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: failing mode, failing codes, failing road

## 3 bar-ready examples:
1. Failing in my cadence, heavy like a drumline.
2. I move with Failing, every step a headline.
3. Failing on the mic, watch the room align.
