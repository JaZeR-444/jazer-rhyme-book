...
END: oyt, oytd, oyts / SLANT: oy, oyte, oyty / MULTI: floyt mode, floyt codes, floyt road

## 3 bar-ready examples:
1. Floyt on the mic, watch the room align.
2. Floyt in the flow, make the speakers quake.
3. Say Floyt with the vision, watch the crowd awake.
