...
END: acs, acsd, acss / SLANT: ac, acse, acsy / MULTI: xemacs mode, xemacs codes, xemacs road

## 3 bar-ready examples:
1. Xemacs in the flow, make the speakers quake.
2. Say Xemacs with the vision, watch the crowd awake.
3. Xemacs in my cadence, heavy like a drumline.
