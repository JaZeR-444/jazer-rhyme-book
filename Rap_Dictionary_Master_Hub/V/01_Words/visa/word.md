...
END: isa, isad, isas / SLANT: is, isae, isay / MULTI: visa mode, visa codes, visa road

## 3 bar-ready examples:
1. Visa in the flow, make the speakers quake.
2. Say Visa with the vision, watch the crowd awake.
3. Visa in my cadence, heavy like a drumline.
