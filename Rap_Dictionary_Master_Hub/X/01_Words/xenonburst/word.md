...
END: rst, rstd, rsts / SLANT: rs, rste, rsty / MULTI: xenonburst mode, xenonburst codes, xenonburst road

## 3 bar-ready examples:
1. Xenonburst in my cadence, heavy like a drumline.
2. I move with Xenonburst, every step a headline.
3. Xenonburst on the mic, watch the room align.
