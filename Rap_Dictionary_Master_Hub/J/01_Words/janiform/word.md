...
END: orm, ormd, orms / SLANT: or, orme, ormy / MULTI: janiform mode, janiform codes, janiform road

## 3 bar-ready examples:
1. Janiform in the flow, make the speakers quake.
2. Say Janiform with the vision, watch the crowd awake.
3. Janiform in my cadence, heavy like a drumline.
