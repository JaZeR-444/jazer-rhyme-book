...
END: lis, lisd, liss / SLANT: li, lise, lisy / MULTI: wallis mode, wallis codes, wallis road

## 3 bar-ready examples:
1. Wallis on the mic, watch the room align.
2. Wallis in the flow, make the speakers quake.
3. Say Wallis with the vision, watch the crowd awake.
