...
END: lio, liod, lios / SLANT: li, lioe, lioy / MULTI: quellio mode, quellio codes, quellio road

## 3 bar-ready examples:
1. Quellio on the mic, watch the room align.
2. Quellio in the flow, make the speakers quake.
3. Say Quellio with the vision, watch the crowd awake.
