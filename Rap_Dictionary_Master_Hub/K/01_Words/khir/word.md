...
END: hir, hird, hirs / SLANT: hi, hire, hiry / MULTI: khir mode, khir codes, khir road

## 3 bar-ready examples:
1. I move with Khir, every step a headline.
2. Khir on the mic, watch the room align.
3. Khir in the flow, make the speakers quake.
