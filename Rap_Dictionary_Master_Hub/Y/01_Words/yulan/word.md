...
END: lan, land, lans / SLANT: la, lane, lany / MULTI: yulan mode, yulan codes, yulan road

## 3 bar-ready examples:
1. Yulan on the mic, watch the room align.
2. Yulan in the flow, make the speakers quake.
3. Say Yulan with the vision, watch the crowd awake.
