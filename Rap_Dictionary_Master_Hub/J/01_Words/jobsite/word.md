...
END: ite, ited, ites / SLANT: it, itee, itey / MULTI: jobsite mode, jobsite codes, jobsite road

## 3 bar-ready examples:
1. I move with Jobsite, every step a headline.
2. Jobsite on the mic, watch the room align.
3. Jobsite in the flow, make the speakers quake.
