...
END: ope, oped, opes / SLANT: op, opee, opey / MULTI: isotope mode, isotope codes, isotope road

## 3 bar-ready examples:
1. I move with Isotope, every step a headline.
2. Isotope on the mic, watch the room align.
3. Isotope in the flow, make the speakers quake.
