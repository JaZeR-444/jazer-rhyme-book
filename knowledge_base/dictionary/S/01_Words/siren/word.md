...
END: ren, rend, rens / SLANT: re, rene, reny / MULTI: siren mode, siren codes, siren road

## 3 bar-ready examples:
1. Siren on the mic, watch the room align.
2. Siren in the flow, make the speakers quake.
3. Say Siren with the vision, watch the crowd awake.
