...
END: ite, ited, ites / SLANT: it, itee, itey / MULTI: onsite mode, onsite codes, onsite road

## 3 bar-ready examples:
1. I move with Onsite, every step a headline.
2. Onsite on the mic, watch the room align.
3. Onsite in the flow, make the speakers quake.
