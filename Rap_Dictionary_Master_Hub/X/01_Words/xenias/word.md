...
END: ias, iasd, iass / SLANT: ia, iase, iasy / MULTI: xenias mode, xenias codes, xenias road

## 3 bar-ready examples:
1. I move with Xenias, every step a headline.
2. Xenias on the mic, watch the room align.
3. Xenias in the flow, make the speakers quake.
