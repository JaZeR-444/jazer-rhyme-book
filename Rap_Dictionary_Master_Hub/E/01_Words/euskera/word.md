...
END: era, erad, eras / SLANT: er, erae, eray / MULTI: euskera mode, euskera codes, euskera road

## 3 bar-ready examples:
1. I move with Euskera, every step a headline.
2. Euskera on the mic, watch the room align.
3. Euskera in the flow, make the speakers quake.
