...
END: rus, rusd, russ / SLANT: ru, ruse, rusy / MULTI: xiphosurus mode, xiphosurus codes, xiphosurus road

## 3 bar-ready examples:
1. I move with Xiphosurus, every step a headline.
2. Xiphosurus on the mic, watch the room align.
3. Xiphosurus in the flow, make the speakers quake.
