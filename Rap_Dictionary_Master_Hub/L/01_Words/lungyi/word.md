...
END: gyi, gyid, gyis / SLANT: gy, gyie, gyiy / MULTI: lungyi mode, lungyi codes, lungyi road

## 3 bar-ready examples:
1. Lungyi on the mic, watch the room align.
2. Lungyi in the flow, make the speakers quake.
3. Say Lungyi with the vision, watch the crowd awake.
