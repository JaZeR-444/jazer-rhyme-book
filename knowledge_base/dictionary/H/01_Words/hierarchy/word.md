...
END: chy, chyd, chys / SLANT: ch, chye, chyy / MULTI: hierarchy mode, hierarchy codes, hierarchy road

## 3 bar-ready examples:
1. Hierarchy in the flow, make the speakers quake.
2. Say Hierarchy with the vision, watch the crowd awake.
3. Hierarchy in my cadence, heavy like a drumline.
