...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: tagging mode, tagging codes, tagging road

## 3 bar-ready examples:
1. Tagging on the mic, watch the room align.
2. Tagging in the flow, make the speakers quake.
3. Say Tagging with the vision, watch the crowd awake.
