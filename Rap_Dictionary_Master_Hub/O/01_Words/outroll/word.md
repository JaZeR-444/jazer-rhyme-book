...
END: oll, olld, olls / SLANT: ol, olle, olly / MULTI: outroll mode, outroll codes, outroll road

## 3 bar-ready examples:
1. Outroll on the mic, watch the room align.
2. Outroll in the flow, make the speakers quake.
3. Say Outroll with the vision, watch the crowd awake.
