...
END: ule, uled, ules / SLANT: ul, ulee, uley / MULTI: moule mode, moule codes, moule road

## 3 bar-ready examples:
1. I move with Moule, every step a headline.
2. Moule on the mic, watch the room align.
3. Moule in the flow, make the speakers quake.
