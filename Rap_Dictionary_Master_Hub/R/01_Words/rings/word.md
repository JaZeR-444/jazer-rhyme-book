...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: rings mode, rings codes, rings road

## 3 bar-ready examples:
1. I move with Rings, every step a headline.
2. Rings on the mic, watch the room align.
3. Rings in the flow, make the speakers quake.
