...
END: est, estd, ests / SLANT: es, este, esty / MULTI: firmest mode, firmest codes, firmest road

## 3 bar-ready examples:
1. I move with Firmest, every step a headline.
2. Firmest on the mic, watch the room align.
3. Firmest in the flow, make the speakers quake.
