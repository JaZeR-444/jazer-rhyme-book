...
END: let, letd, lets / SLANT: le, lete, lety / MULTI: lunulet mode, lunulet codes, lunulet road

## 3 bar-ready examples:
1. Lunulet in the flow, make the speakers quake.
2. Say Lunulet with the vision, watch the crowd awake.
3. Lunulet in my cadence, heavy like a drumline.
