...
END: rge, rged, rges / SLANT: rg, rgee, rgey / MULTI: merge mode, merge codes, merge road

## 3 bar-ready examples:
1. Say Merge with the vision, watch the crowd awake.
2. Merge in my cadence, heavy like a drumline.
3. I move with Merge, every step a headline.
