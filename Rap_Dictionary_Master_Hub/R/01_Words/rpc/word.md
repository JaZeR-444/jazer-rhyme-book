...
END: rpc, rpcd, rpcs / SLANT: rp, rpce, rpcy / MULTI: rpc mode, rpc codes, rpc road

## 3 bar-ready examples:
1. I move with Rpc, every step a headline.
2. Rpc on the mic, watch the room align.
3. Rpc in the flow, make the speakers quake.
