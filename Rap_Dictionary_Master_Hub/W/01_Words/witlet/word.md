...
END: let, letd, lets / SLANT: le, lete, lety / MULTI: witlet mode, witlet codes, witlet road

## 3 bar-ready examples:
1. Say Witlet with the vision, watch the crowd awake.
2. Witlet in my cadence, heavy like a drumline.
3. I move with Witlet, every step a headline.
