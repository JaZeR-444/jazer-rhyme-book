...
END: sel, seld, sels / SLANT: se, sele, sely / MULTI: imbesel mode, imbesel codes, imbesel road

## 3 bar-ready examples:
1. Imbesel in the flow, make the speakers quake.
2. Say Imbesel with the vision, watch the crowd awake.
3. Imbesel in my cadence, heavy like a drumline.
