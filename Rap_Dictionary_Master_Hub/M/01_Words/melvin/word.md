...
END: vin, vind, vins / SLANT: vi, vine, viny / MULTI: melvin mode, melvin codes, melvin road

## 3 bar-ready examples:
1. I move with Melvin, every step a headline.
2. Melvin on the mic, watch the room align.
3. Melvin in the flow, make the speakers quake.
