...
END: nes, nesd, ness / SLANT: ne, nese, nesy / MULTI: wines mode, wines codes, wines road

## 3 bar-ready examples:
1. Wines in the flow, make the speakers quake.
2. Say Wines with the vision, watch the crowd awake.
3. Wines in my cadence, heavy like a drumline.
