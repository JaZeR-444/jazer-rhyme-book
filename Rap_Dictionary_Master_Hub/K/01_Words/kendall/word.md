...
END: all, alld, alls / SLANT: al, alle, ally / MULTI: kendall mode, kendall codes, kendall road

## 3 bar-ready examples:
1. Kendall in the flow, make the speakers quake.
2. Say Kendall with the vision, watch the crowd awake.
3. Kendall in my cadence, heavy like a drumline.
