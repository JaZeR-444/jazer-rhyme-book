...
END: vos, vosd, voss / SLANT: vo, vose, vosy / MULTI: servos mode, servos codes, servos road

## 3 bar-ready examples:
1. Servos in my cadence, heavy like a drumline.
2. I move with Servos, every step a headline.
3. Servos on the mic, watch the room align.
