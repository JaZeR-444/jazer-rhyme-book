...
END: unn, unnd, unns / SLANT: un, unne, unny / MULTI: jotunn mode, jotunn codes, jotunn road

## 3 bar-ready examples:
1. Jotunn on the mic, watch the room align.
2. Jotunn in the flow, make the speakers quake.
3. Say Jotunn with the vision, watch the crowd awake.
