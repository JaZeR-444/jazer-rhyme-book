...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: taxpayers mode, taxpayers codes, taxpayers road

## 3 bar-ready examples:
1. Taxpayers in the flow, make the speakers quake.
2. Say Taxpayers with the vision, watch the crowd awake.
3. Taxpayers in my cadence, heavy like a drumline.
