...
END: owy, owyd, owys / SLANT: ow, owye, owyy / MULTI: nowy mode, nowy codes, nowy road

## 3 bar-ready examples:
1. Nowy on the mic, watch the room align.
2. Nowy in the flow, make the speakers quake.
3. Say Nowy with the vision, watch the crowd awake.
