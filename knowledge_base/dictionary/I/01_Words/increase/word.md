...
END: ase, ased, ases / SLANT: as, asee, asey / MULTI: increase mode, increase codes, increase road

## 3 bar-ready examples:
1. Increase on the mic, watch the room align.
2. Increase in the flow, make the speakers quake.
3. Say Increase with the vision, watch the crowd awake.
