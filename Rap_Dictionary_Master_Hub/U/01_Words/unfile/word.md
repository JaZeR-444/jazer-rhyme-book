...
END: ile, iled, iles / SLANT: il, ilee, iley / MULTI: unfile mode, unfile codes, unfile road

## 3 bar-ready examples:
1. Unfile in my cadence, heavy like a drumline.
2. I move with Unfile, every step a headline.
3. Unfile on the mic, watch the room align.
