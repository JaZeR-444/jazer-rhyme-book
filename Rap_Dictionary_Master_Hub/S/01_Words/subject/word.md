...
END: ect, ectd, ects / SLANT: ec, ecte, ecty / MULTI: subject mode, subject codes, subject road

## 3 bar-ready examples:
1. Subject on the mic, watch the room align.
2. Subject in the flow, make the speakers quake.
3. Say Subject with the vision, watch the crowd awake.
