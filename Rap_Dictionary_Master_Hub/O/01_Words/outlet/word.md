...
END: let, letd, lets / SLANT: le, lete, lety / MULTI: outlet mode, outlet codes, outlet road

## 3 bar-ready examples:
1. Outlet in my cadence, heavy like a drumline.
2. I move with Outlet, every step a headline.
3. Outlet on the mic, watch the room align.
