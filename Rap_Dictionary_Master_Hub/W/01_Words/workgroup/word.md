...
END: oup, oupd, oups / SLANT: ou, oupe, oupy / MULTI: workgroup mode, workgroup codes, workgroup road

## 3 bar-ready examples:
1. Workgroup in the flow, make the speakers quake.
2. Say Workgroup with the vision, watch the crowd awake.
3. Workgroup in my cadence, heavy like a drumline.
