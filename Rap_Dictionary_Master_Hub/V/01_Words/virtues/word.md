...
END: ues, uesd, uess / SLANT: ue, uese, uesy / MULTI: virtues mode, virtues codes, virtues road

## 3 bar-ready examples:
1. Virtues on the mic, watch the room align.
2. Virtues in the flow, make the speakers quake.
3. Say Virtues with the vision, watch the crowd awake.
