...
END: oid, oidd, oids / SLANT: oi, oide, oidy / MULTI: lunoid mode, lunoid codes, lunoid road

## 3 bar-ready examples:
1. Lunoid in the flow, make the speakers quake.
2. Say Lunoid with the vision, watch the crowd awake.
3. Lunoid in my cadence, heavy like a drumline.
