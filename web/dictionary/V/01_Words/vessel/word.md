...
END: sel, seld, sels / SLANT: se, sele, sely / MULTI: vessel mode, vessel codes, vessel road

## 3 bar-ready examples:
1. Vessel in the flow, make the speakers quake.
2. Say Vessel with the vision, watch the crowd awake.
3. Vessel in my cadence, heavy like a drumline.
