...
END: ble, bled, bles / SLANT: bl, blee, bley / MULTI: removable mode, removable codes, removable road

## 3 bar-ready examples:
1. Removable in my cadence, heavy like a drumline.
2. I move with Removable, every step a headline.
3. Removable on the mic, watch the room align.
