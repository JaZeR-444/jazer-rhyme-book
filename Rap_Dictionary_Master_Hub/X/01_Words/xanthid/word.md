...
END: hid, hidd, hids / SLANT: hi, hide, hidy / MULTI: xanthid mode, xanthid codes, xanthid road

## 3 bar-ready examples:
1. Say Xanthid with the vision, watch the crowd awake.
2. Xanthid in my cadence, heavy like a drumline.
3. I move with Xanthid, every step a headline.
