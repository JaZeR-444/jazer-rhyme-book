...
END: des, desd, dess / SLANT: de, dese, desy / MULTI: grades mode, grades codes, grades road

## 3 bar-ready examples:
1. I move with Grades, every step a headline.
2. Grades on the mic, watch the room align.
3. Grades in the flow, make the speakers quake.
