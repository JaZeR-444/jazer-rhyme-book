...
END: eas, easd, eass / SLANT: ea, ease, easy / MULTI: whereas mode, whereas codes, whereas road

## 3 bar-ready examples:
1. I move with Whereas, every step a headline.
2. Whereas on the mic, watch the room align.
3. Whereas in the flow, make the speakers quake.
