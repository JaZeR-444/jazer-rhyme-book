...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: guessing mode, guessing codes, guessing road

## 3 bar-ready examples:
1. Guessing on the mic, watch the room align.
2. Guessing in the flow, make the speakers quake.
3. Say Guessing with the vision, watch the crowd awake.
