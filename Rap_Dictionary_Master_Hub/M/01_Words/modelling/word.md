...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: modelling mode, modelling codes, modelling road

## 3 bar-ready examples:
1. Say Modelling with the vision, watch the crowd awake.
2. Modelling in my cadence, heavy like a drumline.
3. I move with Modelling, every step a headline.
