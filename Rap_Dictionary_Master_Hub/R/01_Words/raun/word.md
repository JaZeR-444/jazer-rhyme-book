...
END: aun, aund, auns / SLANT: au, aune, auny / MULTI: raun mode, raun codes, raun road

## 3 bar-ready examples:
1. Raun in the flow, make the speakers quake.
2. Say Raun with the vision, watch the crowd awake.
3. Raun in my cadence, heavy like a drumline.
