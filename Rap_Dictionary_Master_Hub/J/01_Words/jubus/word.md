...
END: bus, busd, buss / SLANT: bu, buse, busy / MULTI: jubus mode, jubus codes, jubus road

## 3 bar-ready examples:
1. Say Jubus with the vision, watch the crowd awake.
2. Jubus in my cadence, heavy like a drumline.
3. I move with Jubus, every step a headline.
