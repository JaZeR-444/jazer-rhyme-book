...
END: uts, utsd, utss / SLANT: ut, utse, utsy / MULTI: inputs mode, inputs codes, inputs road

## 3 bar-ready examples:
1. Inputs on the mic, watch the room align.
2. Inputs in the flow, make the speakers quake.
3. Say Inputs with the vision, watch the crowd awake.
