...
END: pet, petd, pets / SLANT: pe, pete, pety / MULTI: vardapet mode, vardapet codes, vardapet road

## 3 bar-ready examples:
1. I move with Vardapet, every step a headline.
2. Vardapet on the mic, watch the room align.
3. Vardapet in the flow, make the speakers quake.
