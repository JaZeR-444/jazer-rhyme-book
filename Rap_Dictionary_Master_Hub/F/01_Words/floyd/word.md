...
END: oyd, oydd, oyds / SLANT: oy, oyde, oydy / MULTI: floyd mode, floyd codes, floyd road

## 3 bar-ready examples:
1. I move with Floyd, every step a headline.
2. Floyd on the mic, watch the room align.
3. Floyd in the flow, make the speakers quake.
