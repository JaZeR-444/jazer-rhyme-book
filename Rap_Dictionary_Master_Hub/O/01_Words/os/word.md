...
END: os, osd, oss / SLANT: o, ose, osy / MULTI: os mode, os codes, os road

## 3 bar-ready examples:
1. Os on the mic, watch the room align.
2. Os in the flow, make the speakers quake.
3. Say Os with the vision, watch the crowd awake.
