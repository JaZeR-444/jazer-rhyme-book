...
END: rta, rtad, rtas / SLANT: rt, rtae, rtay / MULTI: yurta mode, yurta codes, yurta road

## 3 bar-ready examples:
1. Yurta on the mic, watch the room align.
2. Yurta in the flow, make the speakers quake.
3. Say Yurta with the vision, watch the crowd awake.
