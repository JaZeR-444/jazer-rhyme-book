...
END: day, dayd, days / SLANT: da, daye, dayy / MULTI: tuesday mode, tuesday codes, tuesday road

## 3 bar-ready examples:
1. I move with Tuesday, every step a headline.
2. Tuesday on the mic, watch the room align.
3. Tuesday in the flow, make the speakers quake.
