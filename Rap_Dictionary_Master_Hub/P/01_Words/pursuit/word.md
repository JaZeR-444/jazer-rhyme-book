...
END: uit, uitd, uits / SLANT: ui, uite, uity / MULTI: pursuit mode, pursuit codes, pursuit road

## 3 bar-ready examples:
1. Pursuit on the mic, watch the room align.
2. Pursuit in the flow, make the speakers quake.
3. Say Pursuit with the vision, watch the crowd awake.
