...
END: hia, hiad, hias / SLANT: hi, hiae, hiay / MULTI: sophia mode, sophia codes, sophia road

## 3 bar-ready examples:
1. I move with Sophia, every step a headline.
2. Sophia on the mic, watch the room align.
3. Sophia in the flow, make the speakers quake.
