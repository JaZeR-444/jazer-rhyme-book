...
END: boy, boyd, boys / SLANT: bo, boye, boyy / MULTI: gameboy mode, gameboy codes, gameboy road

## 3 bar-ready examples:
1. Gameboy in the flow, make the speakers quake.
2. Say Gameboy with the vision, watch the crowd awake.
3. Gameboy in my cadence, heavy like a drumline.
