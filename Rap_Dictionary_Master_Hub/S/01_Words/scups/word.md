...
END: ups, upsd, upss / SLANT: up, upse, upsy / MULTI: scups mode, scups codes, scups road

## 3 bar-ready examples:
1. Scups in the flow, make the speakers quake.
2. Say Scups with the vision, watch the crowd awake.
3. Scups in my cadence, heavy like a drumline.
