...
END: uem, uemd, uems / SLANT: ue, ueme, uemy / MULTI: yquem mode, yquem codes, yquem road

## 3 bar-ready examples:
1. Yquem in the flow, make the speakers quake.
2. Say Yquem with the vision, watch the crowd awake.
3. Yquem in my cadence, heavy like a drumline.
