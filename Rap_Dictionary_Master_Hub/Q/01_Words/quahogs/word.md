...
END: ogs, ogsd, ogss / SLANT: og, ogse, ogsy / MULTI: quahogs mode, quahogs codes, quahogs road

## 3 bar-ready examples:
1. Quahogs on the mic, watch the room align.
2. Quahogs in the flow, make the speakers quake.
3. Say Quahogs with the vision, watch the crowd awake.
