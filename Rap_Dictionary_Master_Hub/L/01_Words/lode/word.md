...
END: ode, oded, odes / SLANT: od, odee, odey / MULTI: lode mode, lode codes, lode road

## 3 bar-ready examples:
1. Lode in the flow, make the speakers quake.
2. Say Lode with the vision, watch the crowd awake.
3. Lode in my cadence, heavy like a drumline.
