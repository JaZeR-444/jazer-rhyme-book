...
END: est, estd, ests / SLANT: es, este, esty / MULTI: test mode, test codes, test road

## 3 bar-ready examples:
1. Test in the flow, make the speakers quake.
2. Say Test with the vision, watch the crowd awake.
3. Test in my cadence, heavy like a drumline.
