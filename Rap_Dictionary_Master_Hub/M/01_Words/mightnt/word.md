...
END: tnt, tntd, tnts / SLANT: tn, tnte, tnty / MULTI: mightnt mode, mightnt codes, mightnt road

## 3 bar-ready examples:
1. I move with Mightnt, every step a headline.
2. Mightnt on the mic, watch the room align.
3. Mightnt in the flow, make the speakers quake.
