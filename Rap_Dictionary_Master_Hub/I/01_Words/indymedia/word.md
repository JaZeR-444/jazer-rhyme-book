...
END: dia, diad, dias / SLANT: di, diae, diay / MULTI: indymedia mode, indymedia codes, indymedia road

## 3 bar-ready examples:
1. Indymedia on the mic, watch the room align.
2. Indymedia in the flow, make the speakers quake.
3. Say Indymedia with the vision, watch the crowd awake.
