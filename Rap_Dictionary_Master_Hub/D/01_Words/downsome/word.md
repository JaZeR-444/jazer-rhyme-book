...
END: ome, omed, omes / SLANT: om, omee, omey / MULTI: downsome mode, downsome codes, downsome road

## 3 bar-ready examples:
1. Downsome on the mic, watch the room align.
2. Downsome in the flow, make the speakers quake.
3. Say Downsome with the vision, watch the crowd awake.
