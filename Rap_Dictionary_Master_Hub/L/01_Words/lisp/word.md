...
END: isp, ispd, isps / SLANT: is, ispe, ispy / MULTI: lisp mode, lisp codes, lisp road

## 3 bar-ready examples:
1. Lisp in my cadence, heavy like a drumline.
2. I move with Lisp, every step a headline.
3. Lisp on the mic, watch the room align.
