...
END: erg, ergd, ergs / SLANT: er, erge, ergy / MULTI: gutenberg mode, gutenberg codes, gutenberg road

## 3 bar-ready examples:
1. Gutenberg on the mic, watch the room align.
2. Gutenberg in the flow, make the speakers quake.
3. Say Gutenberg with the vision, watch the crowd awake.
