...
END: int, intd, ints / SLANT: in, inte, inty / MULTI: hint mode, hint codes, hint road

## 3 bar-ready examples:
1. I move with Hint, every step a headline.
2. Hint on the mic, watch the room align.
3. Hint in the flow, make the speakers quake.
