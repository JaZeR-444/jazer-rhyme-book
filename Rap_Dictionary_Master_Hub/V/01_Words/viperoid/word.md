...
END: oid, oidd, oids / SLANT: oi, oide, oidy / MULTI: viperoid mode, viperoid codes, viperoid road

## 3 bar-ready examples:
1. Viperoid in my cadence, heavy like a drumline.
2. I move with Viperoid, every step a headline.
3. Viperoid on the mic, watch the room align.
