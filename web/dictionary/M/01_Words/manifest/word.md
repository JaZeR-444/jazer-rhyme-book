...
END: est, estd, ests / SLANT: es, este, esty / MULTI: manifest mode, manifest codes, manifest road

## 3 bar-ready examples:
1. I move with Manifest, every step a headline.
2. Manifest on the mic, watch the room align.
3. Manifest in the flow, make the speakers quake.
