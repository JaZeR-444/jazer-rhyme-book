...
END: doz, dozd, dozs / SLANT: do, doze, dozy / MULTI: kudoz mode, kudoz codes, kudoz road

## 3 bar-ready examples:
1. Kudoz on the mic, watch the room align.
2. Kudoz in the flow, make the speakers quake.
3. Say Kudoz with the vision, watch the crowd awake.
