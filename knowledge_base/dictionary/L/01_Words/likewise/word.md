...
END: ise, ised, ises / SLANT: is, isee, isey / MULTI: likewise mode, likewise codes, likewise road

## 3 bar-ready examples:
1. Likewise on the mic, watch the room align.
2. Likewise in the flow, make the speakers quake.
3. Say Likewise with the vision, watch the crowd awake.
