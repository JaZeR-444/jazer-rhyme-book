...
END: oks, oksd, okss / SLANT: ok, okse, oksy / MULTI: looks mode, looks codes, looks road

## 3 bar-ready examples:
1. I move with Looks, every step a headline.
2. Looks on the mic, watch the room align.
3. Looks in the flow, make the speakers quake.
