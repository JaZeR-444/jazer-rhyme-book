...
END: ium, iumd, iums / SLANT: iu, iume, iumy / MULTI: vitium mode, vitium codes, vitium road

## 3 bar-ready examples:
1. Vitium on the mic, watch the room align.
2. Vitium in the flow, make the speakers quake.
3. Say Vitium with the vision, watch the crowd awake.
