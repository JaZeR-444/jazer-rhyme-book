...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: pounding mode, pounding codes, pounding road

## 3 bar-ready examples:
1. Say Pounding with the vision, watch the crowd awake.
2. Pounding in my cadence, heavy like a drumline.
3. I move with Pounding, every step a headline.
