...
END: ils, ilsd, ilss / SLANT: il, ilse, ilsy / MULTI: utils mode, utils codes, utils road

## 3 bar-ready examples:
1. Utils in the flow, make the speakers quake.
2. Say Utils with the vision, watch the crowd awake.
3. Utils in my cadence, heavy like a drumline.
