...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: outgoing mode, outgoing codes, outgoing road

## 3 bar-ready examples:
1. Outgoing in the flow, make the speakers quake.
2. Say Outgoing with the vision, watch the crowd awake.
3. Outgoing in my cadence, heavy like a drumline.
