...
END: ist, istd, ists / SLANT: is, iste, isty / MULTI: nuagist mode, nuagist codes, nuagist road

## 3 bar-ready examples:
1. I move with Nuagist, every step a headline.
2. Nuagist on the mic, watch the room align.
3. Nuagist in the flow, make the speakers quake.
