...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: killing mode, killing codes, killing road

## 3 bar-ready examples:
1. Killing in the flow, make the speakers quake.
2. Say Killing with the vision, watch the crowd awake.
3. Killing in my cadence, heavy like a drumline.
