...
END: viz, vizd, vizs / SLANT: vi, vize, vizy / MULTI: viz mode, viz codes, viz road

## 3 bar-ready examples:
1. Viz on the mic, watch the room align.
2. Viz in the flow, make the speakers quake.
3. Say Viz with the vision, watch the crowd awake.
