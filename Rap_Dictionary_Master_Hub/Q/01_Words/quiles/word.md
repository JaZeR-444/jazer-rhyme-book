...
END: les, lesd, less / SLANT: le, lese, lesy / MULTI: quiles mode, quiles codes, quiles road

## 3 bar-ready examples:
1. I move with Quiles, every step a headline.
2. Quiles on the mic, watch the room align.
3. Quiles in the flow, make the speakers quake.
