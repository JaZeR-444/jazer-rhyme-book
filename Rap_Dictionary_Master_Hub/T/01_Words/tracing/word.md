...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: tracing mode, tracing codes, tracing road

## 3 bar-ready examples:
1. Tracing in my cadence, heavy like a drumline.
2. I move with Tracing, every step a headline.
3. Tracing on the mic, watch the room align.
