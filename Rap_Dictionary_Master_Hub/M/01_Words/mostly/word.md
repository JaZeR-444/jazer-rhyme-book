...
END: tly, tlyd, tlys / SLANT: tl, tlye, tlyy / MULTI: mostly mode, mostly codes, mostly road

## 3 bar-ready examples:
1. Mostly on the mic, watch the room align.
2. Mostly in the flow, make the speakers quake.
3. Say Mostly with the vision, watch the crowd awake.
