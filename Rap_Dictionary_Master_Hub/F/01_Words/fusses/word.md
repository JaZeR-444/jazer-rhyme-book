...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: fusses mode, fusses codes, fusses road

## 3 bar-ready examples:
1. I move with Fusses, every step a headline.
2. Fusses on the mic, watch the room align.
3. Fusses in the flow, make the speakers quake.
