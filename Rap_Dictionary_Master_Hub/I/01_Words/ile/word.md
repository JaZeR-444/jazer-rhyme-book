...
END: ile, iled, iles / SLANT: il, ilee, iley / MULTI: ile mode, ile codes, ile road

## 3 bar-ready examples:
1. I move with Ile, every step a headline.
2. Ile on the mic, watch the room align.
3. Ile in the flow, make the speakers quake.
