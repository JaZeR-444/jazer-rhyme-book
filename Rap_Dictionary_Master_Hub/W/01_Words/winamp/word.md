...
END: amp, ampd, amps / SLANT: am, ampe, ampy / MULTI: winamp mode, winamp codes, winamp road

## 3 bar-ready examples:
1. Winamp on the mic, watch the room align.
2. Winamp in the flow, make the speakers quake.
3. Say Winamp with the vision, watch the crowd awake.
