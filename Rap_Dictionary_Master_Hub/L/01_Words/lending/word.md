...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: lending mode, lending codes, lending road

## 3 bar-ready examples:
1. Lending in the flow, make the speakers quake.
2. Say Lending with the vision, watch the crowd awake.
3. Lending in my cadence, heavy like a drumline.
