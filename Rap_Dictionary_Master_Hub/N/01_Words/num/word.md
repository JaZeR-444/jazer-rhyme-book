...
END: num, numd, nums / SLANT: nu, nume, numy / MULTI: num mode, num codes, num road

## 3 bar-ready examples:
1. Num in my cadence, heavy like a drumline.
2. I move with Num, every step a headline.
3. Num on the mic, watch the room align.
