...
END: uts, utsd, utss / SLANT: ut, utse, utsy / MULTI: payouts mode, payouts codes, payouts road

## 3 bar-ready examples:
1. Payouts on the mic, watch the room align.
2. Payouts in the flow, make the speakers quake.
3. Say Payouts with the vision, watch the crowd awake.
