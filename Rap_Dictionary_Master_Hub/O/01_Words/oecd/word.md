...
END: ecd, ecdd, ecds / SLANT: ec, ecde, ecdy / MULTI: oecd mode, oecd codes, oecd road

## 3 bar-ready examples:
1. Oecd on the mic, watch the room align.
2. Oecd in the flow, make the speakers quake.
3. Say Oecd with the vision, watch the crowd awake.
