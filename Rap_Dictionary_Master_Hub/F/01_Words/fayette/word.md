...
END: tte, tted, ttes / SLANT: tt, ttee, ttey / MULTI: fayette mode, fayette codes, fayette road

## 3 bar-ready examples:
1. Fayette on the mic, watch the room align.
2. Fayette in the flow, make the speakers quake.
3. Say Fayette with the vision, watch the crowd awake.
