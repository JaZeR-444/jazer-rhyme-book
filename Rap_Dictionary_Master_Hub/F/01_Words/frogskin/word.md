...
END: kin, kind, kins / SLANT: ki, kine, kiny / MULTI: frogskin mode, frogskin codes, frogskin road

## 3 bar-ready examples:
1. Frogskin in my cadence, heavy like a drumline.
2. I move with Frogskin, every step a headline.
3. Frogskin on the mic, watch the room align.
