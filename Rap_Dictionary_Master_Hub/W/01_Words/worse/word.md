...
END: rse, rsed, rses / SLANT: rs, rsee, rsey / MULTI: worse mode, worse codes, worse road

## 3 bar-ready examples:
1. Worse in my cadence, heavy like a drumline.
2. I move with Worse, every step a headline.
3. Worse on the mic, watch the room align.
