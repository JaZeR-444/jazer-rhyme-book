...
END: lle, lled, lles / SLANT: ll, llee, lley / MULTI: ville mode, ville codes, ville road

## 3 bar-ready examples:
1. I move with Ville, every step a headline.
2. Ville on the mic, watch the room align.
3. Ville in the flow, make the speakers quake.
