...
END: bag, bagd, bags / SLANT: ba, bage, bagy / MULTI: sackbag mode, sackbag codes, sackbag road

## 3 bar-ready examples:
1. Sackbag in the flow, make the speakers quake.
2. Say Sackbag with the vision, watch the crowd awake.
3. Sackbag in my cadence, heavy like a drumline.
