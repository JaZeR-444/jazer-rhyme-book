...
END: ays, aysd, ayss / SLANT: ay, ayse, aysy / MULTI: fridays mode, fridays codes, fridays road

## 3 bar-ready examples:
1. Fridays in the flow, make the speakers quake.
2. Say Fridays with the vision, watch the crowd awake.
3. Fridays in my cadence, heavy like a drumline.
