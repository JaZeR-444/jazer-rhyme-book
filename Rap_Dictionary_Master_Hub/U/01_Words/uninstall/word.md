...
END: all, alld, alls / SLANT: al, alle, ally / MULTI: uninstall mode, uninstall codes, uninstall road

## 3 bar-ready examples:
1. Uninstall in the flow, make the speakers quake.
2. Say Uninstall with the vision, watch the crowd awake.
3. Uninstall in my cadence, heavy like a drumline.
