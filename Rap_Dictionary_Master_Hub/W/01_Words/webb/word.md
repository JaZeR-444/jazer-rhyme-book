...
END: ebb, ebbd, ebbs / SLANT: eb, ebbe, ebby / MULTI: webb mode, webb codes, webb road

## 3 bar-ready examples:
1. I move with Webb, every step a headline.
2. Webb on the mic, watch the room align.
3. Webb in the flow, make the speakers quake.
