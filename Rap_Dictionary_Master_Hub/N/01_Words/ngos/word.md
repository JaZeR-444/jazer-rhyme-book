...
END: gos, gosd, goss / SLANT: go, gose, gosy / MULTI: ngos mode, ngos codes, ngos road

## 3 bar-ready examples:
1. Ngos on the mic, watch the room align.
2. Ngos in the flow, make the speakers quake.
3. Say Ngos with the vision, watch the crowd awake.
