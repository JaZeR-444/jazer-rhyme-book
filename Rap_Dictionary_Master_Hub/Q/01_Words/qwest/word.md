...
END: est, estd, ests / SLANT: es, este, esty / MULTI: qwest mode, qwest codes, qwest road

## 3 bar-ready examples:
1. I move with Qwest, every step a headline.
2. Qwest on the mic, watch the room align.
3. Qwest in the flow, make the speakers quake.
