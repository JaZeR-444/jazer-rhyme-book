...
END: ahs, ahsd, ahss / SLANT: ah, ahse, ahsy / MULTI: kiblahs mode, kiblahs codes, kiblahs road

## 3 bar-ready examples:
1. Kiblahs in the flow, make the speakers quake.
2. Say Kiblahs with the vision, watch the crowd awake.
3. Kiblahs in my cadence, heavy like a drumline.
