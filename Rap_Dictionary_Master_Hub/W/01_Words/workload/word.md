...
END: oad, oadd, oads / SLANT: oa, oade, oady / MULTI: workload mode, workload codes, workload road

## 3 bar-ready examples:
1. Workload in the flow, make the speakers quake.
2. Say Workload with the vision, watch the crowd awake.
3. Workload in my cadence, heavy like a drumline.
