...
END: lux, luxd, luxs / SLANT: lu, luxe, luxy / MULTI: influx mode, influx codes, influx road

## 3 bar-ready examples:
1. Influx in the flow, make the speakers quake.
2. Say Influx with the vision, watch the crowd awake.
3. Influx in my cadence, heavy like a drumline.
