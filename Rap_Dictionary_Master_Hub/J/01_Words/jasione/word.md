...
END: one, oned, ones / SLANT: on, onee, oney / MULTI: jasione mode, jasione codes, jasione road

## 3 bar-ready examples:
1. Jasione in the flow, make the speakers quake.
2. Say Jasione with the vision, watch the crowd awake.
3. Jasione in my cadence, heavy like a drumline.
