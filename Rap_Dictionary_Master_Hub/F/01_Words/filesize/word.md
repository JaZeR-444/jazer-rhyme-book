...
END: ize, ized, izes / SLANT: iz, izee, izey / MULTI: filesize mode, filesize codes, filesize road

## 3 bar-ready examples:
1. Filesize in my cadence, heavy like a drumline.
2. I move with Filesize, every step a headline.
3. Filesize on the mic, watch the room align.
