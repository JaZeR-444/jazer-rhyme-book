...
END: low, lowd, lows / SLANT: lo, lowe, lowy / MULTI: quickglow mode, quickglow codes, quickglow road

## 3 bar-ready examples:
1. Quickglow in the flow, make the speakers quake.
2. Say Quickglow with the vision, watch the crowd awake.
3. Quickglow in my cadence, heavy like a drumline.
