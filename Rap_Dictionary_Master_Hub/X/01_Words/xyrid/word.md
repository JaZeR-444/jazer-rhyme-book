...
END: rid, ridd, rids / SLANT: ri, ride, ridy / MULTI: xyrid mode, xyrid codes, xyrid road

## 3 bar-ready examples:
1. I move with Xyrid, every step a headline.
2. Xyrid on the mic, watch the room align.
3. Xyrid in the flow, make the speakers quake.
