...
END: way, wayd, ways / SLANT: wa, waye, wayy / MULTI: underway mode, underway codes, underway road

## 3 bar-ready examples:
1. I move with Underway, every step a headline.
2. Underway on the mic, watch the room align.
3. Underway in the flow, make the speakers quake.
