...
END: ssr, ssrd, ssrs / SLANT: ss, ssre, ssry / MULTI: ussr mode, ussr codes, ussr road

## 3 bar-ready examples:
1. I move with Ussr, every step a headline.
2. Ussr on the mic, watch the room align.
3. Ussr in the flow, make the speakers quake.
