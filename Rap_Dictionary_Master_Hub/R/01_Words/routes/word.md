...
END: tes, tesd, tess / SLANT: te, tese, tesy / MULTI: routes mode, routes codes, routes road

## 3 bar-ready examples:
1. Routes in the flow, make the speakers quake.
2. Say Routes with the vision, watch the crowd awake.
3. Routes in my cadence, heavy like a drumline.
