...
END: ary, aryd, arys / SLANT: ar, arye, aryy / MULTI: ordinary mode, ordinary codes, ordinary road

## 3 bar-ready examples:
1. Say Ordinary with the vision, watch the crowd awake.
2. Ordinary in my cadence, heavy like a drumline.
3. I move with Ordinary, every step a headline.
