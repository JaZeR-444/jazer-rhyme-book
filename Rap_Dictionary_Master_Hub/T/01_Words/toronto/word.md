...
END: nto, ntod, ntos / SLANT: nt, ntoe, ntoy / MULTI: toronto mode, toronto codes, toronto road

## 3 bar-ready examples:
1. I move with Toronto, every step a headline.
2. Toronto on the mic, watch the room align.
3. Toronto in the flow, make the speakers quake.
