...
END: nit, nitd, nits / SLANT: ni, nite, nity / MULTI: subunit mode, subunit codes, subunit road

## 3 bar-ready examples:
1. Subunit in the flow, make the speakers quake.
2. Say Subunit with the vision, watch the crowd awake.
3. Subunit in my cadence, heavy like a drumline.
