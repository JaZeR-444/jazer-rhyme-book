...
END: rge, rged, rges / SLANT: rg, rgee, rgey / MULTI: xenonforge mode, xenonforge codes, xenonforge road

## 3 bar-ready examples:
1. Xenonforge in my cadence, heavy like a drumline.
2. I move with Xenonforge, every step a headline.
3. Xenonforge on the mic, watch the room align.
