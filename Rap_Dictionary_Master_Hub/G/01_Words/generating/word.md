...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: generating mode, generating codes, generating road

## 3 bar-ready examples:
1. Say Generating with the vision, watch the crowd awake.
2. Generating in my cadence, heavy like a drumline.
3. I move with Generating, every step a headline.
