...
END: out, outd, outs / SLANT: ou, oute, outy / MULTI: fallout mode, fallout codes, fallout road

## 3 bar-ready examples:
1. Say Fallout with the vision, watch the crowd awake.
2. Fallout in my cadence, heavy like a drumline.
3. I move with Fallout, every step a headline.
