...
END: els, elsd, elss / SLANT: el, else, elsy / MULTI: vowels mode, vowels codes, vowels road

## 3 bar-ready examples:
1. I move with Vowels, every step a headline.
2. Vowels on the mic, watch the room align.
3. Vowels in the flow, make the speakers quake.
