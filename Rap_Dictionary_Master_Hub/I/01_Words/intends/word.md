...
END: nds, ndsd, ndss / SLANT: nd, ndse, ndsy / MULTI: intends mode, intends codes, intends road

## 3 bar-ready examples:
1. Intends on the mic, watch the room align.
2. Intends in the flow, make the speakers quake.
3. Say Intends with the vision, watch the crowd awake.
