...
END: kay, kayd, kays / SLANT: ka, kaye, kayy / MULTI: mckay mode, mckay codes, mckay road

## 3 bar-ready examples:
1. I move with Mckay, every step a headline.
2. Mckay on the mic, watch the room align.
3. Mckay in the flow, make the speakers quake.
