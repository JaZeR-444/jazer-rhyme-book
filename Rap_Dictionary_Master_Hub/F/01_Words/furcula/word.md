...
END: ula, ulad, ulas / SLANT: ul, ulae, ulay / MULTI: furcula mode, furcula codes, furcula road

## 3 bar-ready examples:
1. Furcula in the flow, make the speakers quake.
2. Say Furcula with the vision, watch the crowd awake.
3. Furcula in my cadence, heavy like a drumline.
