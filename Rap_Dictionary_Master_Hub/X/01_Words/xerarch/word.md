...
END: rch, rchd, rchs / SLANT: rc, rche, rchy / MULTI: xerarch mode, xerarch codes, xerarch road

## 3 bar-ready examples:
1. Xerarch in my cadence, heavy like a drumline.
2. I move with Xerarch, every step a headline.
3. Xerarch on the mic, watch the room align.
