...
END: aba, abad, abas / SLANT: ab, abae, abay / MULTI: xanthindaba mode, xanthindaba codes, xanthindaba road

## 3 bar-ready examples:
1. Xanthindaba in my cadence, heavy like a drumline.
2. I move with Xanthindaba, every step a headline.
3. Xanthindaba on the mic, watch the room align.
