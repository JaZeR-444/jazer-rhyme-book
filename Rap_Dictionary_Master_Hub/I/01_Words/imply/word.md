...
END: ply, plyd, plys / SLANT: pl, plye, plyy / MULTI: imply mode, imply codes, imply road

## 3 bar-ready examples:
1. Imply in the flow, make the speakers quake.
2. Say Imply with the vision, watch the crowd awake.
3. Imply in my cadence, heavy like a drumline.
