...
END: des, desd, dess / SLANT: de, dese, desy / MULTI: yuletides mode, yuletides codes, yuletides road

## 3 bar-ready examples:
1. I move with Yuletides, every step a headline.
2. Yuletides on the mic, watch the room align.
3. Yuletides in the flow, make the speakers quake.
