...
END: pus, pusd, puss / SLANT: pu, puse, pusy / MULTI: xenopus mode, xenopus codes, xenopus road

## 3 bar-ready examples:
1. I move with Xenopus, every step a headline.
2. Xenopus on the mic, watch the room align.
3. Xenopus in the flow, make the speakers quake.
