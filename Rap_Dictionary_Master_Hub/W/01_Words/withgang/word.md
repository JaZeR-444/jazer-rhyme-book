...
END: ang, angd, angs / SLANT: an, ange, angy / MULTI: withgang mode, withgang codes, withgang road

## 3 bar-ready examples:
1. Withgang on the mic, watch the room align.
2. Withgang in the flow, make the speakers quake.
3. Say Withgang with the vision, watch the crowd awake.
