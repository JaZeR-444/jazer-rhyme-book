...
END: dup, dupd, dups / SLANT: du, dupe, dupy / MULTI: roundup mode, roundup codes, roundup road

## 3 bar-ready examples:
1. Roundup on the mic, watch the room align.
2. Roundup in the flow, make the speakers quake.
3. Say Roundup with the vision, watch the crowd awake.
