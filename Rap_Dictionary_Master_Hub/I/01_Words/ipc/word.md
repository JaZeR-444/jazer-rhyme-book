...
END: ipc, ipcd, ipcs / SLANT: ip, ipce, ipcy / MULTI: ipc mode, ipc codes, ipc road

## 3 bar-ready examples:
1. Ipc on the mic, watch the room align.
2. Ipc in the flow, make the speakers quake.
3. Say Ipc with the vision, watch the crowd awake.
