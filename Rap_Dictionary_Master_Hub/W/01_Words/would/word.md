...
END: uld, uldd, ulds / SLANT: ul, ulde, uldy / MULTI: would mode, would codes, would road

## 3 bar-ready examples:
1. Would in my cadence, heavy like a drumline.
2. I move with Would, every step a headline.
3. Would on the mic, watch the room align.
