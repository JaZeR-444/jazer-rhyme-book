...
END: sol, sold, sols / SLANT: so, sole, soly / MULTI: kitysol mode, kitysol codes, kitysol road

## 3 bar-ready examples:
1. Say Kitysol with the vision, watch the crowd awake.
2. Kitysol in my cadence, heavy like a drumline.
3. I move with Kitysol, every step a headline.
