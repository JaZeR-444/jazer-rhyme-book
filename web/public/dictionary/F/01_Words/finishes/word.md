...
END: hes, hesd, hess / SLANT: he, hese, hesy / MULTI: finishes mode, finishes codes, finishes road

## 3 bar-ready examples:
1. Finishes in the flow, make the speakers quake.
2. Say Finishes with the vision, watch the crowd awake.
3. Finishes in my cadence, heavy like a drumline.
