...
END: est, estd, ests / SLANT: es, este, esty / MULTI: longest mode, longest codes, longest road

## 3 bar-ready examples:
1. Longest in my cadence, heavy like a drumline.
2. I move with Longest, every step a headline.
3. Longest on the mic, watch the room align.
