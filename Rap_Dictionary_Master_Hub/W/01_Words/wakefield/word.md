...
END: eld, eldd, elds / SLANT: el, elde, eldy / MULTI: wakefield mode, wakefield codes, wakefield road

## 3 bar-ready examples:
1. Wakefield in the flow, make the speakers quake.
2. Say Wakefield with the vision, watch the crowd awake.
3. Wakefield in my cadence, heavy like a drumline.
