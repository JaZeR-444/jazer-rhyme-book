...
END: ite, ited, ites / SLANT: it, itee, itey / MULTI: xanthite mode, xanthite codes, xanthite road

## 3 bar-ready examples:
1. Say Xanthite with the vision, watch the crowd awake.
2. Xanthite in my cadence, heavy like a drumline.
3. I move with Xanthite, every step a headline.
