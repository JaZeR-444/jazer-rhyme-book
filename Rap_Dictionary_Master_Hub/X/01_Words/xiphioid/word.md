...
END: oid, oidd, oids / SLANT: oi, oide, oidy / MULTI: xiphioid mode, xiphioid codes, xiphioid road

## 3 bar-ready examples:
1. I move with Xiphioid, every step a headline.
2. Xiphioid on the mic, watch the room align.
3. Xiphioid in the flow, make the speakers quake.
