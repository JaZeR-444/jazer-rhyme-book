...
END: kin, kind, kins / SLANT: ki, kine, kiny / MULTI: kin mode, kin codes, kin road

## 3 bar-ready examples:
1. Kin in the flow, make the speakers quake.
2. Say Kin with the vision, watch the crowd awake.
3. Kin in my cadence, heavy like a drumline.
