...
END: gle, gled, gles / SLANT: gl, glee, gley / MULTI: rectangle mode, rectangle codes, rectangle road

## 3 bar-ready examples:
1. Rectangle on the mic, watch the room align.
2. Rectangle in the flow, make the speakers quake.
3. Say Rectangle with the vision, watch the crowd awake.
