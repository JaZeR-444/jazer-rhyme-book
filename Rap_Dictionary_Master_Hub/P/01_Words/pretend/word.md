...
END: end, endd, ends / SLANT: en, ende, endy / MULTI: pretend mode, pretend codes, pretend road

## 3 bar-ready examples:
1. Pretend in the flow, make the speakers quake.
2. Say Pretend with the vision, watch the crowd awake.
3. Pretend in my cadence, heavy like a drumline.
