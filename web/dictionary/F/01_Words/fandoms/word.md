...
END: oms, omsd, omss / SLANT: om, omse, omsy / MULTI: fandoms mode, fandoms codes, fandoms road

## 3 bar-ready examples:
1. I move with Fandoms, every step a headline.
2. Fandoms on the mic, watch the room align.
3. Fandoms in the flow, make the speakers quake.
