...
END: sms, smsd, smss / SLANT: sm, smse, smsy / MULTI: mutisms mode, mutisms codes, mutisms road

## 3 bar-ready examples:
1. Say Mutisms with the vision, watch the crowd awake.
2. Mutisms in my cadence, heavy like a drumline.
3. I move with Mutisms, every step a headline.
