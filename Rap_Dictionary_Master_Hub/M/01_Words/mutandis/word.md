...
END: dis, disd, diss / SLANT: di, dise, disy / MULTI: mutandis mode, mutandis codes, mutandis road

## 3 bar-ready examples:
1. I move with Mutandis, every step a headline.
2. Mutandis on the mic, watch the room align.
3. Mutandis in the flow, make the speakers quake.
