...
END: put, putd, puts / SLANT: pu, pute, puty / MULTI: output mode, output codes, output road

## 3 bar-ready examples:
1. I move with Output, every step a headline.
2. Output on the mic, watch the room align.
3. Output in the flow, make the speakers quake.
