...
END: oss, ossd, osss / SLANT: os, osse, ossy / MULTI: jboss mode, jboss codes, jboss road

## 3 bar-ready examples:
1. Jboss in the flow, make the speakers quake.
2. Say Jboss with the vision, watch the crowd awake.
3. Jboss in my cadence, heavy like a drumline.
