...
END: imi, imid, imis / SLANT: im, imie, imiy / MULTI: primi mode, primi codes, primi road

## 3 bar-ready examples:
1. Say Primi with the vision, watch the crowd awake.
2. Primi in my cadence, heavy like a drumline.
3. I move with Primi, every step a headline.
