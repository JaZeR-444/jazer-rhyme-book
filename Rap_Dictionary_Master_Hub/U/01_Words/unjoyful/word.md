...
END: ful, fuld, fuls / SLANT: fu, fule, fuly / MULTI: unjoyful mode, unjoyful codes, unjoyful road

## 3 bar-ready examples:
1. Unjoyful on the mic, watch the room align.
2. Unjoyful in the flow, make the speakers quake.
3. Say Unjoyful with the vision, watch the crowd awake.
