...
END: lly, llyd, llys / SLANT: ll, llye, llyy / MULTI: virtually mode, virtually codes, virtually road

## 3 bar-ready examples:
1. I move with Virtually, every step a headline.
2. Virtually on the mic, watch the room align.
3. Virtually in the flow, make the speakers quake.
