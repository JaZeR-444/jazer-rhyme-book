...
END: ext, extd, exts / SLANT: ex, exte, exty / MULTI: text mode, text codes, text road

## 3 bar-ready examples:
1. Text on the mic, watch the room align.
2. Text in the flow, make the speakers quake.
3. Say Text with the vision, watch the crowd awake.
