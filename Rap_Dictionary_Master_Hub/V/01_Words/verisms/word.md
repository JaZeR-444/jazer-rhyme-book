...
END: sms, smsd, smss / SLANT: sm, smse, smsy / MULTI: verisms mode, verisms codes, verisms road

## 3 bar-ready examples:
1. Verisms in my cadence, heavy like a drumline.
2. I move with Verisms, every step a headline.
3. Verisms on the mic, watch the room align.
