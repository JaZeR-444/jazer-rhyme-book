...
END: rap, rapd, raps / SLANT: ra, rape, rapy / MULTI: unwrap mode, unwrap codes, unwrap road

## 3 bar-ready examples:
1. I move with Unwrap, every step a headline.
2. Unwrap on the mic, watch the room align.
3. Unwrap in the flow, make the speakers quake.
