...
END: box, boxd, boxs / SLANT: bo, boxe, boxy / MULTI: mailbox mode, mailbox codes, mailbox road

## 3 bar-ready examples:
1. Mailbox on the mic, watch the room align.
2. Mailbox in the flow, make the speakers quake.
3. Say Mailbox with the vision, watch the crowd awake.
