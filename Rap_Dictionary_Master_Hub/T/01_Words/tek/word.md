...
END: tek, tekd, teks / SLANT: te, teke, teky / MULTI: tek mode, tek codes, tek road

## 3 bar-ready examples:
1. Tek on the mic, watch the room align.
2. Tek in the flow, make the speakers quake.
3. Say Tek with the vision, watch the crowd awake.
