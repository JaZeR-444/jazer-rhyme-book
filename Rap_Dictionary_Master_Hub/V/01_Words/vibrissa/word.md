...
END: ssa, ssad, ssas / SLANT: ss, ssae, ssay / MULTI: vibrissa mode, vibrissa codes, vibrissa road

## 3 bar-ready examples:
1. Vibrissa in my cadence, heavy like a drumline.
2. I move with Vibrissa, every step a headline.
3. Vibrissa on the mic, watch the room align.
