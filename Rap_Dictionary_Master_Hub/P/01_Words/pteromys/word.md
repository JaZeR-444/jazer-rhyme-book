...
END: mys, mysd, myss / SLANT: my, myse, mysy / MULTI: pteromys mode, pteromys codes, pteromys road

## 3 bar-ready examples:
1. Pteromys in my cadence, heavy like a drumline.
2. I move with Pteromys, every step a headline.
3. Pteromys on the mic, watch the room align.
