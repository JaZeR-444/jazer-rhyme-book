...
END: gid, gidd, gids / SLANT: gi, gide, gidy / MULTI: xylophagid mode, xylophagid codes, xylophagid road

## 3 bar-ready examples:
1. I move with Xylophagid, every step a headline.
2. Xylophagid on the mic, watch the room align.
3. Xylophagid in the flow, make the speakers quake.
