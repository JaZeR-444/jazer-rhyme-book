...
END: son, sond, sons / SLANT: so, sone, sony / MULTI: ferguson mode, ferguson codes, ferguson road

## 3 bar-ready examples:
1. Ferguson in the flow, make the speakers quake.
2. Say Ferguson with the vision, watch the crowd awake.
3. Ferguson in my cadence, heavy like a drumline.
