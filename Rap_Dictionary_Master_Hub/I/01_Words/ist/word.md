...
END: ist, istd, ists / SLANT: is, iste, isty / MULTI: ist mode, ist codes, ist road

## 3 bar-ready examples:
1. Ist on the mic, watch the room align.
2. Ist in the flow, make the speakers quake.
3. Say Ist with the vision, watch the crowd awake.
