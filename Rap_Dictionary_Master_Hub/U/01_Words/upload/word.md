...
END: oad, oadd, oads / SLANT: oa, oade, oady / MULTI: upload mode, upload codes, upload road

## 3 bar-ready examples:
1. Upload on the mic, watch the room align.
2. Upload in the flow, make the speakers quake.
3. Say Upload with the vision, watch the crowd awake.
