...
END: ort, ortd, orts / SLANT: or, orte, orty / MULTI: transport mode, transport codes, transport road

## 3 bar-ready examples:
1. I move with Transport, every step a headline.
2. Transport on the mic, watch the room align.
3. Transport in the flow, make the speakers quake.
