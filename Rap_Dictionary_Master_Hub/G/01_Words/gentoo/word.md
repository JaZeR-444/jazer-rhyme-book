...
END: too, tood, toos / SLANT: to, tooe, tooy / MULTI: gentoo mode, gentoo codes, gentoo road

## 3 bar-ready examples:
1. Gentoo on the mic, watch the room align.
2. Gentoo in the flow, make the speakers quake.
3. Say Gentoo with the vision, watch the crowd awake.
