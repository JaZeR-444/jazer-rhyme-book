...
END: ird, irdd, irds / SLANT: ir, irde, irdy / MULTI: kowbird mode, kowbird codes, kowbird road

## 3 bar-ready examples:
1. I move with Kowbird, every step a headline.
2. Kowbird on the mic, watch the room align.
3. Kowbird in the flow, make the speakers quake.
