...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: users mode, users codes, users road

## 3 bar-ready examples:
1. Users on the mic, watch the room align.
2. Users in the flow, make the speakers quake.
3. Say Users with the vision, watch the crowd awake.
