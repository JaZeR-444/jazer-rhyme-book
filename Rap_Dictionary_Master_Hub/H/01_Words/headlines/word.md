...
END: nes, nesd, ness / SLANT: ne, nese, nesy / MULTI: headlines mode, headlines codes, headlines road

## 3 bar-ready examples:
1. Headlines on the mic, watch the room align.
2. Headlines in the flow, make the speakers quake.
3. Say Headlines with the vision, watch the crowd awake.
