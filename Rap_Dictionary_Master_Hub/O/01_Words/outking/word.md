...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: outking mode, outking codes, outking road

## 3 bar-ready examples:
1. Outking on the mic, watch the room align.
2. Outking in the flow, make the speakers quake.
3. Say Outking with the vision, watch the crowd awake.
