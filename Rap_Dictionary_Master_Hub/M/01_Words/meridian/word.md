...
END: ian, iand, ians / SLANT: ia, iane, iany / MULTI: meridian mode, meridian codes, meridian road

## 3 bar-ready examples:
1. I move with Meridian, every step a headline.
2. Meridian on the mic, watch the room align.
3. Meridian in the flow, make the speakers quake.
