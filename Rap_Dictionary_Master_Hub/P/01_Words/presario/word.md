...
END: rio, riod, rios / SLANT: ri, rioe, rioy / MULTI: presario mode, presario codes, presario road

## 3 bar-ready examples:
1. I move with Presario, every step a headline.
2. Presario on the mic, watch the room align.
3. Presario in the flow, make the speakers quake.
