...
END: lia, liad, lias / SLANT: li, liae, liay / MULTI: stapelia mode, stapelia codes, stapelia road

## 3 bar-ready examples:
1. I move with Stapelia, every step a headline.
2. Stapelia on the mic, watch the room align.
3. Stapelia in the flow, make the speakers quake.
