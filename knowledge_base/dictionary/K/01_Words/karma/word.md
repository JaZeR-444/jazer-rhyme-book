...
END: rma, rmad, rmas / SLANT: rm, rmae, rmay / MULTI: karma mode, karma codes, karma road

## 3 bar-ready examples:
1. Karma in my cadence, heavy like a drumline.
2. I move with Karma, every step a headline.
3. Karma on the mic, watch the room align.
