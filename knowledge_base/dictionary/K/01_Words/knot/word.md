...
END: not, notd, nots / SLANT: no, note, noty / MULTI: knot mode, knot codes, knot road

## 3 bar-ready examples:
1. I move with Knot, every step a headline.
2. Knot on the mic, watch the room align.
3. Knot in the flow, make the speakers quake.
