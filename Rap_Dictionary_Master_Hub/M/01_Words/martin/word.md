...
END: tin, tind, tins / SLANT: ti, tine, tiny / MULTI: martin mode, martin codes, martin road

## 3 bar-ready examples:
1. Martin on the mic, watch the room align.
2. Martin in the flow, make the speakers quake.
3. Say Martin with the vision, watch the crowd awake.
