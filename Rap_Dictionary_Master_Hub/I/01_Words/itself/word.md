...
END: elf, elfd, elfs / SLANT: el, elfe, elfy / MULTI: itself mode, itself codes, itself road

## 3 bar-ready examples:
1. Itself in my cadence, heavy like a drumline.
2. I move with Itself, every step a headline.
3. Itself on the mic, watch the room align.
