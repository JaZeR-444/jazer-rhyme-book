...
END: nue, nued, nues / SLANT: nu, nuee, nuey / MULTI: venue mode, venue codes, venue road

## 3 bar-ready examples:
1. Venue on the mic, watch the room align.
2. Venue in the flow, make the speakers quake.
3. Say Venue with the vision, watch the crowd awake.
