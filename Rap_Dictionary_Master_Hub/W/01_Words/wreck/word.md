...
END: eck, eckd, ecks / SLANT: ec, ecke, ecky / MULTI: wreck mode, wreck codes, wreck road

## 3 bar-ready examples:
1. Wreck in the flow, make the speakers quake.
2. Say Wreck with the vision, watch the crowd awake.
3. Wreck in my cadence, heavy like a drumline.
