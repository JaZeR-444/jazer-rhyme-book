...
END: ese, esed, eses / SLANT: es, esee, esey / MULTI: imprese mode, imprese codes, imprese road

## 3 bar-ready examples:
1. Imprese on the mic, watch the room align.
2. Imprese in the flow, make the speakers quake.
3. Say Imprese with the vision, watch the crowd awake.
