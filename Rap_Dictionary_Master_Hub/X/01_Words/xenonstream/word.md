...
END: eam, eamd, eams / SLANT: ea, eame, eamy / MULTI: xenonstream mode, xenonstream codes, xenonstream road

## 3 bar-ready examples:
1. Xenonstream in the flow, make the speakers quake.
2. Say Xenonstream with the vision, watch the crowd awake.
3. Xenonstream in my cadence, heavy like a drumline.
