...
END: ird, irdd, irds / SLANT: ir, irde, irdy / MULTI: hosebird mode, hosebird codes, hosebird road

## 3 bar-ready examples:
1. I move with Hosebird, every step a headline.
2. Hosebird on the mic, watch the room align.
3. Hosebird in the flow, make the speakers quake.
