...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: juring mode, juring codes, juring road

## 3 bar-ready examples:
1. Say Juring with the vision, watch the crowd awake.
2. Juring in my cadence, heavy like a drumline.
3. I move with Juring, every step a headline.
