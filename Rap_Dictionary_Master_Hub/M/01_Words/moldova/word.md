...
END: ova, ovad, ovas / SLANT: ov, ovae, ovay / MULTI: moldova mode, moldova codes, moldova road

## 3 bar-ready examples:
1. Moldova in the flow, make the speakers quake.
2. Say Moldova with the vision, watch the crowd awake.
3. Moldova in my cadence, heavy like a drumline.
