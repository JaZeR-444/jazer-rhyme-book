...
END: ise, ised, ises / SLANT: is, isee, isey / MULTI: xenonrise mode, xenonrise codes, xenonrise road

## 3 bar-ready examples:
1. I move with Xenonrise, every step a headline.
2. Xenonrise on the mic, watch the room align.
3. Xenonrise in the flow, make the speakers quake.
