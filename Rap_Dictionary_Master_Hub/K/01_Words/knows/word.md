...
END: ows, owsd, owss / SLANT: ow, owse, owsy / MULTI: knows mode, knows codes, knows road

## 3 bar-ready examples:
1. Knows on the mic, watch the room align.
2. Knows in the flow, make the speakers quake.
3. Say Knows with the vision, watch the crowd awake.
