...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: signaling mode, signaling codes, signaling road

## 3 bar-ready examples:
1. I move with Signaling, every step a headline.
2. Signaling on the mic, watch the room align.
3. Signaling in the flow, make the speakers quake.
