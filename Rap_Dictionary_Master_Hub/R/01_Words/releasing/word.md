...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: releasing mode, releasing codes, releasing road

## 3 bar-ready examples:
1. Say Releasing with the vision, watch the crowd awake.
2. Releasing in my cadence, heavy like a drumline.
3. I move with Releasing, every step a headline.
