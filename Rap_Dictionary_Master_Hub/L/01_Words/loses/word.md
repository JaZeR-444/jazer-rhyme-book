...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: loses mode, loses codes, loses road

## 3 bar-ready examples:
1. Say Loses with the vision, watch the crowd awake.
2. Loses in my cadence, heavy like a drumline.
3. I move with Loses, every step a headline.
