...
END: nb, nbd, nbs / SLANT: n, nbe, nby / MULTI: nb mode, nb codes, nb road

## 3 bar-ready examples:
1. I move with Nb, every step a headline.
2. Nb on the mic, watch the room align.
3. Nb in the flow, make the speakers quake.
