...
END: sia, siad, sias / SLANT: si, siae, siay / MULTI: quassia mode, quassia codes, quassia road

## 3 bar-ready examples:
1. Quassia on the mic, watch the room align.
2. Quassia in the flow, make the speakers quake.
3. Say Quassia with the vision, watch the crowd awake.
