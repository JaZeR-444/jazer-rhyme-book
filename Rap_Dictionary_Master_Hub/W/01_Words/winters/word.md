...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: winters mode, winters codes, winters road

## 3 bar-ready examples:
1. Winters in the flow, make the speakers quake.
2. Say Winters with the vision, watch the crowd awake.
3. Winters in my cadence, heavy like a drumline.
