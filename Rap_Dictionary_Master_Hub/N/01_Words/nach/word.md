...
END: ach, achd, achs / SLANT: ac, ache, achy / MULTI: nach mode, nach codes, nach road

## 3 bar-ready examples:
1. I move with Nach, every step a headline.
2. Nach on the mic, watch the room align.
3. Nach in the flow, make the speakers quake.
