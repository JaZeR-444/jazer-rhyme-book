...
END: int, intd, ints / SLANT: in, inte, inty / MULTI: mint mode, mint codes, mint road

## 3 bar-ready examples:
1. Mint in the flow, make the speakers quake.
2. Say Mint with the vision, watch the crowd awake.
3. Mint in my cadence, heavy like a drumline.
