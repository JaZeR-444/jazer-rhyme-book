...
END: use, used, uses / SLANT: us, usee, usey / MULTI: spouse mode, spouse codes, spouse road

## 3 bar-ready examples:
1. Spouse in the flow, make the speakers quake.
2. Say Spouse with the vision, watch the crowd awake.
3. Spouse in my cadence, heavy like a drumline.
