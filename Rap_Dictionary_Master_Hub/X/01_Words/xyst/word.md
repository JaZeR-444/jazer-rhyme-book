...
END: yst, ystd, ysts / SLANT: ys, yste, ysty / MULTI: xyst mode, xyst codes, xyst road

## 3 bar-ready examples:
1. Xyst on the mic, watch the room align.
2. Xyst in the flow, make the speakers quake.
3. Say Xyst with the vision, watch the crowd awake.
