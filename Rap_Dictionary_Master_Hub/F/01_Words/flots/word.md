...
END: ots, otsd, otss / SLANT: ot, otse, otsy / MULTI: flots mode, flots codes, flots road

## 3 bar-ready examples:
1. Flots in the flow, make the speakers quake.
2. Say Flots with the vision, watch the crowd awake.
3. Flots in my cadence, heavy like a drumline.
