...
END: est, estd, ests / SLANT: es, este, esty / MULTI: jerkiest mode, jerkiest codes, jerkiest road

## 3 bar-ready examples:
1. Jerkiest in the flow, make the speakers quake.
2. Say Jerkiest with the vision, watch the crowd awake.
3. Jerkiest in my cadence, heavy like a drumline.
