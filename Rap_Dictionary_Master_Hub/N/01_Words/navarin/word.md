...
END: rin, rind, rins / SLANT: ri, rine, riny / MULTI: navarin mode, navarin codes, navarin road

## 3 bar-ready examples:
1. Navarin in the flow, make the speakers quake.
2. Say Navarin with the vision, watch the crowd awake.
3. Navarin in my cadence, heavy like a drumline.
