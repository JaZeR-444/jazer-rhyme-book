...
END: jan, jand, jans / SLANT: ja, jane, jany / MULTI: yojan mode, yojan codes, yojan road

## 3 bar-ready examples:
1. Yojan in the flow, make the speakers quake.
2. Say Yojan with the vision, watch the crowd awake.
3. Yojan in my cadence, heavy like a drumline.
