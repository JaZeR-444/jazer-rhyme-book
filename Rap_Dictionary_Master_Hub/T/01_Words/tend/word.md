...
END: end, endd, ends / SLANT: en, ende, endy / MULTI: tend mode, tend codes, tend road

## 3 bar-ready examples:
1. Tend on the mic, watch the room align.
2. Tend in the flow, make the speakers quake.
3. Say Tend with the vision, watch the crowd awake.
