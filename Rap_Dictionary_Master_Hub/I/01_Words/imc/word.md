...
END: imc, imcd, imcs / SLANT: im, imce, imcy / MULTI: imc mode, imc codes, imc road

## 3 bar-ready examples:
1. Imc in my cadence, heavy like a drumline.
2. I move with Imc, every step a headline.
3. Imc on the mic, watch the room align.
