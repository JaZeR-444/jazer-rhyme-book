...
END: sgs, sgsd, sgss / SLANT: sg, sgse, sgsy / MULTI: usgs mode, usgs codes, usgs road

## 3 bar-ready examples:
1. Usgs in the flow, make the speakers quake.
2. Say Usgs with the vision, watch the crowd awake.
3. Usgs in my cadence, heavy like a drumline.
