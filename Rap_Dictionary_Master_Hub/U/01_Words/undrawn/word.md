...
END: awn, awnd, awns / SLANT: aw, awne, awny / MULTI: undrawn mode, undrawn codes, undrawn road

## 3 bar-ready examples:
1. I move with Undrawn, every step a headline.
2. Undrawn on the mic, watch the room align.
3. Undrawn in the flow, make the speakers quake.
