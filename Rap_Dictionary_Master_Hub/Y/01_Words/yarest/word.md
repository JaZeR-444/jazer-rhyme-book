...
END: est, estd, ests / SLANT: es, este, esty / MULTI: yarest mode, yarest codes, yarest road

## 3 bar-ready examples:
1. I move with Yarest, every step a headline.
2. Yarest on the mic, watch the room align.
3. Yarest in the flow, make the speakers quake.
