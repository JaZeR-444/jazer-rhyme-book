...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: matching mode, matching codes, matching road

## 3 bar-ready examples:
1. I move with Matching, every step a headline.
2. Matching on the mic, watch the room align.
3. Matching in the flow, make the speakers quake.
