...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: increases mode, increases codes, increases road

## 3 bar-ready examples:
1. Say Increases with the vision, watch the crowd awake.
2. Increases in my cadence, heavy like a drumline.
3. I move with Increases, every step a headline.
