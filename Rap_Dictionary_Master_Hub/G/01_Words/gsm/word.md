...
END: gsm, gsmd, gsms / SLANT: gs, gsme, gsmy / MULTI: gsm mode, gsm codes, gsm road

## 3 bar-ready examples:
1. I move with Gsm, every step a headline.
2. Gsm on the mic, watch the room align.
3. Gsm in the flow, make the speakers quake.
