...
END: nct, nctd, ncts / SLANT: nc, ncte, ncty / MULTI: instinct mode, instinct codes, instinct road

## 3 bar-ready examples:
1. Instinct in the flow, make the speakers quake.
2. Say Instinct with the vision, watch the crowd awake.
3. Instinct in my cadence, heavy like a drumline.
