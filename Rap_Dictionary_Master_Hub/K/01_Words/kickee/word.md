...
END: kee, keed, kees / SLANT: ke, keee, keey / MULTI: kickee mode, kickee codes, kickee road

## 3 bar-ready examples:
1. I move with Kickee, every step a headline.
2. Kickee on the mic, watch the room align.
3. Kickee in the flow, make the speakers quake.
