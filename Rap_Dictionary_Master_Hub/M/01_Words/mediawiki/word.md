...
END: iki, ikid, ikis / SLANT: ik, ikie, ikiy / MULTI: mediawiki mode, mediawiki codes, mediawiki road

## 3 bar-ready examples:
1. Mediawiki in the flow, make the speakers quake.
2. Say Mediawiki with the vision, watch the crowd awake.
3. Mediawiki in my cadence, heavy like a drumline.
