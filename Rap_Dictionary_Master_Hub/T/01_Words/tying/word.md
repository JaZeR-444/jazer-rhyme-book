...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: tying mode, tying codes, tying road

## 3 bar-ready examples:
1. Tying on the mic, watch the room align.
2. Tying in the flow, make the speakers quake.
3. Say Tying with the vision, watch the crowd awake.
