...
END: ffs, ffsd, ffss / SLANT: ff, ffse, ffsy / MULTI: quaffs mode, quaffs codes, quaffs road

## 3 bar-ready examples:
1. I move with Quaffs, every step a headline.
2. Quaffs on the mic, watch the room align.
3. Quaffs in the flow, make the speakers quake.
