...
END: xin, xind, xins / SLANT: xi, xine, xiny / MULTI: urotoxin mode, urotoxin codes, urotoxin road

## 3 bar-ready examples:
1. I move with Urotoxin, every step a headline.
2. Urotoxin on the mic, watch the room align.
3. Urotoxin in the flow, make the speakers quake.
