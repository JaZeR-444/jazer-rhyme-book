...
END: mum, mumd, mums / SLANT: mu, mume, mumy / MULTI: optimum mode, optimum codes, optimum road

## 3 bar-ready examples:
1. Optimum on the mic, watch the room align.
2. Optimum in the flow, make the speakers quake.
3. Say Optimum with the vision, watch the crowd awake.
