...
END: ast, astd, asts / SLANT: as, aste, asty / MULTI: northeast mode, northeast codes, northeast road

## 3 bar-ready examples:
1. Northeast in the flow, make the speakers quake.
2. Say Northeast with the vision, watch the crowd awake.
3. Northeast in my cadence, heavy like a drumline.
