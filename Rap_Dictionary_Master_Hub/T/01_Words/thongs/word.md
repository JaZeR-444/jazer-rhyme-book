...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: thongs mode, thongs codes, thongs road

## 3 bar-ready examples:
1. Thongs on the mic, watch the room align.
2. Thongs in the flow, make the speakers quake.
3. Say Thongs with the vision, watch the crowd awake.
