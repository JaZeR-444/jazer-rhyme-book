...
END: oma, omad, omas / SLANT: om, omae, omay / MULTI: xanthoma mode, xanthoma codes, xanthoma road

## 3 bar-ready examples:
1. Xanthoma on the mic, watch the room align.
2. Xanthoma in the flow, make the speakers quake.
3. Say Xanthoma with the vision, watch the crowd awake.
