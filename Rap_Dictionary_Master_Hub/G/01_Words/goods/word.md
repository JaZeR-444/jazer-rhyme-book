...
END: ods, odsd, odss / SLANT: od, odse, odsy / MULTI: goods mode, goods codes, goods road

## 3 bar-ready examples:
1. I move with Goods, every step a headline.
2. Goods on the mic, watch the room align.
3. Goods in the flow, make the speakers quake.
