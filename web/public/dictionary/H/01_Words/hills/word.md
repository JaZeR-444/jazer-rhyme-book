...
END: lls, llsd, llss / SLANT: ll, llse, llsy / MULTI: hills mode, hills codes, hills road

## 3 bar-ready examples:
1. I move with Hills, every step a headline.
2. Hills on the mic, watch the room align.
3. Hills in the flow, make the speakers quake.
