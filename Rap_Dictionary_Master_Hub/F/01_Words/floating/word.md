...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: floating mode, floating codes, floating road

## 3 bar-ready examples:
1. Say Floating with the vision, watch the crowd awake.
2. Floating in my cadence, heavy like a drumline.
3. I move with Floating, every step a headline.
