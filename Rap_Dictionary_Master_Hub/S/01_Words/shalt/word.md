...
END: alt, altd, alts / SLANT: al, alte, alty / MULTI: shalt mode, shalt codes, shalt road

## 3 bar-ready examples:
1. I move with Shalt, every step a headline.
2. Shalt on the mic, watch the room align.
3. Shalt in the flow, make the speakers quake.
