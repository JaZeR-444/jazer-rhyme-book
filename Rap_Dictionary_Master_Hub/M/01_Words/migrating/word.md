...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: migrating mode, migrating codes, migrating road

## 3 bar-ready examples:
1. Migrating in my cadence, heavy like a drumline.
2. I move with Migrating, every step a headline.
3. Migrating on the mic, watch the room align.
