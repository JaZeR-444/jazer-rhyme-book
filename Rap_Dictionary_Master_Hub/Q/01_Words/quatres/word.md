...
END: res, resd, ress / SLANT: re, rese, resy / MULTI: quatres mode, quatres codes, quatres road

## 3 bar-ready examples:
1. Quatres on the mic, watch the room align.
2. Quatres in the flow, make the speakers quake.
3. Say Quatres with the vision, watch the crowd awake.
