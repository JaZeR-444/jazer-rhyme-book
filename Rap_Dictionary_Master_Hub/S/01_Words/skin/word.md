...
END: kin, kind, kins / SLANT: ki, kine, kiny / MULTI: skin mode, skin codes, skin road

## 3 bar-ready examples:
1. Skin on the mic, watch the room align.
2. Skin in the flow, make the speakers quake.
3. Say Skin with the vision, watch the crowd awake.
