...
END: ias, iasd, iass / SLANT: ia, iase, iasy / MULTI: obias mode, obias codes, obias road

## 3 bar-ready examples:
1. Obias in the flow, make the speakers quake.
2. Say Obias with the vision, watch the crowd awake.
3. Obias in my cadence, heavy like a drumline.
