...
END: ein, eind, eins / SLANT: ei, eine, einy / MULTI: goldstein mode, goldstein codes, goldstein road

## 3 bar-ready examples:
1. I move with Goldstein, every step a headline.
2. Goldstein on the mic, watch the room align.
3. Goldstein in the flow, make the speakers quake.
