...
END: ndo, ndod, ndos / SLANT: nd, ndoe, ndoy / MULTI: kondo mode, kondo codes, kondo road

## 3 bar-ready examples:
1. Kondo on the mic, watch the room align.
2. Kondo in the flow, make the speakers quake.
3. Say Kondo with the vision, watch the crowd awake.
