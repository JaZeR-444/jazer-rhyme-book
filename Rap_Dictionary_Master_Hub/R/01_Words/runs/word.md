...
END: uns, unsd, unss / SLANT: un, unse, unsy / MULTI: runs mode, runs codes, runs road

## 3 bar-ready examples:
1. Runs in the flow, make the speakers quake.
2. Say Runs with the vision, watch the crowd awake.
3. Runs in my cadence, heavy like a drumline.
