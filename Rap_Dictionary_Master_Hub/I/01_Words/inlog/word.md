...
END: log, logd, logs / SLANT: lo, loge, logy / MULTI: inlog mode, inlog codes, inlog road

## 3 bar-ready examples:
1. Inlog on the mic, watch the room align.
2. Inlog in the flow, make the speakers quake.
3. Say Inlog with the vision, watch the crowd awake.
