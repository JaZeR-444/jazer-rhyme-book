...
END: ulu, ulud, ulus / SLANT: ul, ulue, uluy / MULTI: vermoulu mode, vermoulu codes, vermoulu road

## 3 bar-ready examples:
1. I move with Vermoulu, every step a headline.
2. Vermoulu on the mic, watch the room align.
3. Vermoulu in the flow, make the speakers quake.
