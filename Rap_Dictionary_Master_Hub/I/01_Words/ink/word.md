...
END: ink, inkd, inks / SLANT: in, inke, inky / MULTI: ink mode, ink codes, ink road

## 3 bar-ready examples:
1. Ink in the flow, make the speakers quake.
2. Say Ink with the vision, watch the crowd awake.
3. Ink in my cadence, heavy like a drumline.
