...
END: ues, uesd, uess / SLANT: ue, uese, uesy / MULTI: grues mode, grues codes, grues road

## 3 bar-ready examples:
1. Grues on the mic, watch the room align.
2. Grues in the flow, make the speakers quake.
3. Say Grues with the vision, watch the crowd awake.
