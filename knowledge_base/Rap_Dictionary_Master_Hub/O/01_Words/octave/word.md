...
END: ave, aved, aves / SLANT: av, avee, avey / MULTI: octave mode, octave codes, octave road

## 3 bar-ready examples:
1. Octave in the flow, make the speakers quake.
2. Say Octave with the vision, watch the crowd awake.
3. Octave in my cadence, heavy like a drumline.
