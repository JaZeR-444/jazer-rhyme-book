...
END: see, seed, sees / SLANT: se, seee, seey / MULTI: oversee mode, oversee codes, oversee road

## 3 bar-ready examples:
1. I move with Oversee, every step a headline.
2. Oversee on the mic, watch the room align.
3. Oversee in the flow, make the speakers quake.
