...
END: ood, oodd, oods / SLANT: oo, oode, oody / MULTI: greenwood mode, greenwood codes, greenwood road

## 3 bar-ready examples:
1. Greenwood on the mic, watch the room align.
2. Greenwood in the flow, make the speakers quake.
3. Say Greenwood with the vision, watch the crowd awake.
