...
END: els, elsd, elss / SLANT: el, else, elsy / MULTI: fuels mode, fuels codes, fuels road

## 3 bar-ready examples:
1. I move with Fuels, every step a headline.
2. Fuels on the mic, watch the room align.
3. Fuels in the flow, make the speakers quake.
