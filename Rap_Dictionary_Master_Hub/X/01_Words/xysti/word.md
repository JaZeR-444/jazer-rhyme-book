...
END: sti, stid, stis / SLANT: st, stie, stiy / MULTI: xysti mode, xysti codes, xysti road

## 3 bar-ready examples:
1. Xysti on the mic, watch the room align.
2. Xysti in the flow, make the speakers quake.
3. Say Xysti with the vision, watch the crowd awake.
