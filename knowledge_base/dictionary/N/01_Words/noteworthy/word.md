...
END: thy, thyd, thys / SLANT: th, thye, thyy / MULTI: noteworthy mode, noteworthy codes, noteworthy road

## 3 bar-ready examples:
1. I move with Noteworthy, every step a headline.
2. Noteworthy on the mic, watch the room align.
3. Noteworthy in the flow, make the speakers quake.
