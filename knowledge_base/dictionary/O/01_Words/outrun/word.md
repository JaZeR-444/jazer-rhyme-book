...
END: run, rund, runs / SLANT: ru, rune, runy / MULTI: outrun mode, outrun codes, outrun road

## 3 bar-ready examples:
1. Outrun in my cadence, heavy like a drumline.
2. I move with Outrun, every step a headline.
3. Outrun on the mic, watch the room align.
