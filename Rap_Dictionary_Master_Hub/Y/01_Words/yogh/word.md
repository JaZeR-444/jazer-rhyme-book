...
END: ogh, oghd, oghs / SLANT: og, oghe, oghy / MULTI: yogh mode, yogh codes, yogh road

## 3 bar-ready examples:
1. I move with Yogh, every step a headline.
2. Yogh on the mic, watch the room align.
3. Yogh in the flow, make the speakers quake.
