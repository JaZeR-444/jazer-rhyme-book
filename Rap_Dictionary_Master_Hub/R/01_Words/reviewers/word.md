...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: reviewers mode, reviewers codes, reviewers road

## 3 bar-ready examples:
1. I move with Reviewers, every step a headline.
2. Reviewers on the mic, watch the room align.
3. Reviewers in the flow, make the speakers quake.
