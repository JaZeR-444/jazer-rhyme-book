...
END: abs, absd, abss / SLANT: ab, abse, absy / MULTI: squabs mode, squabs codes, squabs road

## 3 bar-ready examples:
1. Squabs on the mic, watch the room align.
2. Squabs in the flow, make the speakers quake.
3. Say Squabs with the vision, watch the crowd awake.
