...
END: ect, ectd, ects / SLANT: ec, ecte, ecty / MULTI: undirect mode, undirect codes, undirect road

## 3 bar-ready examples:
1. Undirect in the flow, make the speakers quake.
2. Say Undirect with the vision, watch the crowd awake.
3. Undirect in my cadence, heavy like a drumline.
