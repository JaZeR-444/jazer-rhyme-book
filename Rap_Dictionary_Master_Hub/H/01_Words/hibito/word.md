...
END: ito, itod, itos / SLANT: it, itoe, itoy / MULTI: hibito mode, hibito codes, hibito road

## 3 bar-ready examples:
1. I move with Hibito, every step a headline.
2. Hibito on the mic, watch the room align.
3. Hibito in the flow, make the speakers quake.
