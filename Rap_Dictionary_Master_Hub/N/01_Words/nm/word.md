...
END: nm, nmd, nms / SLANT: n, nme, nmy / MULTI: nm mode, nm codes, nm road

## 3 bar-ready examples:
1. I move with Nm, every step a headline.
2. Nm on the mic, watch the room align.
3. Nm in the flow, make the speakers quake.
