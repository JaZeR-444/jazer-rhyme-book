...
END: sen, send, sens / SLANT: se, sene, seny / MULTI: jensen mode, jensen codes, jensen road

## 3 bar-ready examples:
1. Jensen in the flow, make the speakers quake.
2. Say Jensen with the vision, watch the crowd awake.
3. Jensen in my cadence, heavy like a drumline.
