...
END: mes, mesd, mess / SLANT: me, mese, mesy / MULTI: names mode, names codes, names road

## 3 bar-ready examples:
1. I move with Names, every step a headline.
2. Names on the mic, watch the room align.
3. Names in the flow, make the speakers quake.
