...
END: its, itsd, itss / SLANT: it, itse, itsy / MULTI: reknits mode, reknits codes, reknits road

## 3 bar-ready examples:
1. Reknits in my cadence, heavy like a drumline.
2. I move with Reknits, every step a headline.
3. Reknits on the mic, watch the room align.
