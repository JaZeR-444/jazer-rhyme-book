...
END: rap, rapd, raps / SLANT: ra, rape, rapy / MULTI: thrap mode, thrap codes, thrap road

## 3 bar-ready examples:
1. I move with Thrap, every step a headline.
2. Thrap on the mic, watch the room align.
3. Thrap in the flow, make the speakers quake.
