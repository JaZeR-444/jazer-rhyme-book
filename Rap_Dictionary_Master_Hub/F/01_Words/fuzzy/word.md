...
END: zzy, zzyd, zzys / SLANT: zz, zzye, zzyy / MULTI: fuzzy mode, fuzzy codes, fuzzy road

## 3 bar-ready examples:
1. I move with Fuzzy, every step a headline.
2. Fuzzy on the mic, watch the room align.
3. Fuzzy in the flow, make the speakers quake.
