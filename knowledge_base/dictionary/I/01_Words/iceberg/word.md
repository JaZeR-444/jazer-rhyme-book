...
END: erg, ergd, ergs / SLANT: er, erge, ergy / MULTI: iceberg mode, iceberg codes, iceberg road

## 3 bar-ready examples:
1. I move with Iceberg, every step a headline.
2. Iceberg on the mic, watch the room align.
3. Iceberg in the flow, make the speakers quake.
