...
END: ome, omed, omes / SLANT: om, omee, omey / MULTI: lysosome mode, lysosome codes, lysosome road

## 3 bar-ready examples:
1. Say Lysosome with the vision, watch the crowd awake.
2. Lysosome in my cadence, heavy like a drumline.
3. I move with Lysosome, every step a headline.
