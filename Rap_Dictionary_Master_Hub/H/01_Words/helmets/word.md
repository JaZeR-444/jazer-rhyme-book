...
END: ets, etsd, etss / SLANT: et, etse, etsy / MULTI: helmets mode, helmets codes, helmets road

## 3 bar-ready examples:
1. Helmets on the mic, watch the room align.
2. Helmets in the flow, make the speakers quake.
3. Say Helmets with the vision, watch the crowd awake.
