...
END: ops, opsd, opss / SLANT: op, opse, opsy / MULTI: pops mode, pops codes, pops road

## 3 bar-ready examples:
1. I move with Pops, every step a headline.
2. Pops on the mic, watch the room align.
3. Pops in the flow, make the speakers quake.
