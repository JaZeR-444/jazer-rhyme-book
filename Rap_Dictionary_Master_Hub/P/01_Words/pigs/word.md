...
END: igs, igsd, igss / SLANT: ig, igse, igsy / MULTI: pigs mode, pigs codes, pigs road

## 3 bar-ready examples:
1. Pigs on the mic, watch the room align.
2. Pigs in the flow, make the speakers quake.
3. Say Pigs with the vision, watch the crowd awake.
