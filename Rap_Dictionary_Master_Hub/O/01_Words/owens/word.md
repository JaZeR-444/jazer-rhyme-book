...
END: ens, ensd, enss / SLANT: en, ense, ensy / MULTI: owens mode, owens codes, owens road

## 3 bar-ready examples:
1. I move with Owens, every step a headline.
2. Owens on the mic, watch the room align.
3. Owens in the flow, make the speakers quake.
