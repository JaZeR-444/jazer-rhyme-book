...
END: yls, ylsd, ylss / SLANT: yl, ylse, ylsy / MULTI: xylyls mode, xylyls codes, xylyls road

## 3 bar-ready examples:
1. Xylyls in my cadence, heavy like a drumline.
2. I move with Xylyls, every step a headline.
3. Xylyls on the mic, watch the room align.
