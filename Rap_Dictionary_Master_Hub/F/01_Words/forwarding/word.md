...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: forwarding mode, forwarding codes, forwarding road

## 3 bar-ready examples:
1. Forwarding in my cadence, heavy like a drumline.
2. I move with Forwarding, every step a headline.
3. Forwarding on the mic, watch the room align.
