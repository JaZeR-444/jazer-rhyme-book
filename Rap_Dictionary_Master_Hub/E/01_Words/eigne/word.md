...
END: gne, gned, gnes / SLANT: gn, gnee, gney / MULTI: eigne mode, eigne codes, eigne road

## 3 bar-ready examples:
1. Eigne on the mic, watch the room align.
2. Eigne in the flow, make the speakers quake.
3. Say Eigne with the vision, watch the crowd awake.
