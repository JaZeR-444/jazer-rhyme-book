...
END: ulu, ulud, ulus / SLANT: ul, ulue, uluy / MULTI: loulu mode, loulu codes, loulu road

## 3 bar-ready examples:
1. Loulu on the mic, watch the room align.
2. Loulu in the flow, make the speakers quake.
3. Say Loulu with the vision, watch the crowd awake.
