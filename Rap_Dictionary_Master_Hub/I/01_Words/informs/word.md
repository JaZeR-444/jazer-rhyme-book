...
END: rms, rmsd, rmss / SLANT: rm, rmse, rmsy / MULTI: informs mode, informs codes, informs road

## 3 bar-ready examples:
1. Informs in the flow, make the speakers quake.
2. Say Informs with the vision, watch the crowd awake.
3. Informs in my cadence, heavy like a drumline.
