...
END: bec, becd, becs / SLANT: be, bece, becy / MULTI: geelbec mode, geelbec codes, geelbec road

## 3 bar-ready examples:
1. Geelbec on the mic, watch the room align.
2. Geelbec in the flow, make the speakers quake.
3. Say Geelbec with the vision, watch the crowd awake.
