...
END: osi, osid, osis / SLANT: os, osie, osiy / MULTI: inkosi mode, inkosi codes, inkosi road

## 3 bar-ready examples:
1. Inkosi on the mic, watch the room align.
2. Inkosi in the flow, make the speakers quake.
3. Say Inkosi with the vision, watch the crowd awake.
