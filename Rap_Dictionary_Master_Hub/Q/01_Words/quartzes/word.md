...
END: zes, zesd, zess / SLANT: ze, zese, zesy / MULTI: quartzes mode, quartzes codes, quartzes road

## 3 bar-ready examples:
1. Quartzes on the mic, watch the room align.
2. Quartzes in the flow, make the speakers quake.
3. Say Quartzes with the vision, watch the crowd awake.
