...
END: ket, ketd, kets / SLANT: ke, kete, kety / MULTI: rocket mode, rocket codes, rocket road

## 3 bar-ready examples:
1. Say Rocket with the vision, watch the crowd awake.
2. Rocket in my cadence, heavy like a drumline.
3. I move with Rocket, every step a headline.
