...
END: enu, enud, enus / SLANT: en, enue, enuy / MULTI: menu mode, menu codes, menu road

## 3 bar-ready examples:
1. I move with Menu, every step a headline.
2. Menu on the mic, watch the room align.
3. Menu in the flow, make the speakers quake.
