...
END: ics, icsd, icss / SLANT: ic, icse, icsy / MULTI: spherics mode, spherics codes, spherics road

## 3 bar-ready examples:
1. I move with Spherics, every step a headline.
2. Spherics on the mic, watch the room align.
3. Spherics in the flow, make the speakers quake.
