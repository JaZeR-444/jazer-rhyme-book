...
END: sas, sasd, sass / SLANT: sa, sase, sasy / MULTI: kansas mode, kansas codes, kansas road

## 3 bar-ready examples:
1. Kansas on the mic, watch the room align.
2. Kansas in the flow, make the speakers quake.
3. Say Kansas with the vision, watch the crowd awake.
