...
END: tes, tesd, tess / SLANT: te, tese, tesy / MULTI: votes mode, votes codes, votes road

## 3 bar-ready examples:
1. I move with Votes, every step a headline.
2. Votes on the mic, watch the room align.
3. Votes in the flow, make the speakers quake.
