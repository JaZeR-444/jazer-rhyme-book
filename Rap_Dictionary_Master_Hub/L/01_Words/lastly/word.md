...
END: tly, tlyd, tlys / SLANT: tl, tlye, tlyy / MULTI: lastly mode, lastly codes, lastly road

## 3 bar-ready examples:
1. I move with Lastly, every step a headline.
2. Lastly on the mic, watch the room align.
3. Lastly in the flow, make the speakers quake.
