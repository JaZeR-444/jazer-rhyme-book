...
END: ies, iesd, iess / SLANT: ie, iese, iesy / MULTI: ties mode, ties codes, ties road

## 3 bar-ready examples:
1. I move with Ties, every step a headline.
2. Ties on the mic, watch the room align.
3. Ties in the flow, make the speakers quake.
