...
END: ect, ectd, ects / SLANT: ec, ecte, ecty / MULTI: infect mode, infect codes, infect road

## 3 bar-ready examples:
1. Infect in the flow, make the speakers quake.
2. Say Infect with the vision, watch the crowd awake.
3. Infect in my cadence, heavy like a drumline.
