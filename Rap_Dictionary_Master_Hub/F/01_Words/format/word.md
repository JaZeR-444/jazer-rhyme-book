...
END: mat, matd, mats / SLANT: ma, mate, maty / MULTI: format mode, format codes, format road

## 3 bar-ready examples:
1. Format on the mic, watch the room align.
2. Format in the flow, make the speakers quake.
3. Say Format with the vision, watch the crowd awake.
