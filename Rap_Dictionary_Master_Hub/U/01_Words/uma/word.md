...
END: uma, umad, umas / SLANT: um, umae, umay / MULTI: uma mode, uma codes, uma road

## 3 bar-ready examples:
1. Say Uma with the vision, watch the crowd awake.
2. Uma in my cadence, heavy like a drumline.
3. I move with Uma, every step a headline.
