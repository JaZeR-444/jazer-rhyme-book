...
END: eta, etad, etas / SLANT: et, etae, etay / MULTI: theta mode, theta codes, theta road

## 3 bar-ready examples:
1. Theta in the flow, make the speakers quake.
2. Say Theta with the vision, watch the crowd awake.
3. Theta in my cadence, heavy like a drumline.
