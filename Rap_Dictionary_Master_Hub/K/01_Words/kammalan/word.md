...
END: lan, land, lans / SLANT: la, lane, lany / MULTI: kammalan mode, kammalan codes, kammalan road

## 3 bar-ready examples:
1. Kammalan on the mic, watch the room align.
2. Kammalan in the flow, make the speakers quake.
3. Say Kammalan with the vision, watch the crowd awake.
