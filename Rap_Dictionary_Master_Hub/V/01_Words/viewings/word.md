...
END: ngs, ngsd, ngss / SLANT: ng, ngse, ngsy / MULTI: viewings mode, viewings codes, viewings road

## 3 bar-ready examples:
1. Viewings on the mic, watch the room align.
2. Viewings in the flow, make the speakers quake.
3. Say Viewings with the vision, watch the crowd awake.
