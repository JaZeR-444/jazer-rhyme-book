...
END: imp, impd, imps / SLANT: im, impe, impy / MULTI: scrimp mode, scrimp codes, scrimp road

## 3 bar-ready examples:
1. Say Scrimp with the vision, watch the crowd awake.
2. Scrimp in my cadence, heavy like a drumline.
3. I move with Scrimp, every step a headline.
