...
END: hes, hesd, hess / SLANT: he, hese, hesy / MULTI: reaches mode, reaches codes, reaches road

## 3 bar-ready examples:
1. Reaches on the mic, watch the room align.
2. Reaches in the flow, make the speakers quake.
3. Say Reaches with the vision, watch the crowd awake.
