...
END: ago, agod, agos / SLANT: ag, agoe, agoy / MULTI: santiago mode, santiago codes, santiago road

## 3 bar-ready examples:
1. Santiago on the mic, watch the room align.
2. Santiago in the flow, make the speakers quake.
3. Say Santiago with the vision, watch the crowd awake.
