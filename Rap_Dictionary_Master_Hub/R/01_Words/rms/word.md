...
END: rms, rmsd, rmss / SLANT: rm, rmse, rmsy / MULTI: rms mode, rms codes, rms road

## 3 bar-ready examples:
1. Rms on the mic, watch the room align.
2. Rms in the flow, make the speakers quake.
3. Say Rms with the vision, watch the crowd awake.
