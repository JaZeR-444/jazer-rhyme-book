...
END: int, intd, ints / SLANT: in, inte, inty / MULTI: waypoint mode, waypoint codes, waypoint road

## 3 bar-ready examples:
1. Waypoint in my cadence, heavy like a drumline.
2. I move with Waypoint, every step a headline.
3. Waypoint on the mic, watch the room align.
