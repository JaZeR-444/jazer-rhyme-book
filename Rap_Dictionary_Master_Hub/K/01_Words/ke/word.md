...
END: ke, ked, kes / SLANT: k, kee, key / MULTI: ke mode, ke codes, ke road

## 3 bar-ready examples:
1. I move with Ke, every step a headline.
2. Ke on the mic, watch the room align.
3. Ke in the flow, make the speakers quake.
