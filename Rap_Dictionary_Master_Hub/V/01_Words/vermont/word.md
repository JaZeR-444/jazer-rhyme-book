...
END: ont, ontd, onts / SLANT: on, onte, onty / MULTI: vermont mode, vermont codes, vermont road

## 3 bar-ready examples:
1. I move with Vermont, every step a headline.
2. Vermont on the mic, watch the room align.
3. Vermont in the flow, make the speakers quake.
