...
END: gin, gind, gins / SLANT: gi, gine, giny / MULTI: virgin mode, virgin codes, virgin road

## 3 bar-ready examples:
1. Virgin on the mic, watch the room align.
2. Virgin in the flow, make the speakers quake.
3. Say Virgin with the vision, watch the crowd awake.
