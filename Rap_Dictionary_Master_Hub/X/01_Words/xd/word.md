...
END: xd, xdd, xds / SLANT: x, xde, xdy / MULTI: xd mode, xd codes, xd road

## 3 bar-ready examples:
1. Xd on the mic, watch the room align.
2. Xd in the flow, make the speakers quake.
3. Say Xd with the vision, watch the crowd awake.
