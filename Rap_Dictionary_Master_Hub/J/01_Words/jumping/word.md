...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: jumping mode, jumping codes, jumping road

## 3 bar-ready examples:
1. I move with Jumping, every step a headline.
2. Jumping on the mic, watch the room align.
3. Jumping in the flow, make the speakers quake.
