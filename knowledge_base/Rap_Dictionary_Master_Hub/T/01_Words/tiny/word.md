...
END: iny, inyd, inys / SLANT: in, inye, inyy / MULTI: tiny mode, tiny codes, tiny road

## 3 bar-ready examples:
1. I move with Tiny, every step a headline.
2. Tiny on the mic, watch the room align.
3. Tiny in the flow, make the speakers quake.
