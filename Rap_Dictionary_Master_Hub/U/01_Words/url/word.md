...
END: url, urld, urls / SLANT: ur, urle, urly / MULTI: url mode, url codes, url road

## 3 bar-ready examples:
1. Url on the mic, watch the room align.
2. Url in the flow, make the speakers quake.
3. Say Url with the vision, watch the crowd awake.
