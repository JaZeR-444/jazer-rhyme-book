...
END: lse, lsed, lses / SLANT: ls, lsee, lsey / MULTI: impulse mode, impulse codes, impulse road

## 3 bar-ready examples:
1. I move with Impulse, every step a headline.
2. Impulse on the mic, watch the room align.
3. Impulse in the flow, make the speakers quake.
