...
END: rge, rged, rges / SLANT: rg, rgee, rgey / MULTI: gorge mode, gorge codes, gorge road

## 3 bar-ready examples:
1. Gorge on the mic, watch the room align.
2. Gorge in the flow, make the speakers quake.
3. Say Gorge with the vision, watch the crowd awake.
