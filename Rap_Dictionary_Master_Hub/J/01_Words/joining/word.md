...
END: ing, ingd, ings / SLANT: in, inge, ingy / MULTI: joining mode, joining codes, joining road

## 3 bar-ready examples:
1. I move with Joining, every step a headline.
2. Joining on the mic, watch the room align.
3. Joining in the flow, make the speakers quake.
