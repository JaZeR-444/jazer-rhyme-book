...
END: sau, saud, saus / SLANT: sa, saue, sauy / MULTI: nassau mode, nassau codes, nassau road

## 3 bar-ready examples:
1. Say Nassau with the vision, watch the crowd awake.
2. Nassau in my cadence, heavy like a drumline.
3. I move with Nassau, every step a headline.
