...
END: tes, tesd, tess / SLANT: te, tese, tesy / MULTI: templates mode, templates codes, templates road

## 3 bar-ready examples:
1. Templates in the flow, make the speakers quake.
2. Say Templates with the vision, watch the crowd awake.
3. Templates in my cadence, heavy like a drumline.
