...
END: pry, pryd, prys / SLANT: pr, prye, pryy / MULTI: impropry mode, impropry codes, impropry road

## 3 bar-ready examples:
1. I move with Impropry, every step a headline.
2. Impropry on the mic, watch the room align.
3. Impropry in the flow, make the speakers quake.
