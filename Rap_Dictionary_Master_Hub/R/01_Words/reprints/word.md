...
END: nts, ntsd, ntss / SLANT: nt, ntse, ntsy / MULTI: reprints mode, reprints codes, reprints road

## 3 bar-ready examples:
1. Reprints in my cadence, heavy like a drumline.
2. I move with Reprints, every step a headline.
3. Reprints on the mic, watch the room align.
