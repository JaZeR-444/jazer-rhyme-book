...
END: tle, tled, tles / SLANT: tl, tlee, tley / MULTI: throttle mode, throttle codes, throttle road

## 3 bar-ready examples:
1. Throttle in the flow, make the speakers quake.
2. Say Throttle with the vision, watch the crowd awake.
3. Throttle in my cadence, heavy like a drumline.
