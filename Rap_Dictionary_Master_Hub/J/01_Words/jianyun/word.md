...
END: yun, yund, yuns / SLANT: yu, yune, yuny / MULTI: jianyun mode, jianyun codes, jianyun road

## 3 bar-ready examples:
1. Say Jianyun with the vision, watch the crowd awake.
2. Jianyun in my cadence, heavy like a drumline.
3. I move with Jianyun, every step a headline.
