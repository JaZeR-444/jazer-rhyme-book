...
END: use, used, uses / SLANT: us, usee, usey / MULTI: oxhouse mode, oxhouse codes, oxhouse road

## 3 bar-ready examples:
1. Oxhouse on the mic, watch the room align.
2. Oxhouse in the flow, make the speakers quake.
3. Say Oxhouse with the vision, watch the crowd awake.
