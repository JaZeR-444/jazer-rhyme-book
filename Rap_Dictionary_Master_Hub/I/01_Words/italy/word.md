...
END: aly, alyd, alys / SLANT: al, alye, alyy / MULTI: italy mode, italy codes, italy road

## 3 bar-ready examples:
1. I move with Italy, every step a headline.
2. Italy on the mic, watch the room align.
3. Italy in the flow, make the speakers quake.
