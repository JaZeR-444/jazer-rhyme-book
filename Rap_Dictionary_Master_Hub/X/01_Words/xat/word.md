...
END: xat, xatd, xats / SLANT: xa, xate, xaty / MULTI: xat mode, xat codes, xat road

## 3 bar-ready examples:
1. I move with Xat, every step a headline.
2. Xat on the mic, watch the room align.
3. Xat in the flow, make the speakers quake.
