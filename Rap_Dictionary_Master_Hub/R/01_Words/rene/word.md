...
END: ene, ened, enes / SLANT: en, enee, eney / MULTI: rene mode, rene codes, rene road

## 3 bar-ready examples:
1. Rene in the flow, make the speakers quake.
2. Say Rene with the vision, watch the crowd awake.
3. Rene in my cadence, heavy like a drumline.
