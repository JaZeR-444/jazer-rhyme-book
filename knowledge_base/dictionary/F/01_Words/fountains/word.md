...
END: ins, insd, inss / SLANT: in, inse, insy / MULTI: fountains mode, fountains codes, fountains road

## 3 bar-ready examples:
1. Fountains on the mic, watch the room align.
2. Fountains in the flow, make the speakers quake.
3. Say Fountains with the vision, watch the crowd awake.
