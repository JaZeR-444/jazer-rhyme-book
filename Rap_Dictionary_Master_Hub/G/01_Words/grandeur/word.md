...
END: eur, eurd, eurs / SLANT: eu, eure, eury / MULTI: grandeur mode, grandeur codes, grandeur road

## 3 bar-ready examples:
1. I move with Grandeur, every step a headline.
2. Grandeur on the mic, watch the room align.
3. Grandeur in the flow, make the speakers quake.
