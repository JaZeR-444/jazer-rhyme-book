...
END: osa, osad, osas / SLANT: os, osae, osay / MULTI: xosa mode, xosa codes, xosa road

## 3 bar-ready examples:
1. I move with Xosa, every step a headline.
2. Xosa on the mic, watch the room align.
3. Xosa in the flow, make the speakers quake.
