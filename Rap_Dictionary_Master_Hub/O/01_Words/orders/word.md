...
END: ers, ersd, erss / SLANT: er, erse, ersy / MULTI: orders mode, orders codes, orders road

## 3 bar-ready examples:
1. I move with Orders, every step a headline.
2. Orders on the mic, watch the room align.
3. Orders in the flow, make the speakers quake.
