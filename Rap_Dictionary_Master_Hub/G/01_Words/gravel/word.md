...
END: vel, veld, vels / SLANT: ve, vele, vely / MULTI: gravel mode, gravel codes, gravel road

## 3 bar-ready examples:
1. I move with Gravel, every step a headline.
2. Gravel on the mic, watch the room align.
3. Gravel in the flow, make the speakers quake.
