...
END: hir, hird, hirs / SLANT: hi, hire, hiry / MULTI: yukaghir mode, yukaghir codes, yukaghir road

## 3 bar-ready examples:
1. I move with Yukaghir, every step a headline.
2. Yukaghir on the mic, watch the room align.
3. Yukaghir in the flow, make the speakers quake.
