...
END: ses, sesd, sess / SLANT: se, sese, sesy / MULTI: gases mode, gases codes, gases road

## 3 bar-ready examples:
1. I move with Gases, every step a headline.
2. Gases on the mic, watch the room align.
3. Gases in the flow, make the speakers quake.
