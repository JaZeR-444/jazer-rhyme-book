...
END: era, erad, eras / SLANT: er, erae, eray / MULTI: listera mode, listera codes, listera road

## 3 bar-ready examples:
1. I move with Listera, every step a headline.
2. Listera on the mic, watch the room align.
3. Listera in the flow, make the speakers quake.
