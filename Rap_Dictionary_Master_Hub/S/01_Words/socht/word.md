...
END: cht, chtd, chts / SLANT: ch, chte, chty / MULTI: socht mode, socht codes, socht road

## 3 bar-ready examples:
1. Socht on the mic, watch the room align.
2. Socht in the flow, make the speakers quake.
3. Say Socht with the vision, watch the crowd awake.
